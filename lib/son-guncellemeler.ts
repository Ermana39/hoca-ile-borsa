export type SonGuncellemeItem = {
  title: string;
  href: string;
  updatedAt: string;
};

export const sonGuncellemeler: SonGuncellemeItem[] = [
  {
    title: "Günlük Borsa Özeti",
    href: "/borsa/gunluk-borsa-ozeti",
    updatedAt: "29.04.2026 18:30",
  },
  {
    title: "Dikkat Çekenler",
    href: "/borsa/dikkat-cekenler",
    updatedAt: "24.04.2026 20:05",
  },
  {
