        ...
        <article className="overflow-hidden rounded-2xl border border-zinc-200 bg-white">
          ...
          <div className="p-5 md:p-8">
            <h1 className="text-2xl font-bold leading-tight text-zinc-900 md:text-4xl">
              BUluslararası kredi derecelendirme kuruluşu Fitch Ratings, Türkiye’nin uzun vadeli yabancı para cinsinden kredi notunu “BB-” seviyesinde teyit ederken, görünümü “pozitif”ten “durağan”a çekti.
            </h1>
