...
export const metadata: Metadata = {
  title:
    "Çimko Çimento ve Beton San. Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Çimko Çimento ve Beton San. Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function CimkoCimentoVeBetonSanTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "75.789.472 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const fonKullanim = [
    "%60-40 Çimento, hazır beton ve agrega iş kollarında yapılacak yatırımlar ile yurt içi ve yurt dışı şirket ve varlık alımları",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023: "14,6 Milyar TL",
      d2022: "12,8 Milyar TL",
      d2021: "8,1 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Belirlenecek",
      desc: "Taslak izahnamede fiyat istikrarı süresi henüz netleşmemiş görünüyor.",
    },
    {
    ...
    },
    {
      title: "Yatırım Alanı",
      value: "Çimento/Beton",
      desc: "Fon kullanımında çimento, hazır beton, agrega ve olası şirket/varlık alımları öne çıkıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">75.789.472</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Çimko Çimento ve Beton San. Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Çimko Çimento ve Beton San. Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Çimko Çimento ve Beton San. Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Çimko Çimento ve Beton San. Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
