...
export const metadata: Metadata = {
  title:
    "Esasburda Turizm ve İnşaat San. Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Esasburda Turizm ve İnşaat San. Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, aracı kurum bilgileri ve taslak süreç verileri.",
};
...
export default function EsasburdaTurizmVeInsaatSanTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "280.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 280.000.000 Lot"];

  const fonKullanim = [
    "Taslak süreçte açıklanması bekleniyor",
    "Şirketin resmi halka arz detaylarıyla netleşecektir",
    "Fon kullanım dağılımı ilerleyen aşamalarda duyurulacaktır",
  ];
  ...
  const oneCikanlar = [
    {
      title: "Toplam Pay",
      value: "280 Milyon",
      desc: "Taslak halka arz planında toplam pay miktarı 280.000.000 lot olarak yer alıyor.",
    },
    {
      title: "Aracı Kurum",
      value: "2 Kurum",
      desc: "Halk Yatırım ve İş Yatırım konsorsiyum yapısında öne çıkıyor.",
    },
    {
      title: "Fiyat",
      value: "Hazırlanıyor",
      desc: "Halka arz fiyatı veya fiyat aralığı henüz netleşmemiş durumda.",
    },
    {
      title: "Süreç",
      value: "Taslak",
      desc: "Birçok başlık taslak aşamada olup resmi duyurularla tamamlanacaktır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">280.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Esasburda Turizm ve İnşaat San. Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Esasburda Turizm ve İnşaat San. Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, aracı
                kurum yapısı ve sürecin taslak aşamadaki gelişimi yer alıyor. Bu sayfada şu an için
                açıklanan sınırlı veriler daha sade ve analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-900">
                  Tahsisat detayları açıklanmadı.
                </div>
                <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-900">
                  Dağıtım yöntemi netleşmeyi bekliyor.
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  <div className="text-sm font-semibold text-cyan-800">Süreç Durumu</div>
                  <p className="mt-2 text-sm text-cyan-900">Taslak aşamada.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Esasburda Turizm ve İnşaat San. Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Esasburda Turizm ve İnşaat San. Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, aracı kurum bilgileri,
            süreç durumu ve taslak aşamadaki ana başlıklar bir arada sunulmuştur. Sayfadaki bilgiler
            taslak veriler doğrultusunda hazırlanmıştır ve resmi detaylar açıklandıkça
            güncellenmelidir.
          </p>
        </section>
      </div>
