...
export const metadata: Metadata = {
  title:
    "Otosor Otomotiv A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Otosor Otomotiv A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, bist kodu, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OtosorOtomotivASPage() {
  const summaryItems = [
    ...
    { label: "Bist Kodu", value: "OTOSR" },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 35.000.000 Lot",
    "Ortak Satışı: 35.000.000 Lot (Nurol Portföy Yönetim A.Ş. Dokuzuncu Girişim Sermayesi Yatırım Fonu)",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "5,6 Milyar TL",
      d2024: "16,6 Milyar TL",
      d2023: "11,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "1,6 Milyar TL",
      d2024: "5,1 Milyar TL",
      d2023: "3,2 Milyar TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">OTOSR</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Otosor Otomotiv A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Otosor Otomotiv A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi,
                bist kodu, fon kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%22,58</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Otosor Otomotiv A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Otosor Otomotiv A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım yöntemi, bist kodu, halka
