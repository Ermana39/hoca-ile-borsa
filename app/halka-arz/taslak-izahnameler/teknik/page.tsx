...
export const metadata: Metadata = {
  title:
    "Teknik Yapı Teknik Yapılar San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Teknik Yapı Teknik Yapılar San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, bist kodu, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TeknikYapiTeknikYapilarSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "51.500.000 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "BIST Kodu", value: "TEKYP" },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 41.500.000 Lot",
    "Ortak Satışı: 6.000.000 Lot (Ahmet Nazmi Durbakayım)",
    "Ortak Satışı: 4.000.000 Lot (Umut Durbakayım)",
  ];

  const fonKullanim = [
    "%40 Devam eden ve yeni yapılacak projelerin finansmanı",
    "%40 Kredi borcu ödemesi",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_9: "707,1 Milyon TL",
      d2022: "426,5 Milyon TL",
      d2021: "520,5 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2023_9: "248,7 Milyon TL",
      d2022: "142,1 Milyon TL",
      d2021: "153,8 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">51.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">TEKYP</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Teknik Yapı Teknik Yapılar San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Teknik Yapı Teknik Yapılar San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en
          ...
          <aside className="space-y-8">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-sm font-semibold text-slate-800">BIST Kodu</div>
                  <p className="mt-2 text-sm text-slate-700">TEKYP</p>
                </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30,03</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Teknik Yapı Teknik Yapılar San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Teknik Yapı Teknik Yapılar San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
