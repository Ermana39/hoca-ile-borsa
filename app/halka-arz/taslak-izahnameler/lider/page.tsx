...
export const metadata: Metadata = {
  title:
    "Lider Sistem Teknolojileri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Lider Sistem Teknolojileri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function LiderSistemTeknolojileriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "48.800.000 Lot" },
    { label: "Aracı Kurum", value: "InvestAZ Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 32.000.000 Lot",
    "Ortak Satışı: 8.400.000 Lot (Muhammed Burak Görmez)",
    "Ortak Satışı: 4.200.000 Lot (Bekir Türkden)",
    "Ortak Satışı: 4.200.000 Lot (Rasim Öz)",
  ];

  const fonKullanim = [
    "%50 Ar-Ge ve yazılım geliştirme alanlarındaki yatırımlar",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "718,6 Milyon TL",
      d2024: "815,5 Milyon TL",
      d2023: "583,1 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "245,7 Milyon TL",
      d2024: "396,3 Milyon TL",
      d2023: "408,6 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">48.800.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Lider Sistem Teknolojileri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Lider Sistem Teknolojileri A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%24,40</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Lider Sistem Teknolojileri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Lider Sistem Teknolojileri A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
