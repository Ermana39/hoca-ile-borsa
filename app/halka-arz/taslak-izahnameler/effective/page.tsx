...
export const metadata: Metadata = {
  title:
    "Effective Invest Yatırım Holding A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Effective Invest Yatırım Holding A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function EffectiveInvestYatirimHoldingASPage() {
  const summaryItems = [
    ...
    { label: "Aracı Kurum", value: "Yatırım Finansman Menkul Değerler A.Ş." },
  ...
  const fonKullanim = [
    "%65-80 Yeni yatırım imkanlarının finansmanı",
    "%10-20 İşletme sermayesi",
  ];

  const satisYontemi = ["Sabit Fiyatla Talep Toplama", "En İyi Gayret Aracılığı"];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "3,2 Milyar TL",
      d2024_9_4: "2,7 Milyar TL",
      d2023_12_4: "2,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "1,9 Milyar TL",
      d2024_9_4: "2,7 Milyar TL",
      d2023_12_4: "2,4 Milyar TL",
    },
  ];
  ...
  const istirakler = [
    { name: "Mia Teknoloji A.Ş.", capital: "494.000.000 TL", share: "%15" },
    {
      name: "Link Bilgisayar Sistemleri Yazılım ve Donanım San. ve Tic. A.Ş.",
      capital: "21.750.120,881 TL",
      share: "%20,17",
    },
    { name: "Enerjey Enerji A.Ş.", capital: "1.000.000 TL", share: "%60" },
    { name: "Globalx Ymc Danışmanlık San. Tic. A.Ş.", capital: "200.000 TL", share: "%55" },
    { name: "Hudsup Limited", capital: "412.600 GBP", share: "%1" },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Planlanıyor",
      desc: "Fiyat istikrarı işlemleri planlanmaktadır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="grid gap-8 xl:grid-cols-3">
          <div className="space-y-8 xl:col-span-2">
                  ...
                  <tbody>
                    {finansalVeriler.map((row, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-slate-700">{row.d2024_9_4}</td>
                        <td className="px-4 py-4 text-sm text-slate-700">{row.d2023_12_4}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between">
                <h2 className="text-xl font-bold text-slate-900">İştirakler</h2>
                <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700">
                  Portföy Görünümü
                </span>
              </div>
                  ...
                  <tbody>
                    {istirakler.map((row, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-slate-700">{row.capital}</td>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Effective Invest Yatırım Holding A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Effective Invest Yatırım Holding A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, fon kullanım alanları, iştirak yapısı ve finansal görünüm yer
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">Kullanılamaz.</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">Planlanmaktadır.</p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%24</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Effective Invest Yatırım Holding A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Effective Invest Yatırım Holding A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım yöntemi,
            halka açıklık oranı, fon kullanım alanları, iştirak yapısı, finansal veriler ve
