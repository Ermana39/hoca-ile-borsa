...
export const metadata: Metadata = {
  title:
    "Ic Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Ic Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, tahsisat grupları, fon kullanım alanları ve finansal veriler.",
};
...
export default function IcGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "494.651.628 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 328.606.513 Lot",
    "Ortak Satışı: 31.752.919 Lot (İbrahim Çeçen)",
    "Ortak Satışı: 27.061.710 Lot (Nezahat Çeçen)",
    "Ortak Satışı: 26.926.528 Lot (Serhat Çeçen)",
    "Ortak Satışı: 26.685.548 Lot (Murat Çeçen)",
    "Ortak Satışı: 26.685.548 Lot (Fırat Çeçen)",
    "Ortak Satışı: 26.685.548 Lot (Mehmet Salih Çeçen)",
    "Ortak Satışı: 247.314 Lot (Yıldırım Akdemir)",
  ];

  const fonKullanim = [
    "%40-45 Yeni yatırımların finansmanı (otel harici yatırımlar)",
    "%10-20 Mevcut gayrimenkullerin renovasyonu",
    "%15-20 Çeşme marina alımı kaynaklı borcun ödenmesi",
    "%20-25 Kredi ödemeleri",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "361,2 Milyon TL",
      d2024: "1,2 Milyar TL",
      d2023: "-",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "332,6 Milyon TL",
      d2024: "1,1 Milyar TL",
      d2023: "-",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "30 gün fiyat istikrarı planlanıyor. Ak Yatırım Menkul Değerler A.Ş. bilgisi yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">494.651.628</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Ic Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Ic Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    30 gün. Ak Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Ic Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Ic Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
