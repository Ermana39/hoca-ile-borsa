...
export const metadata: Metadata = {
  title:
    "Narlı Feribot İşletmeciliği A.Ş. Halka Arz Detayları | Taslak İzahname ve Finansal Veriler",
  description:
    "Narlı Feribot İşletmeciliği A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, bist kodu, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function NarliFeribotIsletmeciligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "7.500.000 Lot" },
    {
      label: "Aracı Kurum",
      value: "A1 Capital Yatırım Menkul Değerler A.Ş.",
    },
    { label: "BIST Kodu", value: "NARFE" },
    { label: "Pazar", value: "Yıldız Pazar" },
    { label: "Tahsisat", value: "Tamamı Eşit Dağıtım" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 4.500.000 Lot",
    "Ortak Satışı: 3.000.000 Lot (Negmar Denizcilik Yatırım A.Ş.)",
  ];

  const fonKullanim = [
    "%100 Lojistik alanında depo yatırımlarının finansmanı.",
  ];

  const tahsisat = ["Yoktur.", "Tamamı Eşit Dağıtım.", "T1-T2 Uygun."];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_9: "865,3 Milyon TL",
      d2022: "827,8 Milyon TL",
      d2021: "132,8 Milyon TL",
    },
    {
      kalem: "Brüt Kar",
      d2023_9: "157,2 Milyon TL",
      d2022: "117,4 Milyon TL",
      d2021: "67,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Dağıtım",
      value: "Eşit",
      desc: "Tamamı eşit dağıtım yöntemi ile planlanıyor.",
    },
    {
      title: "Fiyat İstikrarı",
      value: "Yok",
      desc: "Taslak izahnameye göre planlanmamaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">7.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">NARFE</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="grid gap-8 xl:grid-cols-3">
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Depo yatırımlarının finansmanı
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-4 text-xs italic font-semibold text-slate-500">
                Taslak İzahname, Sayfa 96.
              </p>
            </section>

            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Narlı Feribot İşletmeciliği A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Narlı Feribot İşletmeciliği A.Ş. halka arz sürecinde yatırımcıların en çok takip
                ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, bist kodu,
                dağıtım yöntemi, halka açıklık oranı, fon kullanım alanı ve finansal görünüm yer
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Narlı Feribot İşletmeciliği A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Narlı Feribot İşletmeciliği A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, bist kodu, dağıtım
            yöntemi, halka açıklık oranı, fon kullanım alanı, finansal veriler ve taahhüt detayları
