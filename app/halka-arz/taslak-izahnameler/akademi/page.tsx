...
export const metadata: Metadata = {
  ...
  description:
    "Akademi Çevre Entegre Atık Yönetimi Endüstri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AkademiCevreEntegreAtikYonetimiEndustriASPage() {
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "544,4 Milyon TL",
      d2023: "184,3 Milyon TL",
      d2022: "198,5 Milyon TL",
    },
  ];
