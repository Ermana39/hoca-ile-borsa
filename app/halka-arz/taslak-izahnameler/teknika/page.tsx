...
export const metadata: Metadata = {
  title:
    "Teknika Plast Teknik Kalıp Plastik San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Teknika Plast Teknik Kalıp Plastik San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TeknikaPlastTeknikKalıpPlastikSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "31.000.000 Lot" },
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "367,8 Milyon TL",
      d2023: "586,6 Milyon TL",
      d2022: "453,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%24,8",
      desc: "Planlanan halka açıklık oranı %24,8 seviyesindedir.",
    },
    {
      title: "Tahsisat",
      value: "4 Grup",
      desc: "Bireysel, yüksek başvurulu, yurt içi kurumsal ve yurt dışı kurumsal gruplar öne çıkmaktadır.",
    },
    {
      title: "Dağıtım",
      value: "Eşit / Oransal",
      desc: "Bireyselde eşit, yüksek başvuruluda oransal dağıtım yapısı öne çıkıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">31.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%24,8</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Teknika Plast Teknik Kalıp Plastik San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Teknika Plast Teknik Kalıp Plastik San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%24,8.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Teknika Plast Teknik Kalıp Plastik San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Teknika Plast Teknik Kalıp Plastik San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
