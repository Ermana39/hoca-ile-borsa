...
export const metadata: Metadata = {
  title:
    "Multikan Sağlık Ürünleri San. ve Dış Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Multikan Sağlık Ürünleri San. ve Dış Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};

export default function MultikanSaglikUrunleriSanVeDisTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 48.000.000 Lot",
    "Ortak Satışı: 7.200.000 Lot (Hakan Memiş)",
    "Ortak Satışı: 4.800.000 Lot (Deniz Gür)",
  ];

  const fonKullanim = [
    "%50 İşletme sermayesi",
    "%40 Depo yapım projesi",
    "%5 Yurt dışı yatırımları",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025: "621,1 Milyon TL",
      d2024: "690,6 Milyon TL",
      d2023: "534,9 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Dağıtım",
      value: "Tamamı Eşit",
      desc: "Tahsisat grubu bulunmuyor, tamamı eşit dağıtım.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Multikan Sağlık Ürünleri San. ve Dış Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Multikan Sağlık Ürünleri San. ve Dış Tic. A.Ş. halka arz sürecinde yatırımcıların
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30,30</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Multikan Sağlık Ürünleri San. ve Dış Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Multikan Sağlık Ürünleri San. ve Dış Tic. A.Ş. halka arz sayfasında yatırımcıların
