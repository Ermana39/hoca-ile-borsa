...
export const metadata: Metadata = {
  title:
    "Beşler Makarna Un İrmik Gıda San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Beşler Makarna Un İrmik Gıda San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BeslerMakarnaUnIrmikGidaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "44.365.000 Lot" },
  ...
  const tahsisat = [
    "31.055.500 Lot (%70) Yurt İçi Bireysel Yatırımcı",
    "13.309.500 Lot (%30) Yurt İçi Kurumsal Yatırımcı",
  ];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "3,8 Milyar TL",
      d2024: "8,3 Milyar TL",
      d2023: "8,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "505,6 Milyon TL",
      d2024: "571,0 Milyon TL",
      d2023: "664,9 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">44.365.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Beşler Makarna Un İrmik Gıda San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Beşler Makarna Un İrmik Gıda San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%23,35</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Beşler Makarna Un İrmik Gıda San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Beşler Makarna Un İrmik Gıda San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
