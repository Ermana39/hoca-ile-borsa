...
export const metadata: Metadata = {
  title:
    "Hür Çelik Sanayi ve Dış Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Hür Çelik Sanayi ve Dış Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function HurCelikSanayiVeDisTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 100.000.000 Lot"];

  const fonKullanim = [
    "%30-40 Mevcut kapasitenin artırılması",
    "%30-40 Finansal borçların ödenmesi",
    "%40-20 İşletme sermayesi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "995,4 Milyon TL",
      d2023: "2,0 Milyar TL",
      d2022: "2,6 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "253,8 Milyon TL",
      d2023: "287,7 Milyon TL",
      d2022: "287,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%23,81",
      desc: "Planlanan halka açıklık oranı %23,81 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "Tahsisat",
      value: "Oransal",
      desc: "Yüksek başvurulu yatırımcı grubu için oransal dağıtım yapısı öne çıkmaktadır.",
    },
    {
      title: "Kapasite",
      value: "Artış",
      desc: "Fon kullanımında mevcut kapasitenin artırılması önemli başlıklardan biridir.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%23,81</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Hür Çelik Sanayi ve Dış Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Hür Çelik Sanayi ve Dış Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%23,81.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Hür Çelik Sanayi ve Dış Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Hür Çelik Sanayi ve Dış Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
