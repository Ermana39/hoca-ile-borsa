...
export const metadata: Metadata = {
  title:
    "Narlı Feribot İşletmeciliği A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
...
export default function NarliFeribotIsletmeciligiASPage() {
  ...
  const fonKullanim = ["%100 Lojistik alanında depo yatırımlarının finansmanı."];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "T1-T2",
      value: "Uygun",
      desc: "Taslak izahnamede T1-T2 uygun bilgisi yer alıyor.",
    },
  ];
