...
export const metadata: Metadata = {
  title:
    "Masfen Enerji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Masfen Enerji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function MasfenEnerjiASPage() {
  const summaryItems = [
    ...
    { label: "Aracı Kurum", value: "Deniz Yatırım Menkul Kıymetler A.Ş." },
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "1,8 Milyar TL",
      d2023: "2,8 Milyar TL",
      d2022: "1,2 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "668,3 Milyon TL",
      d2023: "987,9 Milyon TL",
      d2022: "207,8 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Masfen Enerji A.Ş.</h1>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Masfen Enerji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Masfen Enerji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, ek pay, dağıtım yöntemi,
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,87, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Masfen Enerji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Masfen Enerji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
