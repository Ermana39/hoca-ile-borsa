...
export const metadata: Metadata = {
  title:
    "Fiba Faktoring A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Fiba Faktoring A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, bist kodu, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function FibaFaktoringASPage() {
  const summaryItems = [
  ...
  const fonKullanim = ["%100 Faktoring işlemlerinin finansmanı"];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_3: "782,8 Milyon TL",
      d2023: "1,8 Milyar TL",
      d2022: "650,2 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_3: "396,5 Milyon TL",
      d2023: "939,4 Milyon TL",
      d2022: "291,5 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Ek Pay",
      value: "13,68 Milyon",
      desc: "Taslak izahnamede ek ortak satışı da yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Fiba Faktoring A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">68.400.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">FIBAF</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
                  ...
                  <tbody>
                    {finansalVeriler.map((row, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-slate-700">{row.d2024_3}</td>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Fiba Faktoring A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Fiba Faktoring A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">13.680.000 Lot</p>
                </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%31,30, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Fiba Faktoring A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Fiba Faktoring A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, ek pay, dağıtım yöntemi, halka
