...
export const metadata: Metadata = {
  title:
    "Alcas Metal Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Alcas Metal Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AlcasMetalSanayiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "18.186.300 Lot" },
  ...
  const fonKullanim = [
    "%45 Planlanan yeni tesis yatırımına ilişkin yapılacak arazi, inşaat, makine ve teçhizat yatırımlarının finansmanı",
    "%6 Güneş Enerjisi Santrali (GES) yatırımları",
    "%9 Mevcut tesislere ilişkin makine ve teçhizat yatırımlarının finansmanı",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2023: "389,2 Milyon TL",
      d2022: "583,8 Milyon TL",
      d2021: "285,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Bireysel/Grup",
      desc: "Bireysel ve grup çalışanları için eşit dağıtım bilgisi yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">18.186.300</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="mb-2 text-sm font-semibold text-slate-800">
                      Mevcut tesis ve işletme sermayesi
                    </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Alcas Metal Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Alcas Metal Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%31,09</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Alcas Metal Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Alcas Metal Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
