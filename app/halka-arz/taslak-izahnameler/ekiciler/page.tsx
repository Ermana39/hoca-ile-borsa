...
export const metadata: Metadata = {
  title:
    "Ekiciler Süt Gıda Tarım Hayvancılık San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Ekiciler Süt Gıda Tarım Hayvancılık San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function EkicilerSutGidaTarimHayvancilikSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "20.873.946 Lot" },
    { label: "Aracı Kurum", value: "InvestAZ Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 10.436.973 Lot",
    "Ortak Satışı: 4.883.424 Lot (Necoi Erol)",
    "Ortak Satışı: 4.789.512 Lot (Necmi Erol)",
    "Ortak Satışı: 109.200 Lot (Hamit Erol)",
    "Ortak Satışı: 654.837 Lot (Muhammet Bayram)",
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%39,81",
      desc: "Planlanan halka açıklık oranı %39,81 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "Tahsisat",
      value: "3 Grup",
      desc: "Bireysel, yurt içi kurumsal ve yurt dışı kurumsal yatırımcı grupları yer almaktadır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">20.873.946</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%39,81</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Ekiciler Süt Gıda Tarım Hayvancılık San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Ekiciler Süt Gıda Tarım Hayvancılık San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en
                çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                ortak satışı, dağıtım yöntemi, tahsisat yapısı, fon kullanım alanları ve finansal
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%39,81.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Ekiciler Süt Gıda Tarım Hayvancılık San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Ekiciler Süt Gıda Tarım Hayvancılık San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
