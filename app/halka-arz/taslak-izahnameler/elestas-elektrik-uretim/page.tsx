...
export const metadata: Metadata = {
  title:
    "Elestaş Elektrik Üretim A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Elestaş Elektrik Üretim A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ElestasElektrikUretimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "102.000.000 Lot" },
    { label: "Aracı Kurum", value: "QNB Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 76.500.000 Lot",
    "Ortak Satışı: 12.546.739 Lot (Tema Trend Gayrimenkul San. ve Tic. Ltd. Şti.)",
    "Ortak Satışı: 6.348.378 Lot (Vahap Küçük)",
    "Ortak Satışı: 2.128.638 Lot (Ali Çiçek)",
  ];

  const fonKullanim = [
    "%75-85 Yatırım finansmanı",
    "%12-25 Finansman maliyeti azaltılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025: "34,1 Milyon TL",
      d2024: "138,4 Milyon TL",
      d2023: "427,0 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">102.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Aracı Kurum</div>
                  <div className="mt-1 text-sm font-bold">QNB Yatırım</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-slate-800">
                    Finansman maliyeti azaltılması
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Elestaş Elektrik Üretim A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Elestaş Elektrik Üretim A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Elestaş Elektrik Üretim A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Elestaş Elektrik Üretim A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
