...
export const metadata: Metadata = {
  title:
    "Kale Jet Motorları Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Kale Jet Motorları Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KaleJetMotorlariSanayiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "56.875.000 Lot" },
    { label: "Aracı Kurum", value: "Ak Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 32.500.000 Lot",
    "Ortak Satışı: 24.375.000 Lot (H. İbrahim Bodur Holding A.Ş.)",
  ];

  const fonKullanim = [
    "%50 Finansal borçluluğun azaltılması",
    "%30 Yeni ürün geliştirmeleri",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "560,4 Milyon TL",
      d2023: "293,8 Milyon TL",
      d2022: "155,8 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "161,2 Milyon TL",
      d2023: "130,3 Milyon TL",
      d2022: "78,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%36,31",
      desc: "Planlanan halka açıklık oranı %36,31 seviyesindedir.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">56.875.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%36,31</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kale Jet Motorları Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kale Jet Motorları Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%36,31.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kale Jet Motorları Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kale Jet Motorları Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
