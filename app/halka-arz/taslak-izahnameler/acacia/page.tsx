...
export const metadata: Metadata = {
  title:
    "Acacia Maden İşletmeleri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Acacia Maden İşletmeleri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AcaciaMadenIsletmeleriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "117.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Ortak Satışı: 46.800.000 Lot (Akfen Holding A.Ş.)",
    "Ortak Satışı: 46.800.000 Lot (İlbak Madencilik San. ve Tic. A.Ş.)",
    "Ortak Satışı: 23.400.000 Lot (BMA Madencilik San. ve Tic. A.Ş.)",
  ];

  const fonKullanim = [
    "Halka Arz Eden Pay Sahipleri, Akfen, İlbak ve BMA Madencilik'in mevcut paylarının halka arz kapsamında satılması yoluyla gerçekleştirileceğinden şirket herhangi bir gelir elde etmeyecektir.",
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "6 Ay",
      desc: "İhraççı ve ortaklar için 6 ay satmama taahhüdü bulunuyor.",
    },
    {
      title: "Gelir Kullanımı",
      value: "Şirkete Gelir Yok",
      desc: "Halka arz gelirinin şirket bünyesine girmeyeceği belirtiliyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">117.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Acacia Maden İşletmeleri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Acacia Maden İşletmeleri A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi,
                tahsisat oranları ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Acacia Maden İşletmeleri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Acacia Maden İşletmeleri A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım yöntemi,
            halka açıklık oranı, finansal veriler ve taahhüt detayları bir arada sunulmuştur.
