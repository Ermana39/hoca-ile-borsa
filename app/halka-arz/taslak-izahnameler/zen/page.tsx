...
export const metadata: Metadata = {
  title:
    "Zen Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Zen Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ZenGirisimSermayesiYatirimOrtakligiASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    "%70 Yeni girişim sermayesi yatırımları",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_9: "257,7 Milyon TL",
      d2022: "226,5 Milyon TL",
      d2021: "-",
    },
    {
      kalem: "Brüt Kâr",
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Planlanıyor",
      desc: "Taslak izahnamede fiyat istikrarının planlandığı belirtiliyor.",
    },
    {
      title: "T1-T2",
      value: "Uygun",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Zen Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Zen Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Zen Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Zen Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı
