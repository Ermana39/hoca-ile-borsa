...
export const metadata: Metadata = {
  title:
    "Kardemir Çelik Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Kardemir Çelik Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KardemirCelikSanayiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "180.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "8,9 Milyar TL",
      d2023: "11,6 Milyar TL",
      d2022: "7,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">180.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kardemir Çelik Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kardemir Çelik Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kardemir Çelik Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kardemir Çelik Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
