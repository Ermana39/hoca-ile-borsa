...
export const metadata: Metadata = {
  title:
    "Biem İlaç San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Biem İlaç San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BiemIlacSanVeTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 27.000.000 Lot",
    "Ortak Satışı: 3.000.000 Lot (Levent Canyurt)",
  ];

  const fonKullanim = [
    "%40-45 İşletme sermayesi",
    "%25-30 Finansal borç ödemeleri",
    "%20-25 Yeni yatırımların finansmanı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "746,4 Milyon TL",
      d2023: "1,0 Milyar TL",
      d2022: "887,1 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "445,6 Milyon TL",
      d2023: "667,7 Milyon TL",
      d2022: "413,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "15 Gün",
      desc: "Halka arz sonrası 15 gün fiyat istikrarı planlanıyor.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "Ar-Ge",
      value: "%5-10",
      desc: "Fon kullanımında Ar-Ge yatırımları için ayrıca pay ayrılması planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Fiyat İstikrarı</div>
                  <div className="mt-1 text-lg font-bold">15 Gün</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Biem İlaç San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Biem İlaç San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">15 gün.</p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Biem İlaç San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Biem İlaç San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
            için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi,
            fon kullanım alanları, finansal veriler ve taahhüt detayları bir arada sunulmuştur.
