...
export const metadata: Metadata = {
  title:
    "Sakarya Elektrik Dağıtım A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Sakarya Elektrik Dağıtım A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SakaryaElektrikDagitimASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 250.000.000 Lot (Aczen Enerji Yatırımları San. ve Tic. A.Ş.)",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "7,5 Milyar TL",
      d2024: "20,0 Milyar TL",
      d2023: "17,6 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "3,5 Milyar TL",
      d2024: "7,7 Milyar TL",
      d2023: "7,1 Milyar TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Sakarya Elektrik Dağıtım A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Sakarya Elektrik Dağıtım A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Sakarya Elektrik Dağıtım A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Sakarya Elektrik Dağıtım A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
