...
export const metadata: Metadata = {
  title:
    "Borsan Kablo Elektrik Aydınlatma İnşaat San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Borsan Kablo Elektrik Aydınlatma İnşaat San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BorsanKabloElektrikAydinlatmaInsaatSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "90.625.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 72.500.000 Lot",
    "Ortak Satışı: 16.312.500 Lot (Adnan Ölmez)",
    "Ortak Satışı: 1.812.500 Lot (Assaad Joseph Azar)",
  ];

  const fonKullanim = [
    "%50-55 Yeni fabrika entegre üretim tesisi ve alternatif yatırım fırsatları",
    "%15-25 İşletme sermayesi",
    "%25-30 Finansal borçluluğun azaltılması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "1,5 Milyar TL",
      d2024: "6,8 Milyar TL",
      d2023: "7,8 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "155,5 Milyon TL",
      d2024: "564,4 Milyon TL",
      d2023: "954,6 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">90.625.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Borsan Kablo Elektrik Aydınlatma İnşaat San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Borsan Kablo Elektrik Aydınlatma İnşaat San. ve Tic. A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım
                alanları, fiyat istikrarı ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Borsan Kablo Elektrik Aydınlatma İnşaat San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Borsan Kablo Elektrik Aydınlatma İnşaat San. ve Tic. A.Ş. halka arz sayfasında
            yatırımcıların hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot
            miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, halka açıklık oranı, fon kullanım
