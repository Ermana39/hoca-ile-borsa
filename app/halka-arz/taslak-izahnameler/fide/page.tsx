...
export const metadata: Metadata = {
  title:
    "Fide Konserve Gıda San. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Fide Konserve Gıda San. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function FideKonserveGidaSanASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "24.500.000 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 22.500.000 Lot",
    "Ortak Satışı: 1.000.000 Lot (Cemal Konaççı)",
    "Ortak Satışı: 1.000.000 Lot (Murad Konaççı)",
  ];

  const fonKullanim = [
    "%30-40 Yeni yatırımla kapasite artışı ve modernizasyon",
    "%60-70 Operasyonel büyüme",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "901,5 Milyon TL",
      d2023: "1,2 Milyar TL",
      d2022: "1,0 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "292,0 Milyon TL",
      d2023: "361,4 Milyon TL",
      d2022: "358,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Öncelikli",
      desc: "Fon kullanımında kapasite artışı ve modernizasyon yatırımları öne çıkmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">24.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Kapasite artışı ve modernizasyon
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Fide Konserve Gıda San. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Fide Konserve Gıda San. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Fide Konserve Gıda San. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Fide Konserve Gıda San. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
