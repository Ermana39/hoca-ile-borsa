...
export const metadata: Metadata = {
  title:
    "Oltan ve Köleoğlu Elektrik ve Enerji Üretimi Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Oltan ve Köleoğlu Elektrik ve Enerji Üretimi Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OltanVeKoleogluElektrikVeEnerjiUretimiTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 50.000.000 Lot (Orhan Veli Oltan)",
    "Ortak Satışı: 50.000.000 Lot (Gamze Köleoğlu Büyükkalp)",
  ];

  const fonKullanim = [
    "%90 Finansal yapının sağlamlaştırılması",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "2,5 Milyar TL",
      d2024: "3,2 Milyar TL",
      d2023: "2,1 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "666,4 Milyon TL",
      d2024: "804,3 Milyon TL",
      d2023: "386,3 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Oltan ve Köleoğlu Elektrik ve Enerji Üretimi Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Oltan ve Köleoğlu Elektrik ve Enerji Üretimi Tic. A.Ş. halka arz sürecinde
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    Planlayıcı kurum: Deniz Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Oltan ve Köleoğlu Elektrik ve Enerji Üretimi Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Oltan ve Köleoğlu Elektrik ve Enerji Üretimi Tic. A.Ş. halka arz sayfasında
