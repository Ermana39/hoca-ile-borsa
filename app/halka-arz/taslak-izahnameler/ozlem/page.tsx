...
export const metadata: Metadata = {
  title:
    "Özlem Tarım Ürünleri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Özlem Tarım Ürünleri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OzlemTarimUrunleriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "26.000.000 Lot" },
    { label: "Ek Pay", value: "Bulunmuyor" },
    { label: "Aracı Kurum", value: "Global Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 15.500.000 Lot",
    "Ortak Satışı: 1.115.625 Lot (Yağman Akış)",
    "Ortak Satışı: 1.115.625 Lot (Cihan Akış)",
    "Ortak Satışı: 1.115.625 Lot (Özlem Akış)",
    "Ortak Satışı: 1.695.750 Lot (Günay Guy Pagy)",
    "Ortak Satışı: 1.115.000 Lot (Frederic Fatih Pagy)",
    "Ortak Satışı: 630.000 Lot (Giyon Luc Emmanuel Pagy)",
    "Ortak Satışı: 535.500 Lot (Vittoria Desii)",
    "Ortak Satışı: 446.250 Lot (Carla Desii)",
    "Ortak Satışı: 1.575.000 Lot (Avril Pa)",
    "Ortak Satışı: 223.125 Lot (İşnsu Akış)",
    "Ortak Satışı: 245.438 Lot (Kemal Akış)",
    "Ortak Satışı: 446.250 Lot (Can Akış)",
    "Ortak Satışı: 200.182 Lot (Ayşe Akış)",
  ];

  const fonKullanim = [
    "%80-85 Yatırımların fonlanması",
    "%15-20 İşletme sermayesi",
  ];

  const tahsisat = ["Tahsisat grubu bulunmuyor."];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "696,2 Milyon TL",
      d2023: "702,8 Milyon TL",
      d2022: "555,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%22,51",
      desc: "Planlanan halka açıklık oranı %22,51 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">26.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%22,51</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Özlem Tarım Ürünleri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Özlem Tarım Ürünleri A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%22,51.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Özlem Tarım Ürünleri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Özlem Tarım Ürünleri A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
            için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi,
