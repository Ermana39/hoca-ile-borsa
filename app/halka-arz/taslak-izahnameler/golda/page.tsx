...
export const metadata: Metadata = {
  title:
    "Golda Gıda San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Golda Gıda San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, satış yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function GoldaGidaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "87.499.998 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2023: "235,5 Milyon TL",
      d2022: "211,5 Milyon TL",
      d2021: "173,5 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      desc: "Sabit fiyatla talep toplama yöntemi uygulanması planlanıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mb-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">87.499.998</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="grid gap-4 p-6 sm:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:border-blue-300 hover:bg-white">
              <div className="text-sm font-medium text-slate-500">Pazar</div>
              <div className="mt-2 whitespace-pre-line text-base font-semibold text-slate-900">
                Yıldız Pazar
              </div>
            </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Golda Gıda San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Golda Gıda San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, satış yöntemi,
                dağıtım yapısı, fon kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    30 gün. Brüt halka arz gelirinin %20'si. (Gedik Yatırım Menkul Değerler A.Ş.)
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Golda Gıda San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Golda Gıda San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
            için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım yöntemi, satış yöntemi,
