...
export const metadata: Metadata = {
  title:
    "Oğuzata Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Oğuzata Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OguzataGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "215.000.000 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 215.000.000 Lot"];

  const fonKullanim = [
    "%10-20 İşletme sermayesi",
    "%80-90 Mevcut projeler ile yeni yatırımların finansmanı",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "31,3 Milyon TL",
      d2023: "252,6 Bin TL",
      d2022: "-",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "22,1 Milyon TL",
      d2023: "252,6 Bin TL",
      d2022: "-",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Toplam Pay",
      value: "215 Milyon",
      desc: "Taslak izahnameye göre toplam halka arz payı 215.000.000 lot seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
    ...
    },
    {
      title: "Takvim",
      value: "2025 İçi",
      desc: "Tahmini halka arz takvimi 2025 yılı içerisinde tamamlanacak şekilde planlanmaktadır.",
    },
    {
      title: "Fiyat İstikrarı",
      value: "Bekleniyor",
      desc: "Fiyat istikrarı uygulamasına dair gün bilgisi henüz netleşmemiş görünüyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">215.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Takvim</div>
                  <div className="mt-1 text-lg font-bold">2025 İçi</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Oğuzata Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Oğuzata Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, pazar bilgisi, fon kullanım alanları, tahmini halka arz takvimi ve
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  <div className="text-sm font-semibold text-cyan-800">Pazar</div>
                  <p className="mt-2 text-sm text-cyan-900">Ana Pazar.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Oğuzata Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Oğuzata Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım
            yöntemi, pazar bilgisi, fon kullanım alanları, finansal veriler ve taahhüt detayları
            bir arada sunulmuştur. Sayfadaki bilgiler taslak izahnameye göre hazırlanmıştır ve resmi
