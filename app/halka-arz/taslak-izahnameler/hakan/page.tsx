...
export const metadata: Metadata = {
  title:
    "Hakan Faydasıçok Çelik A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Hakan Faydasıçok Çelik A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function HakanFaydasicokCelikASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    "%60-70 Sıcak ve soğuk haddeleme yatırımı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "1,0 Milyar TL",
      d2023: "2,7 Milyar TL",
      d2022: "3,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "229,8 Milyon TL",
      d2023: "408,2 Milyon TL",
      d2022: "437,7 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Hakan Faydasıçok Çelik A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Hakan Faydasıçok Çelik A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Hakan Faydasıçok Çelik A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Hakan Faydasıçok Çelik A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
