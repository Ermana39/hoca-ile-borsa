...
export const metadata: Metadata = {
  title:
    "Hastavuk Gıda Tarım Hayvancılık A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Hastavuk Gıda Tarım Hayvancılık A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function HastavukGidaTarimHayvancilikASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "271.500.000 Lot" },
    { label: "Ek Pay", value: "54.300.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 190.000.000 Lot",
    "Ortak Satışı: 81.500.000 Lot",
    "Ek Ortak Satışı: 53.300.000 Lot",
  ];

  const fonKullanim = [
    "%15-20 Damızlık üretim tesisleri yatırımı",
    "%5-10 İleri işleme tesisi yatırımı",
    "%35-40 Kesimhane yatırımı",
    "%25-30 Enerji tesisi yatırımı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "5,4 Milyar TL",
      d2024: "12,3 Milyar TL",
      d2023: "13,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">271.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">54.300.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Hastavuk Gıda Tarım Hayvancılık A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Hastavuk Gıda Tarım Hayvancılık A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">54.300.000 Lot</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,26, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Hastavuk Gıda Tarım Hayvancılık A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Hastavuk Gıda Tarım Hayvancılık A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
