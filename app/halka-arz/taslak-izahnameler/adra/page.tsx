...
export const metadata: Metadata = {
  title:
    "Adra Holding A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Adra Holding A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AdraHoldingASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "1.153.763.440 Lot" },
    {
      label: "Aracı Kurum",
      value: "Yatırım Finansman Menkul Değerler A.Ş.",
    },
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "2,1 Milyar TL",
      d2024: "8,1 Milyar TL",
      d2023: "11,1 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "518,7 Milyon TL",
      d2024: "2,0 Milyar TL",
      d2023: "3,6 Milyar TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Adra Holding A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">1.153.763.440</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Adra Holding A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Adra Holding A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Adra Holding A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Adra Holding A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
