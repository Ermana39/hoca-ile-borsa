...
export const metadata: Metadata = {
  title:
    "Soybaş Demir Çelik San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Soybaş Demir Çelik San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SoybasDemirCelikSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "62.500.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 5.000.000 Lot (Osman Soybaş)",
    "Ortak Satışı: 5.000.000 Lot (Ahmet Soybaş)",
    "Ortak Satışı: 2.500.000 Lot (Esra Soybaş)",
  ];

  const fonKullanim = [
    "%55-60 Yatırım finansmanı ve makine/ekipman alımları",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2023: "515,1 Milyon TL",
      d2022: "497,9 Milyon TL",
      d2021: "549,4 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">62.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Soybaş Demir Çelik San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Soybaş Demir Çelik San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%32,89</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Soybaş Demir Çelik San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Soybaş Demir Çelik San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
