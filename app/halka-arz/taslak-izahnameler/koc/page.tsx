...
export const metadata: Metadata = {
  title:
    "Koç Bakır Kablo San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Koç Bakır Kablo San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KocBakirKabloSanVeTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 58.000.000 Lot",
    "Ortak Satışı: 5.000.000 Lot (İsmail Koç)",
    "Ortak Satışı: 5.000.000 Lot (Engin Selim Koç)",
    "Ortak Satışı: 5.000.000 Lot (Muhammed Harun Raşit Koç)",
    "Ortak Satışı: 5.000.000 Lot (Şahin Alper)",
  ];

  const fonKullanim = [
    "%15-25 Üretim hattı kurulumu",
    "%45-55 Finansal borç ödemeleri",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "2,3 Milyar TL",
      d2024: "4,7 Milyar TL",
      d2023: "4,3 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "219,7 Milyon TL",
      d2024: "492,7 Milyon TL",
      d2023: "104,3 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "5 Gün",
      desc: "5 gün boyunca 4.000.000 adet günlük alım emri girilecek.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Koç Bakır Kablo San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Koç Bakır Kablo San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 4.000.000 adet günlük alım emri girilecek.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,16</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Koç Bakır Kablo San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Koç Bakır Kablo San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
