...
export const metadata: Metadata = {
  title:
    "Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function DebaAtikYonetimiVeElektrikUretimiYatirimSanayiiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "46.000.000 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 46.000.000 Lot"];

  const fonKullanim = [
    "%25-35 İşletme sermayesi",
    "%25-35 Finansal borçluluğun azaltılması",
    "%25-30 Kapasite artışı",
    "%10-15 Güneş enerjisi santrali (GES) yatırımı",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "318,8 Milyon TL",
      d2024: "846,0 Milyon TL",
      d2023: "708,1 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "83,6 Milyon TL",
      d2024: "150,4 Milyon TL",
      d2023: "193,9 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">
                  Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş.
                </h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">46.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş. halka arz sürecinde
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,3</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Deba Atık Yönetimi ve Elektrik Üretimi Yatırım Sanayii A.Ş. halka arz sayfasında
