...
export const metadata: Metadata = {
  title:
    "Birleşim Yeşil Enerji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Birleşim Yeşil Enerji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BirlesimYesilEnerjiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "115.500.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 77.000.000 Lot",
    "Ortak Satışı: 19.250.000 Lot (Mesut Altan)",
    "Ortak Satışı: 19.250.000 Lot (İdris Çakın)",
  ];

  const fonKullanim = [
    "%35-45 Şirket ve bağlı ortaklıkların finansal yapısının güçlendirilmesi ve finansman maliyetinin azaltılması",
    "%25-35 Organik büyüme finansmanı",
    "%15-25 Elektrik enerjisi üretim kapasitesi artırımı",
    "%5-15 Yenileme yatırımlarında kullanılması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_9: "361,9 Milyon TL",
      d2022: "376,5 Milyon TL",
      d2021: "92,4 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2023_9: "130,5 Milyon TL",
      d2022: "139,8 Milyon TL",
      d2021: "46,5 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    {
      title: "Enerji Büyümesi",
      value: "Kapasite Artışı",
      desc: "Fon kullanımında üretim kapasitesi artırımı ve organik büyüme öne çıkıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">115.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Birleşim Yeşil Enerji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Birleşim Yeşil Enerji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,02</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Birleşim Yeşil Enerji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Birleşim Yeşil Enerji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
