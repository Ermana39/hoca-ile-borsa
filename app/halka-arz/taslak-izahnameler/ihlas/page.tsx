...
export const metadata: Metadata = {
  title:
    "İhlas Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İhlas Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, satış yöntemi, finansal veriler ve temel halka arz bilgileri.",
};
...
export default function IhlasGirisimSermayesiYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Aracı Kurum", value: "Al Capital Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 200.000.000 Lot"];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Dağıtım",
      value: "Tam Eşit",
      desc: "Tahsisat grubu bulunmuyor ve tamamen eşit dağıtım yapısı öne çıkıyor.",
    },
    {
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "42,2 Milyon TL",
      d2023: "45,1 Milyon TL",
      d2022: "13,1 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "42,2 Milyon TL",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İhlas Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İhlas Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım
                yöntemi, satış yöntemi, finansal görünüm ve taahhüt detayları yer alıyor. Bu sayfada
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">200.000.000 Lot.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İhlas Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İhlas Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı
