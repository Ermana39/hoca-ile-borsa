...
export const metadata: Metadata = {
  title:
    "Sapro Temizlik Ürünleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Sapro Temizlik Ürünleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları, tahsisat grupları ve finansal veriler.",
};
...
export default function SaproTemizlikUrunleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "200.000.000 Lot" },
    { label: "Ek Pay", value: "20.000.000 Lot" },
    { label: "Aracı Kurum", value: "QNB Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 195.000.000 Lot",
    "Ortak Satışı: 2.500.000 Lot (CM Holding A.Ş.)",
    "Ortak Satışı: 1.250.000 Lot (Ceyhun Zincirkıran)",
    "Ortak Satışı: 1.250.000 Lot (Mehmet Gündoğdu)",
    "Ek Ortak Satışı: 10.000.000 Lot (CM Holding A.Ş.)",
    "Ek Ortak Satışı: 5.000.000 Lot (Ceyhun Zincirkıran)",
    "Ek Ortak Satışı: 5.000.000 Lot (Mehmet Gündoğdu)",
  ];

  const fonKullanim = [
    "%45-55 Finansman maliyetinin azaltılması",
    "%20-25 Makine ve ekipman yatırımı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "1,0 Milyar TL",
      d2024: "3,6 Milyar TL",
      d2023: "3,1 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "257,8 Milyon TL",
      d2024: "999,8 Milyon TL",
      d2023: "944,1 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%40",
      desc: "Planlanan halka açıklık oranı %40 seviyesindedir.",
    },
    {
      title: "Ek Pay",
      value: "20 Milyon",
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "Brüt halka arz gelirinin %20'si ile 30 gün fiyat istikrarı planlanıyor.",
    },
    {
      title: "Satmama",
      value: "1 Yıl",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">200.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">20.000.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Sapro Temizlik Ürünleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Sapro Temizlik Ürünleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ek pay,
                dağıtım yöntemi, fon kullanım alanları, tahsisat yapısı ve finansal görünüm yer
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">20.000.000 Lot</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%40.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Sapro Temizlik Ürünleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Sapro Temizlik Ürünleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
