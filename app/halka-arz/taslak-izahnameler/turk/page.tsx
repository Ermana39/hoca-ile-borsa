...
export const metadata: Metadata = {
  title:
    "Turk Oluklu Mukavva ve Ambalaj Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Turk Oluklu Mukavva ve Ambalaj Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TurkOlukluMukavvaVeAmbalajSanayiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "78.000.000 Lot" },
    { label: "Aracı Kurum", value: "A1 Capital Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 52.000.000 Lot",
    "Ortak Satışı: 13.000.000 Lot (Mehmet Berat Battal)",
    "Ortak Satışı: 13.000.000 Lot (Yunus Emre Battal)",
  ];

  const fonKullanim = [
    "%45 Üretim tesisi yatırımı",
    "%30 Hammadde tedariki ve işletme sermayesi",
    "%25 Finansal borç ödemesi",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "340,5 Milyon TL",
      d2023: "235,6 Milyon TL",
      d2022: "126,8 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%34,67",
      desc: "Planlanan halka açıklık oranı %34,67 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">78.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%34,67</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Turk Oluklu Mukavva ve Ambalaj Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Turk Oluklu Mukavva ve Ambalaj Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
                satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal görünüm
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%34,67.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Turk Oluklu Mukavva ve Ambalaj Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Turk Oluklu Mukavva ve Ambalaj Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı,
            dağıtım yöntemi, pazar bilgisi, halka açıklık oranı, fon kullanım alanları, finansal
            veriler ve taahhüt detayları bir arada sunulmuştur. Sayfadaki bilgiler taslak izahnameye
            göre hazırlanmıştır ve resmi veriler açıklandıkça güncellenmelidir.
          </p>
        </section>
      </div>
    </main>
