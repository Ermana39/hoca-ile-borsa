...
export const metadata: Metadata = {
  title:
    "Tellioğlu Yem-Gıda Entegre Tesisleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Tellioğlu Yem-Gıda Entegre Tesisleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TelliogluYemGidaEntegreTesisleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "70.500.000 Lot" },
    { label: "Aracı Kurum", value: "Bulls Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 47.000.000 Lot",
    "Ortak Satışı: 12.220.000 Lot (Halil Servet Tellioğlu)",
    "Ortak Satışı: 3.760.000 Lot (Mert Tellioğlu)",
    "Ortak Satışı: 3.760.000 Lot (Buse Tellioğlu Altındiş)",
    "Ortak Satışı: 3.760.000 Lot (Yiğit Tellioğlu)",
  ];

  const fonKullanim = [
    "%25-30 İşletme sermayesi",
    "%40-45 Finansal borçluluk seviyesinin azaltılması",
    "%20-25 Unlu mamuller tesisi kurulumu",
    "%5-10 Lojistik amaçlı taşıtların ve silobasların artırılması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "2,3 Milyar TL",
      d2024: "3,4 Milyar TL",
      d2023: "3,2 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "437,0 Milyon TL",
      d2024: "540,1 Milyon TL",
      d2023: "971,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Belirsiz",
      desc: "Fiyat istikrarı süresi henüz netleşmemiş görünüyor.",
    },
    {
    ...
    },
    {
      ...
      value: "2026 İlk Yarı",
      desc: "Halka arzın 2026 yılının ilk yarısında tamamlanması planlanıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">70.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Tellioğlu Yem-Gıda Entegre Tesisleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Tellioğlu Yem-Gıda Entegre Tesisleri San. ve Tic. A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, dağıtım yöntemi, tahsisat oranları, fon kullanım alanları ve
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    Süre bilgisi henüz netleşmemiştir.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%28,54</p>
                </div>

                <div className="rounded-2xl border border-sky-200 bg-sky-50 p-4">
                  <div className="text-sm font-semibold text-sky-800">Tahmini Halka Arz Takvimi</div>
                  <p className="mt-2 text-sm text-sky-900">
                    2026 yılının ilk yarısında tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Tellioğlu Yem-Gıda Entegre Tesisleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Tellioğlu Yem-Gıda Entegre Tesisleri San. ve Tic. A.Ş. halka arz sayfasında
            yatırımcıların hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot
            miktarı, dağıtım yöntemi, halka açıklık oranı, fon kullanım alanları, finansal veriler
