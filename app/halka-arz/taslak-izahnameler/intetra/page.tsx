...
export const metadata: Metadata = {
  title:
    "İntetra Teknoloji ve Bilişim Hizmetleri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İntetra Teknoloji ve Bilişim Hizmetleri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function IntetraTeknolojiVeBilisimHizmetleriASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 10.000.000 Lot (Mehmet Ömerbeyoğlu)",
  ];

  const fonKullanim = [
    "%30 İşletme sermayesi",
    "%10 Finansal borçların ödenmesi",
    "%60 Yatırımların finansmanı",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "737,6 Milyon TL",
      d2023: "1,7 Milyar TL",
      d2022: "823,4 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "301,5 Milyon TL",
      d2023: "714,6 Milyon TL",
      d2022: "219,3 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İntetra Teknoloji ve Bilişim Hizmetleri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İntetra Teknoloji ve Bilişim Hizmetleri A.Ş. halka arz sürecinde yatırımcıların en
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İntetra Teknoloji ve Bilişim Hizmetleri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İntetra Teknoloji ve Bilişim Hizmetleri A.Ş. halka arz sayfasında yatırımcıların hızlı
