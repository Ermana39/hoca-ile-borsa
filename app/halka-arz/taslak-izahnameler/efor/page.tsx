...
export const metadata: Metadata = {
  title:
    "Efor Gübre Madencilik San. Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Efor Gübre Madencilik San. Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function EforGubreMadencilikSanTicASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    ...
    "%15 Bağlı ortaklık sermaye artışı",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "614,2 Milyon TL",
      d2023: "608,9 Milyon TL",
      d2022: "352,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    {
      title: "İşletme Sermayesi",
      value: "%55",
      desc: "Fon kullanımında en yüksek pay işletme sermayesine ayrılmaktadır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Efor Gübre Madencilik San. Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Efor Gübre Madencilik San. Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    Gün bilgisi henüz netleşmemiş görünüyor.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Efor Gübre Madencilik San. Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Efor Gübre Madencilik San. Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
