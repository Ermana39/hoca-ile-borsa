...
export const metadata: Metadata = {
  title:
    "Bewen Enerji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Bewen Enerji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BewenEnerjiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "80.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "517,0 Milyon TL",
      d2023: "1,0 Milyar TL",
      d2022: "1,1 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "212,4 Milyon TL",
      d2023: "552,2 Milyon TL",
      d2022: "653,9 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%25,23",
      desc: "Planlanan halka açıklık oranı %25,23 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "RES Yatırımı",
      value: "Öncelikli",
      desc: "Fon kullanımında RES kapasite artışı yatırım finansmanı öne çıkmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Bewen Enerji A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">80.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%25,23</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Bewen Enerji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Bewen Enerji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700 italic">
                    Gün bilgisi ilerleyen aşamalarda netleşecektir.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,23.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Bewen Enerji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Bewen Enerji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için halka
            arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi, halka
            açıklık oranı, tahsisat dağılımı, fon kullanım alanları, finansal veriler ve taahhüt
