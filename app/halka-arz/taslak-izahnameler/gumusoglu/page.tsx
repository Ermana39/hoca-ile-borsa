...
export const metadata: Metadata = {
  title:
    "Gümüşoğlu Tekstil San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Gümüşoğlu Tekstil San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function GumusogluTekstilSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "112.500.000 Lot" },
    { label: "Ek Pay", value: "22.500.000 Lot" },
    { label: "Aracı Kurum", value: "Garanti Yatırım Menkul Kıymetler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 112.500.000 Lot",
    "Ortak Satışı: 22.500.000 Lot (İbrahim Gümüşoğlu)",
    "Ek Ortak Satışı: 11.250.000 Lot (İbrahim Gümüşoğlu)",
  ];

  const fonKullanim = [
    "%30-40 Finansman maliyetinin azaltılması",
    "%25-35 Yatırım finansmanı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "786,3 Milyon TL",
      d2024: "2,0 Milyar TL",
      d2023: "1,9 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "289,4 Milyon TL",
      d2024: "671,6 Milyon TL",
      d2023: "505,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Ek Pay",
      value: "22,5 Milyon",
      desc: "Taslakta ek pay yapısı da yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">112.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">22.500.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Gümüşoğlu Tekstil San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Gümüşoğlu Tekstil San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">22.500.000 Lot</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Gümüşoğlu Tekstil San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Gümüşoğlu Tekstil San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
