...
export const metadata: Metadata = {
  title:
    "Karesi Polyester ve Petrokimya Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Karesi Polyester ve Petrokimya Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KaresiPolyesterVePetrokimyaSanayiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "119.779.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 97.779.000 Lot",
    "Ortak Satışı: 22.000.000 Lot (Ramazan Bayduz)",
  ];

  const fonKullanim = [
    "%50-60 Üretim kapasite artışı ve yeni yatırımlar",
    "%40-50 İşletme sermayesi",
    "%2-5 Enerji yatırımları",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "9,3 Milyar TL",
      d2023: "19,1 Milyar TL",
      d2022: "17,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "1,9 Milyar TL",
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%10",
      desc: "Planlanan halka açıklık oranı %10 seviyesindedir.",
    },
    {
      title: "Tahmini Takvim",
      value: "2024 Q4",
      desc: "Tahmini halka arz takvimi 2024 yılının son çeyreğinde tamamlanacak şekilde planlanmaktadır.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">119.779.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Karesi Polyester ve Petrokimya Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Karesi Polyester ve Petrokimya Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
                satışı, dağıtım yöntemi, tahmini takvim, fon kullanım alanları ve finansal görünüm
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    Gün bilgisi netleşmedi, İş Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Karesi Polyester ve Petrokimya Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Karesi Polyester ve Petrokimya Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı
