...
export const metadata: Metadata = {
  title:
    "Biosys Biyomedikal Mühendislik San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Biosys Biyomedikal Mühendislik San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları, satış yöntemi ve finansal veriler.",
};
...
export default function BiosysBiyomedikalMuhendislikSanVeTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 25.000.000 Lot"];

  const fonKullanim = [
    "%40-45 Hemodiyaliz cihazı fabrikası",
    "%20-25 Sürekli cilt altı glukoz izlem sistemi (SGİ) yatırımı",
    "%7,5-12,5 Ar-Ge ve yeni ürün geliştirme",
    "%7,5-12,5 Uluslararası yapılanma, yeni ülkelere giriş ve organizasyon kurma",
    "%0-5 Kalite ve belgelendirme süreçleri",
    "%7,5-12,5 Stok yatırımı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "30,6 Milyon TL",
      d2024: "456,6 Milyon TL",
      d2023: "230,9 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "10,8 Milyon TL",
      d2024: "318,4 Milyon TL",
      d2023: "167,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%25",
      desc: "Planlanan halka açıklık oranı %25 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 md:col-span-2">
                  ...
                  <div className="text-sm text-slate-700">{fonKullanim[6]}</div>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Biosys Biyomedikal Mühendislik San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Biosys Biyomedikal Mühendislik San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların
                en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, satış yöntemi, fon kullanım alanları, fiyat istikrarı ve finansal
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Biosys Biyomedikal Mühendislik San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Biosys Biyomedikal Mühendislik San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların
            hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım
            yöntemi, satış yöntemi, halka açıklık oranı, fon kullanım alanları, finansal veriler ve
