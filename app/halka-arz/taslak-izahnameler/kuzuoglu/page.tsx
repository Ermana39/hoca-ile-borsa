...
export const metadata: Metadata = {
  title:
    "Kuzuoğlu Su Ürünleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Kuzuoğlu Su Ürünleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KuzuogluSuUrunleriSanVeTicASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    "%50 Balık yetiştiriciliği kapasitesinin artırımına yönelik yatırımlar",
    "%50 Hammadde tedariki ve işletme sermayesi ihtiyacının finansmanı",
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kuzuoğlu Su Ürünleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kuzuoğlu Su Ürünleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kuzuoğlu Su Ürünleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kuzuoğlu Su Ürünleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
