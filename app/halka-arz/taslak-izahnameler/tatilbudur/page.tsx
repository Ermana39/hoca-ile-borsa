...
export const metadata: Metadata = {
  title:
    "Tatilbudur Seyahat Acenteliği ve Turizm A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Tatilbudur Seyahat Acenteliği ve Turizm A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve halka açıklık bilgileri.",
};
...
export default function TatilbudurSeyahatAcenteligiVeTurizmASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "55.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const oneCikanlar = [
    {
      title: "Toplam Pay",
      value: "55 Milyon",
      desc: "Toplam halka arz büyüklüğü 55.000.000 lot olarak planlanıyor.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      ...
      value: "27,5 Milyon",
      desc: "Halka arzın yarısı sermaye artırımı tarafında bulunuyor.",
    },
    {
      title: "Ortak Satışı",
      value: "27,5 Milyon",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">55.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-5 text-xl font-bold text-slate-900">
                Tatilbudur Seyahat Acenteliği ve Turizm A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Tatilbudur Seyahat Acenteliği ve Turizm A.Ş. halka arz sürecinde yatırımcıların en
                çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, sermaye artırımı ve ortak satışı dengesi yer alıyor. Bu sayfada
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Tatilbudur Seyahat Acenteliği ve Turizm A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Tatilbudur Seyahat Acenteliği ve Turizm A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım
            yöntemi, sermaye artırımı ve ortak satışı bilgileri bir arada sunulmuştur. Taslak
            izahname verilerinde henüz netleşmeyen başlıklar açıklandıkça sayfa güncellenmelidir.
          </p>
        </section>
      </div>
    </main>
