...
export const metadata: Metadata = {
  title:
    "Uras Kimya San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Uras Kimya San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function UrasKimyaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "16.200.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 11.340.000 Lot",
    "Ortak Satışı: 4.860.000 Lot (Murat Özavşar)",
  ];

  const fonKullanim = [
    "%60 Finansal borcun kapatılması",
    "%40 İhracat yapılan ülkelerde satış ağının kurulması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_9: "337,0 Milyon TL",
      d2022: "409,8 Milyon TL",
      d2021: "216,1 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2023_9: "125,5 Milyon TL",
      d2022: "143,8 Milyon TL",
      d2021: "75,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Tamamı Eşit",
      desc: "Tahsisat grubu bulunmuyor, tamamen eşit dağıtım planlanıyor.",
    },
    {
      title: "T1-T2",
      value: "Uygun",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">16.200.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Uras Kimya San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Uras Kimya San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,24</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Uras Kimya San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Uras Kimya San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
