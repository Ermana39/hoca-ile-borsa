...
export const metadata: Metadata = {
  title:
    "Inavitas Enerji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Inavitas Enerji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function InavitasEnerjiASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 10.000.000 Lot (Alper Terciyanlı)",
  ];

  const fonKullanim = [
    "%35-45 Ar-Ge yatırımları ve yeni ürünlerin ticarileştirilmesi",
    "%15-20 Global pazarlarda büyüme",
    "%25-30 Yatırım fırsatlarının fonlanması",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "1,2 Milyar TL",
      d2024: "941,9 Milyon TL",
      d2023: "623,8 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "286,8 Milyon TL",
      d2024: "388,8 Milyon TL",
      d2023: "344,2 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Inavitas Enerji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Inavitas Enerji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,83</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Inavitas Enerji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Inavitas Enerji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
