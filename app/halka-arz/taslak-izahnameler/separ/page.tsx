...
export const metadata: Metadata = {
  title:
    "Separ Plastik San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Separ Plastik San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SeparPlastikSanVeTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 90.000.000 Lot",
    "Ortak Satışı: 30.000.000 Lot (Önder Bal)",
  ];

  const fonKullanim = [
    "%30 Yeni makine ve kalıp yatırımları",
    "%30 İşletme sermayesi",
    "%15 Güneş enerjisi santrali yatırımları",
    "%15 Yurt dışı depo kurulumu yatırımı",
    "%10 Yüksek maliyetli banka kredilerinin kapatılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "207,9 Milyon TL",
      d2023: "203,2 Milyon TL",
      d2022: "336,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%35,29",
      desc: "Planlanan halka açıklık oranı %35,29 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
    ...
    },
    {
      title: "Günlük Alım",
      value: "6 Milyon",
      desc: "5 gün boyunca 6.000.000 adet günlük alım emri taahhüdü yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%35,29</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Separ Plastik San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Separ Plastik San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 6.000.000 adet günlük alım emri verilecek.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%35,29.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Separ Plastik San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Separ Plastik San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
