...
export const metadata: Metadata = {
  title:
    "Dorçe Prefabrik Yapı ve İnşaat Sanayii Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Dorçe Prefabrik Yapı ve İnşaat Sanayii Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function DorcePrefabrikYapiVeInsaatSanayiiTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "174.000.000 Lot" },
    { label: "Aracı Kurum", value: "Ahlatcı Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 174.000.000 Lot"];

  const fonKullanim = [
    "%35-40 İşletme sermayesi",
    "%25-35 Finansal borçluluğun azaltılması",
    "%15-25 Üretim tesisi",
    "%5-15 ConTech (İnşaat Teknolojileri) odaklı modernizasyon, otomasyon ve dijital dönüşüm yatırımları",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "889,7 Milyon TL",
      d2023: "2,7 Milyar TL",
      d2022: "468,3 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">174.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Dorçe Prefabrik Yapı ve İnşaat Sanayii Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Dorçe Prefabrik Yapı ve İnşaat Sanayii Tic. A.Ş. halka arz sürecinde yatırımcıların
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%23,20</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Dorçe Prefabrik Yapı ve İnşaat Sanayii Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Dorçe Prefabrik Yapı ve İnşaat Sanayii Tic. A.Ş. halka arz sayfasında yatırımcıların
