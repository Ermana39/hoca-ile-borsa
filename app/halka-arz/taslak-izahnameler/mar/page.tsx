...
export const metadata: Metadata = {
  title:
    "Mar Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Mar Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function MarGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "157.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 22.400.000 Lot (Münir Özkök)",
    "Ortak Satışı: 9.600.000 Lot (Yusuf Arslan)",
  ];

  const fonKullanim = [
    "%85 Gayrimenkul yatırımları ile gayrimenkul projelerinin finansmanı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "155,9 Milyon TL",
      d2024: "379,9 Milyon TL",
      d2023: "368,0 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "76,2 Milyon TL",
      d2024: "55,4 Milyon TL",
      d2023: "144,6 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">157.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Mar Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Mar Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,12</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Mar Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Mar Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
