...
export const metadata: Metadata = {
  title:
    "Kapeks Kimya Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Kapeks Kimya Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KapeksKimyaSanayiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "12.550.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 12.550.000 Lot"];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "1,2 Milyar TL",
      d2023: "3,1 Milyar TL",
      d2022: "3,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "442,4 Milyon TL",
      d2023: "1,2 Milyar TL",
      d2022: "1,2 Milyar TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">12.550.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Üretim, depo ve alternatif yatırımlar
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kapeks Kimya Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kapeks Kimya Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    15 gün. Brüt halka arz gelirinin %20'si. Ziraat Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,1</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kapeks Kimya Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kapeks Kimya Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
