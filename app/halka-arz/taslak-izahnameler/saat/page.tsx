...
export const metadata: Metadata = {
  title:
    "Saat ve Saat San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Saat ve Saat San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SaatVeSaatSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "136.944.954 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 54.777.982 Lot",
    "Ortak Satışı: 28.123.335 Lot (Ramazan Kaya)",
    "Ortak Satışı: 28.123.335 Lot (Hamza Kaya)",
    "Ortak Satışı: 25.920.302 Lot (Nurullah Dönmez)",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_3: "1,5 Milyar TL",
      d2023: "5,8 Milyar TL",
      d2022: "3,9 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_3: "804,4 Milyon TL",
      d2023: "3,6 Milyar TL",
      d2022: "2,4 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Belirlenecek",
      desc: "Fiyat istikrarı süresi henüz netleşmemiş, Halk Yatırım bilgisi yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">136.944.954</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Saat ve Saat San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Saat ve Saat San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    Süre bilgisi henüz netleşmemiştir. Halk Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,29</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Saat ve Saat San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Saat ve Saat San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
