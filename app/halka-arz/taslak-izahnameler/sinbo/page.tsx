...
export const metadata: Metadata = {
  title:
    "Sinbo Küçük Ev Aletleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Sinbo Küçük Ev Aletleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SinboKucukEvAletleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "233.534.772 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 233.534.772 Lot"];

  const fonKullanim = [
    "%6,67 Yurt dışı yatırımları",
    "%10,00 Yurt içi yatırımları",
    "%83,33 Borçların ödenmesi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "1,5 Milyar TL",
      d2024: "2,0 Milyar TL",
      d2023: "2,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "349,3 Milyon TL",
      d2024: "777,5 Milyon TL",
      d2023: "871,2 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">233.534.772</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Sinbo Küçük Ev Aletleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Sinbo Küçük Ev Aletleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,07</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Sinbo Küçük Ev Aletleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Sinbo Küçük Ev Aletleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
