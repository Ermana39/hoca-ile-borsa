...
export const metadata: Metadata = {
  title:
    "(nef) Timur Gayrimenkul Geliştirme Yapı ve Yatırım A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "(nef) Timur Gayrimenkul Geliştirme Yapı ve Yatırım A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, bist kodu, tahsisat dağılımı, fon kullanım alanları ve finansal veriler.",
};
...
export default function TimurGayrimenkulGelistirmeYapiVeYatirimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "116.545.019 Lot" },
    { label: "Aracı Kurum", value: "Gedik Yatırım Menkul Değerler A.Ş." },
    { label: "BIST Kodu", value: "TIMUR" },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 105.950.017 Lot",
    "Ortak Satışı: 10.595.001 Lot (Erden Timur)",
  ];

  const fonKullanim = [
    "%60 Konut projeleri",
    "%40 Nef arsa projeleri",
  ];

  const tahsisat = [
    "46.618.007 Lot (%40) Yurt İçi Bireysel Yatırımcı",
    "11.654.501 Lot (%10) Yüksek Başvurulu Yatırımcı",
    "29.136.254 Lot (%25) Yurt İçi Kurumsal Yatırımcı",
    "29.136.254 Lot (%25) Yurt Dışı Kurumsal Yatırımcı",
  ];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "1,3 Milyar TL",
      d2024: "3,4 Milyar TL",
      d2023: "4,7 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "314,1 Milyon TL",
      d2024: "653,1 Milyon TL",
      d2023: "277,8 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "Brüt halka arz gelirinin %10'u ile fiyat istikrarı planlanıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">116.545.019</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">TIMUR</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                (nef) Timur Gayrimenkul Geliştirme Yapı ve Yatırım A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                (nef) Timur Gayrimenkul Geliştirme Yapı ve Yatırım A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, bist kodu, tahsisat oranları, fon kullanım alanları ve
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            (nef) Timur Gayrimenkul Geliştirme Yapı ve Yatırım A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            (nef) Timur Gayrimenkul Geliştirme Yapı ve Yatırım A.Ş. halka arz sayfasında
            yatırımcıların hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot
            miktarı, bist kodu, tahsisat dağılımı, halka açıklık oranı, fon kullanım alanları,
