...
export const metadata: Metadata = {
  title:
    "(enterprise) Yes Oto Kiralama ve Turizm Yatırımları A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "(enterprise) Yes Oto Kiralama ve Turizm Yatırımları A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, bist kodu, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function YesOtoKiralamaVeTurizmYatirimlariASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "35.000.000 Lot" },
    { label: "Ek Pay", value: "5.250.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
        "Ak Yatırım Menkul Değerler A.Ş.\nDeniz Yatırım Menkul Değerler A.Ş.",
    },
    { label: "BIST Kodu", value: "YESOT" },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 25.000.000 Lot",
    "Ortak Satışı: 10.000.000 Lot (Adnan Başdemir, Özarslan Abdulkadir Tangün, Mustafa Başdemir)",
    "Ek Ortak Satışı: 5.250.000 Lot (Adnan Başdemir, Özarslan Abdulkadir Tangün, Mustafa Başdemir)",
  ];

  const fonKullanim = [
    "%70 Yeni taşıt alımı, büyüme, yeni yatırımların finansmanı",
    "%30 İşletme sermayesi ve finansal borçların azaltılması",
  ];

  const tahsisat = [
    "Yurt İçi Bireysel Yatırımcı: Açıklanmadı",
    "Yurt İçi Kurumsal Yatırımcı: Açıklanmadı",
    "Ek satış Bireysel Yatırımcı Grubu'na dağıtılacaktır.",
  ];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_6: "2,6 Milyar TL",
      d2022: "2,7 Milyar TL",
      d2021: "2,0 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2023_6: "1,6 Milyar TL",
      d2022: "1,5 Milyar TL",
      d2021: "690,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Ek Pay",
      value: "5,25 Milyon",
      desc: "Ek satış bireysel yatırımcı grubuna dağıtılacaktır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">35.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">YESOT</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-slate-800">
                    İşletme sermayesi ve borç azaltımı
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                (enterprise) Yes Oto Kiralama ve Turizm Yatırımları A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                (enterprise) Yes Oto Kiralama ve Turizm Yatırımları A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, ek pay, bist kodu, dağıtım yöntemi, fon kullanım alanları ve
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,16, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            (enterprise) Yes Oto Kiralama ve Turizm Yatırımları A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            (enterprise) Yes Oto Kiralama ve Turizm Yatırımları A.Ş. halka arz sayfasında
            yatırımcıların hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot
            miktarı, ek pay, bist kodu, dağıtım yöntemi, halka açıklık oranı, fon kullanım
