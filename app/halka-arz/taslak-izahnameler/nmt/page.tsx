...
export const metadata: Metadata = {
  title:
    "Nmt Lojistik A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Nmt Lojistik A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function NmtLojistikASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "60.000.000 Lot" },
    { label: "Ek Pay", value: "12.000.000 Lot" },
    { label: "Aracı Kurum", value: "Alnus Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 50.000.000 Lot",
    "Ortak Satışı: 2.500.000 Lot (Nadir Taşkın)",
    "Ortak Satışı: 2.500.000 Lot (Mustafa Taşkın)",
    "Ortak Satışı: 2.500.000 Lot (Nevzat Taşkın)",
    "Ortak Satışı: 2.500.000 Lot (Hamit Taşkın)",
    "Ortak Satışı: 500.000 Lot (Yahya Kemal Savaş)",
    "Ek Ortak Satışı: 3.500.000 Lot (Nadir Taşkın)",
    "Ek Ortak Satışı: 2.800.000 Lot (Mustafa Taşkın)",
    "Ek Ortak Satışı: 2.800.000 Lot (Nevzat Taşkın)",
    "Ek Ortak Satışı: 2.400.000 Lot (Hamit Taşkın)",
    "Ek Ortak Satışı: 500.000 Lot (Yahya Kemal Savaş)",
  ];

  const fonKullanim = [
    "%50-60 Lojistik ve depoculuk faaliyetleri yatırımları",
    "%40-50 İşletme sermayesi",
    "%10-20 Banka kredisi kapatılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "855,3 Milyon TL",
      d2023: "804,8 Milyon TL",
      d2022: "1,4 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%24",
      desc: "Planlanan halka açıklık oranı ek satış dahil yaklaşık %24 seviyesindedir.",
    },
    {
    ...
    },
    {
      ...
      value: "2025 İkinci Çeyrek",
      desc: "Tahmini halka arz takvimi 2025 yılının ikinci çeyreğinde tamamlanacak şekilde planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Nmt Lojistik A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">60.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">12.000.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Nmt Lojistik A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Nmt Lojistik A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, ek pay satışı, dağıtım
                yöntemi, tahmini takvim, fon kullanım alanları ve finansal görünüm yer alıyor. Bu
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    2025 yılının birinci çeyreğinde tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%24, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Nmt Lojistik A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Nmt Lojistik A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, ek pay büyüklüğü, dağıtım yöntemi,
