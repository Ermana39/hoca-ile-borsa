...
export const metadata: Metadata = {
  title:
    "İstinyepark İstanbul Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İstinyepark İstanbul Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function IstinyeparkIstanbulGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "156.825.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 117.300.000 Lot",
    "Ortak Satışı: 19.762.500 Lot (Zafer Kurşun)",
    "Ortak Satışı: 19.762.500 Lot (Zafer Yıldırım)",
  ];

  const fonKullanim = [
    "%95-100 Finansal borç ödemesi",
    "%0-5 AVM yenileme yatırımları",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "3,0 Milyar TL",
      d2024: "5,0 Milyar TL",
      d2023: "974,4 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "2,7 Milyar TL",
      d2024: "4,4 Milyar TL",
      d2023: "886,9 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Belirsiz",
      desc: "Süre bilgisi henüz netleşmemiş, İş Yatırım Menkul Değerler A.Ş. bilgisi yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">156.825.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İstinyepark İstanbul Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İstinyepark İstanbul Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    Süre bilgisi henüz netleşmemiştir. İş Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İstinyepark İstanbul Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İstinyepark İstanbul Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında
