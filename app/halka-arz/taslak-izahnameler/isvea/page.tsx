...
export const metadata: Metadata = {
  title:
    "İsvea Seramik ve Banyo Ürünleri Sanayi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İsvea Seramik ve Banyo Ürünleri Sanayi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function IsveaSeramikVeBanyoUrunleriSanayiASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 60.000.000 Lot"];

  const fonKullanim = [
    "%10-15 Özetime yönelik yenilenebilir enerji yatırımları",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "869,7 Milyon TL",
      d2023: "2,0 Milyar TL",
      d2022: "1,6 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "252,4 Milyon TL",
      d2023: "446,5 Milyon TL",
      d2022: "(-)20,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "30 gün fiyat istikrarı planlanıyor. Halk Yatırım Menkul Değerler A.Ş. bilgisi yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İsvea Seramik ve Banyo Ürünleri Sanayi A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İsvea Seramik ve Banyo Ürünleri Sanayi A.Ş. halka arz sürecinde yatırımcıların en
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    30 gün. Halk Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İsvea Seramik ve Banyo Ürünleri Sanayi A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İsvea Seramik ve Banyo Ürünleri Sanayi A.Ş. halka arz sayfasında yatırımcıların hızlı
