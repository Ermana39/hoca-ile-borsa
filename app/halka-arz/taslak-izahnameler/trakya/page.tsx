...
export const metadata: Metadata = {
  title:
    "(Tredaş) Trakya Elektrik Dağıtım A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "(Tredaş) Trakya Elektrik Dağıtım A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TredasTrakyaElektrikDagitimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "41.068.259 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 28.747.781 Lot",
    "Ortak Satışı: 12.320.378 Lot (İçtaş Trakya Enerji Yatırımları ve Tic. A.Ş.)",
    "Ortak Satışı: 50 Lot (Serhat Çeçen)",
    "Ortak Satışı: 25 Lot (Fırat Çeçen)",
    "Ortak Satışı: 25 Lot (Mehmet Salih Çeçen)",
  ];

  const fonKullanim = [
    "%60-70 Yatırım harcamaları",
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%21,93",
      desc: "Planlanan halka açıklık oranı %21,93 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Yıldız Pazar",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">41.068.259</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%21,93</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                (Tredaş) Trakya Elektrik Dağıtım A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                (Tredaş) Trakya Elektrik Dağıtım A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
                satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları, tahsisat yapısı ve
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%21,93.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            (Tredaş) Trakya Elektrik Dağıtım A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            (Tredaş) Trakya Elektrik Dağıtım A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
