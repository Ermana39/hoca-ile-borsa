...
export const metadata: Metadata = {
  title:
    "Milk Academy Süt Ürünleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Milk Academy Süt Ürünleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function MilkAcademySutUrunleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "47.150.000 Lot" },
    { label: "Aracı Kurum", value: "İntegral Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 47.150.000 Lot"];

  const fonKullanim = [
    "%35 İşletme sermayesi",
    "%30 Dondurma üretim hattı yatırımı",
    "%10 Ar-Ge inovasyon yatırımı",
    "%5 Bilgi sistemleri insan kaynakları geliştirme yatırımları",
    "%10 Mevcut üretim sistemlerinin geliştirilmesi ve modernizasyon yatırımı",
    "%10 Finansal borçların kapatılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "149,6 Milyon TL",
      d2023: "135,0 Milyon TL",
      d2022: "127,3 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "Brüt halka arz gelirinin %10'u ile 30 gün fiyat istikrarı planlanmaktadır.",
    },
    {
      title: "T1-T2",
      value: "Uygun",
      desc: "Talep sürecinde T1-T2 bakiye kullanımına uygun yapı belirtiliyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">47.150.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Pazar</div>
                  <div className="mt-1 text-lg font-bold">Ana Pazar</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Milk Academy Süt Ürünleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Milk Academy Süt Ürünleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, satış yöntemi, fon kullanım alanları ve finansal görünüm yer alıyor.
                Bu sayfada şirketin taslak izahname verileri daha sade ve analiz edilebilir bir yapıda
                sunulmuştur.
              </p>
            </section>
          </div>
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    30 gün, brüt halka arz gelirinin %10&apos;u.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  <div className="text-sm font-semibold text-cyan-800">Pay</div>
                  <p className="mt-2 text-sm text-cyan-900">47.150.000 Lot.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Milk Academy Süt Ürünleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Milk Academy Süt Ürünleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım
            yöntemi, satış yöntemi, finansal veriler ve taahhüt detayları bir arada sunulmuştur.
