...
export const metadata: Metadata = {
  title:
    "Özova Tarım A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Özova Tarım A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OzovaTarimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "23.600.000 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 17.700.000 Lot",
    "Ortak Satışı: 5.900.000 Lot (GrainTurk Holding A.Ş.)",
  ];

  const fonKullanim = [
    "%15-20 Yeni depo yatırımları ve mevcut depoların modernizasyonu",
    "%40 İşletme sermayesi",
    "%30 Makarna üretim tesisi yatırımı",
    "%10-15 Mevcut finansal borçların azaltılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "781,6 Milyon TL",
      d2023: "598,8 Milyon TL",
      d2022: "470,5 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%20,05",
      desc: "Planlanan halka açıklık oranı %20,05 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "Depo ve Tesis",
      value: "Yatırım",
      desc: "Fon kullanımında depo modernizasyonu ve makarna üretim tesisi yatırımı dikkat çekiyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Özova Tarım A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">23.600.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%20,05</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Özova Tarım A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Özova Tarım A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı, dağıtım
                yöntemi, fon kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada şirketin
                taslak izahname verileri daha sade ve analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,05.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Özova Tarım A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Özova Tarım A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için halka
            arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi, halka açıklık
