...
export const metadata: Metadata = {
  title:
    "Hdm Çelik Boru San. ve Tic. A.Ş. Halka Arz Detayları | Taslak İzahname ve Finansal Veriler",
  description:
    "Hdm Çelik Boru San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, aracı kurum bilgileri, finansal veriler ve halka açıklık oranı.",
};
...
export default function HdmCelikBoruSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "33.333.334 Lot" },
    { label: "Ek Pay", value: "6.666.666 Lot" },
    {
      label: "Aracı Kurum",
      value: "Ak Yatırım Menkul Değerler A.Ş.",
    },
    { label: "BIST Kodu", value: "HDMCB" },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 16.666.667 Lot",
    "Ortak Satışı: 5.500.000 Lot (Muhiddin Murat Kandemir)",
    "Ortak Satışı: 5.500.000 Lot (Veysel Kurt)",
    "Ortak Satışı: 5.500.000 Lot (Ezgi Ayhan)",
    "Ortak Satışı: 166.667 Lot (Ayşe Banu Başkut)",
    "Ek Pay Ortak Satışı: 2.222.222 Lot (Muhiddin Murat Kandemir)",
    "Ek Pay Ortak Satışı: 2.222.222 Lot (Veysel Kurt)",
    "Ek Pay Ortak Satışı: 2.222.222 Lot (Ezgi Ayhan)",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2022_6: "826,8 Milyon TL",
      d2021: "754,9 Milyon TL",
      d2020: "465,8 Milyon TL",
    },
    {
      kalem: "Brüt Kar",
      d2022_6: "242,8 Milyon TL",
      d2021: "197 Milyon TL",
      d2020: "101,2 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Ek Pay",
      value: "6,67 Mn",
      desc: "Planlanan ek satış kapsamındaki pay miktarı.",
    },
    {
      title: "Dağıtım",
      value: "Oransal",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">33.333.334</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">HDMCB</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
                  ...
                  <tbody>
                    {finansalVeriler.map((row, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-slate-700">{row.d2022_6}</td>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Hdm Çelik Boru San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Hdm Çelik Boru San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
                ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ek pay,
                dağıtım yöntemi, tahsisat yapısı, halka açıklık oranı ve finansal görünüm yer
          ...
          <aside className="space-y-8">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-sm font-semibold text-slate-800">Dağıtım Yöntemi</div>
                  <p className="mt-2 text-sm text-slate-700">Oransal Dağıtım</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">6 Ay, İhraççı.</p>
                  <p className="mt-1 text-sm text-blue-900">6 Ay, Ortaklar.</p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%10.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Hdm Çelik Boru San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Hdm Çelik Boru San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, ek pay, dağıtım
            yöntemi, aracı kurum bilgisi, halka açıklık oranı, tahsisat yapısı ve finansal veriler
            bir arada sunulmuştur. Sayfadaki bilgiler taslak izahnameye göre hazırlanmıştır.
          </p>
        </section>
      </div>
    </main>
