...
export const metadata: Metadata = {
  title:
    "Pürsan Pigment Ürünleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Pürsan Pigment Ürünleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function PursanPigmentUrunleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "85.000.000 Lot" },
    { label: "Aracı Kurum", value: "InvestAZ Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 45.000.000 Lot",
    "Ortak Satışı: 40.000.000 Lot (Hakkı Kağan Biter)",
  ];

  const fonKullanim = [
    "%40-50 İşletme sermayesi",
    "%20-30 Tesis satın alınması",
    "%10-20 Markalaşma, perakendeleşme yatırımı",
    "%5-10 Makine, cihaz yatırımları, ürün çeşitliliği ve verimliliğin artırılması",
    "%5-10 İhracat potansiyelinin yükseltilmesi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "603,3 Milyon TL",
      d2023: "1,0 Milyar TL",
      d2022: "1,0 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "191,1 Milyon TL",
      d2023: "248,2 Milyon TL",
      d2022: "211,2 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%34,62",
      desc: "Planlanan halka açıklık oranı %34,62 seviyesindedir.",
    },
    {
      title: "Tahsisat",
      value: "4 Grup",
      desc: "Bireysel, kurumsal, yurt dışı kurumsal ve yüksek başvurulu yatırımcı grupları öne çıkıyor.",
    },
    {
      title: "Dağıtım",
      value: "Eşit / Oransal",
      desc: "Bireyselde eşit, yüksek başvuruluda oransal dağıtım yapısı dikkat çekiyor.",
    },
    {
      title: "Yatırım Önceliği",
      value: "İşletme",
      desc: "Fon kullanımında işletme sermayesi en büyük payı oluşturmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">85.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%34,62</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Markalaşma ve perakendeleşme
                  </div>
                  <div className="text-sm text-emerald-900">{fonKullanim[2]}</div>
                </div>

                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-slate-800">
                    Makine ve verimlilik
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Pürsan Pigment Ürünleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Pürsan Pigment Ürünleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">Gün bilgisi netleşmedi.</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">Gün bilgisi netleşmedi.</p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%34,62.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Pürsan Pigment Ürünleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Pürsan Pigment Ürünleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı,
            dağıtım yöntemi, halka açıklık oranı, tahsisat dağılımı, fon kullanım alanları,
            finansal veriler ve taahhüt detayları bir arada sunulmuştur. Sayfadaki bilgiler taslak
