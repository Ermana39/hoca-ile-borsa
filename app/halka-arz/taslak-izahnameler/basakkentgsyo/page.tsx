...
export const metadata: Metadata = {
  title:
    "Başakkent Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Başakkent Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BasakkentGirisimSermayesiYatirimOrtakligiASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 35.000.000 Lot"];

  const fonKullanim = [
    "%20 Savunma sanayi sektörü şirketlerine yatırım",
    "%60 Diğer sektörlerde faaliyet gösteren şirketlere yatırım",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "202,5 Milyon TL",
      d2023: "160,8 Milyon TL",
      d2022: "-",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "198,7 Milyon TL",
      d2023: "139,6 Milyon TL",
      d2022: "-",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%25,93",
      desc: "Planlanan halka açıklık oranı %25,93 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%25,93</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Başakkent Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Başakkent Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,93.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Başakkent Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Başakkent Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların
