...
export const metadata: Metadata = {
  title:
    "İnfinia Mühendislik A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İnfinia Mühendislik A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function InfiniaMuhendislikASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "25.300.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 23.500.000 Lot",
    "Ortak Satışı: 1.200.000 Lot (İsmail Tugay Güzel)",
    "Ortak Satışı: 600.000 Lot (Kadem Berker Yaşar)",
  ];

  const fonKullanim = [
    "%10-20 Kapasite ve verimlilik artışına yönelik yatırımlar",
    "%20-30 Ar-Ge ve Ür-Ge yatırımları",
    "%20-30 Global satış ve pazarlama ağı yatırımları",
    "%10-20 İşletme sermayesi",
    "%5-15 Finansal borçların ödenmesi",
    "%5-15 Şirket satın alımı / iş ortaklıklarının kurulması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "153,5 Milyon TL",
      d2023: "394,2 Milyon TL",
      d2022: "257,6 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "33,4 Milyon TL",
      d2023: "168,6 Milyon TL",
      d2022: "168,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%20,49",
      desc: "Planlanan halka açıklık oranı %20,49 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
    ...
    },
    {
      title: "Günlük Alım",
      value: "360 Bin",
      desc: "5 gün boyunca 360.000 adet günlük alım emri taahhüdü yer alıyor.",
    },
    {
      title: "Çalışan Tahsisatı",
      value: "Var",
      desc: "Tahsisat yapısında şirket çalışanları için ayrı bir grup yer almaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">25.300.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%20,49</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İnfinia Mühendislik A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İnfinia Mühendislik A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 360.000 adet günlük alım emri girilecek.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,49.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İnfinia Mühendislik A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İnfinia Mühendislik A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
