...
export const metadata: Metadata = {
  title: "Sönmez Global Plastik A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Sönmez Global Plastik A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SonmezGlobalPlastikASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 500.000.000 Lot"];

  const fonKullanim = [
    "%55 Yatırımların finansmanı",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025: "774,2 Milyon TL",
      d2024: "653,1 Milyon TL",
      d2023: "598,2 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Sönmez Global Plastik A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Sönmez Global Plastik A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi,
                fon kullanım alanları, halka açıklık oranı ve finansal görünüm yer alıyor. Bu
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Sönmez Global Plastik A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Sönmez Global Plastik A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
