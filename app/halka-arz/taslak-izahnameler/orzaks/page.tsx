...
export const metadata: Metadata = {
  title:
    "Orzaks İlaç ve Kimya San. Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Orzaks İlaç ve Kimya San. Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OrzaksIlacVeKimyaSanTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "71.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 23.000.000 Lot (Yunus Emre Alimoğlu)",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_3: "774,4 Milyon TL",
      d2023: "4,3 Milyar TL",
      d2022: "3,1 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_3: "534,1 Milyon TL",
      d2023: "2,0 Milyar TL",
      d2022: "1,5 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "5 Gün",
      desc: "5 gün boyunca 3.550.000 adet günlük alım emri girilecek.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">71.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Orzaks İlaç ve Kimya San. Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Orzaks İlaç ve Kimya San. Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 3.550.000 adet günlük alım emri girilecek. (Yunus Emre Alimoğlu)
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Orzaks İlaç ve Kimya San. Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Orzaks İlaç ve Kimya San. Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
