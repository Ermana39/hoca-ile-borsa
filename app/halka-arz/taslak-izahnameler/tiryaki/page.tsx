...
export const metadata: Metadata = {
  title:
    "Tiryaki Anadolu Holding A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Tiryaki Anadolu Holding A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TiryakiAnadoluHoldingASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "3.330.000.000 Lot" },
    { label: "Ek Pay", value: "666.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 1.332.000.000 Lot",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "46,0 Milyar TL",
      d2024: "25,8 Milyar TL",
      d2023: "11,0 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "3,6 Milyar TL",
      d2024: "2,2 Milyar TL",
      d2023: "1,1 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "15 Gün",
      desc: "Ak Yatırım Menkul Değerler A.Ş. aracılığıyla 15 gün fiyat istikrarı planlanıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">3.330.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">666.000.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Tiryaki Anadolu Holding A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Tiryaki Anadolu Holding A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">666.000.000 Lot</p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    15 gün. Ak Yatırım Menkul Değerler A.Ş.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%24,05, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Tiryaki Anadolu Holding A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Tiryaki Anadolu Holding A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
