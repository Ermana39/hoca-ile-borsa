...
export const metadata: Metadata = {
  title:
    "Reis Makina Tic. ve San. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Reis Makina Tic. ve San. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ReisMakinaTicVeSanASPage() {
  const summaryItems = [
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "1,2 Milyar TL",
      d2024: "3,1 Milyar TL",
      d2023: "3,6 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "264,2 Milyon TL",
      d2024: "827,0 Milyon TL",
      d2023: "693,0 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Reis Makina Tic. ve San. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Reis Makina Tic. ve San. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Reis Makina Tic. ve San. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Reis Makina Tic. ve San. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
