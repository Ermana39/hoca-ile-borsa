...
export const metadata: Metadata = {
  title:
    "Mega Teks Tekstil Ürünleri İmalat San. ve Tic. A.Ş. Halka Arz Detayları | Taslak İzahname ve Finansal Veriler",
  description:
    "Mega Teks Tekstil Ürünleri İmalat San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function MegaTeksTekstilUrunleriImalatSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "20.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value: "İnfo Yatırım Menkul Değerler A.Ş.",
    },
    { label: "Pazar", value: "Ana Pazar" },
    { label: "Halka Açıklık", value: "%32" },
    { label: "T1-T2 Durumu", value: "T1-T2 Uygun" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 17.500.000 Lot",
    "Ortak Satışı: 1.500.000 Lot (Mehmet Vurucu)",
    "Ortak Satışı: 1.000.000 Lot (Mert Vurucu)",
  ];

  const fonKullanim = [
    "%30 Finansal anapara ve faiz ödemelerinde.",
    "%10 Güneş enerjisi santrali (GES) kurulumu.",
    "%20 Markalaşma, teknoloji ve altyapı harcamaları.",
    "%20 Yeni ofis ve depo binası yapımı veya satın alma.",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2023_6: "244,4 Milyon TL",
      d2022: "409,2 Milyon TL",
      d2021: "211,3 Milyon TL",
    },
    {
      kalem: "Brüt Kar",
      d2023_6: "10,0 Milyon TL",
      d2022: "57,7 Milyon TL",
      d2021: "10,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Pazar",
      value: "Ana",
      desc: "Şirket paylarının Ana Pazar'da işlem görmesi planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%32</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Mega Teks Tekstil Ürünleri İmalat San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Mega Teks Tekstil Ürünleri İmalat San. ve Tic. A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, dağıtım yöntemi, fon kullanım alanları, halka açıklık oranı,
                taahhüt detayları ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">
                    5 Gün, 300.000 adet günlük alım emri girilecek. (Mehmet Vurucu)
                  </p>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Mega Teks Tekstil Ürünleri İmalat San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Mega Teks Tekstil Ürünleri İmalat San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların
            hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım
            yöntemi, fon kullanım alanları, finansal veriler, halka açıklık oranı ve taahhüt
