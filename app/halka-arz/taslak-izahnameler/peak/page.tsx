...
export const metadata: Metadata = {
  title:
    "Peak Pv Solar Teknolojileri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Peak Pv Solar Teknolojileri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};

export default function PeakPvSolarTeknolojileriASPage() {
  const summaryItems = [
    ...
    { label: "Ek Pay", value: "11.000.000 Lot" },
    { label: "Aracı Kurum", value: "Ak Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 45.000.000 Lot",
    "Ortak Satışı: 10.000.000 Lot",
    "Ek Ortak Satışı: 11.000.000 Lot",
  ];

  const fonKullanim = [
    "%20-35 Hammadde ve yarı mamul alımı",
    "%25-45 Yeni yatırımların finansmanı",
    "%25-60 İşletme sermayesi",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025: "507,3 Milyon TL",
      d2024: "674,4 Milyon TL",
      d2023: "494,3 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%30",
      desc: "Ek satış dahil halka açıklık oranı.",
    },
    {
      title: "Fiyat İstikrarı",
      value: "15 Gün",
      desc: "Taslak izahnamede 15 gün fiyat istikrarı bilgisi yer alıyor.",
    },
    {
      title: "Ek Pay",
      value: "11.000.000 Lot",
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">11.000.000</div>
                </div>
              </div>
            </div>
          </div>
