...
export const metadata: Metadata = {
  title:
    "Namet Gıda San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Namet Gıda San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function NametGidaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "445.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 133.500.000 Lot",
    "Ortak Satışı: 108.756.431 Lot (Haluk Kayar)",
    "Ortak Satışı: 48.249.923 Lot (Faruk Kayar)",
    "Ortak Satışı: 30.610.040 Lot (Hikmet Kayar)",
    "Ortak Satışı: 1.650.228 Lot (Özcan Albak)",
    "Ortak Satışı: 122.233.378 Lot (Gulf Delicatessen Investors S.a.r.l.)",
  ];

  const fonKullanim = [
    "%80-90 Yeni üretim tesisi yatırımı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "25,9 Milyar TL",
      d2023: "24,1 Milyar TL",
      d2022: "17,8 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "5,3 Milyar TL",
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%20,86",
      desc: "Planlanan halka açıklık oranı %20,86 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Yıldız Pazar",
    ...
    },
    {
      title: "Toplam Pay",
      value: "445 Milyon",
      desc: "Toplam halka arz büyüklüğünde yüksek lot miktarı dikkat çekmektedir.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">445.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%20,86</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Namet Gıda San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Namet Gıda San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı,
                dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal görünüm yer alıyor.
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,86.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Namet Gıda San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Namet Gıda San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
