...
export const metadata: Metadata = {
  title:
    "Doğa Sigorta A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Doğa Sigorta A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve temel halka arz bilgileri.",
};
...
export default function DogaSigortaASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 9.000.000 Lot (Nihat Kırmızı)",
    "Ortak Satışı: 6.800.000 Lot (Nabi Kırmızı)",
    "Ortak Satışı: 4.200.000 Lot (Kırmızı Holding A.Ş.)",
  ];

  const fonKullanim = ["%100 Özkaynakların güçlendirilmesi"];
  ...
  const finansalNotlar = [
    "Detaylı finansal tablo için izahname incelenmelidir.",
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Günlük Alım",
      value: "2,5 Milyon",
      desc: "5 gün boyunca 2.500.000 adet günlük alım emri taahhüdü yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Doğa Sigorta A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Doğa Sigorta A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı, dağıtım
                yöntemi, pazar bilgisi, fon kullanım amacı ve taahhüt detayları yer alıyor. Bu
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 2.500.000 adet günlük alım emri girilecek.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Doğa Sigorta A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Doğa Sigorta A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi, halka
            açıklık oranı, fon kullanım amacı ve taahhüt detayları bir arada sunulmuştur. Sayfadaki
