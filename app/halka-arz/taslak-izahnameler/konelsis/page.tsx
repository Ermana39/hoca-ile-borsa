...
export const metadata: Metadata = {
  title:
    "Konelis Enerji Elektronik Kontrol Sistemleri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Konelis Enerji Elektronik Kontrol Sistemleri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KonelisEnerjiElektronikKontrolSistemleriASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 5.000.000 Lot (Hüseyin Güneş)",
  ];

  const fonKullanim = [
    "%20 İşletme sermayesi",
    "%80 Yenilenebilir enerji üretimi yatırımları",
  ];
  ...
  const finansalVeriler = [
    {
      ...
      d2024: "1,1 Milyar TL",
      d2023: "1,2 Milyar TL",
      d2022: "738,8 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "149,5 Milyon TL",
      d2023: "131,2 Milyon TL",
      d2022: "140,2 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">
                  Konelis Enerji Elektronik Kontrol Sistemleri A.Ş.
                </h1>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Konelis Enerji Elektronik Kontrol Sistemleri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Konelis Enerji Elektronik Kontrol Sistemleri A.Ş. halka arz sürecinde yatırımcıların
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Konelis Enerji Elektronik Kontrol Sistemleri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Konelis Enerji Elektronik Kontrol Sistemleri A.Ş. halka arz sayfasında yatırımcıların
