...
export const metadata: Metadata = {
  title: "Aras Elektrik Dağıtım A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Aras Elektrik Dağıtım A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ArasElektrikDagitimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "65.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value: "Bizim Menkul Değerler A.Ş.\nHalk Yatırım Menkul Değerler A.Ş.",
    },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 23.029.273 Lot",
    "Ortak Satışı: 41.970.727 Lot (Doğu Aras Enerji Yatırımları A.Ş.)",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025: "18,0 Milyar TL",
      d2024: "18,6 Milyar TL",
      d2023: "19,3 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025: "10,9 Milyar TL",
      d2024: "10,2 Milyar TL",
      d2023: "11,2 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Hazırlanıyor",
      desc: "Fiyat istikrarı bilgisi ilerleyen aşamalarda netleşecek.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Aras Elektrik Dağıtım A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">65.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {fonKullanim.slice(1, 3).map((item, index) => (
                    <div
                      key={index}
                      className="rounded-2xl border border-slate-200 bg-slate-50 p-4"
                    >
                      <div className="mb-2 text-sm font-semibold text-slate-800">
                        {index === 0 ? "Zorunlu yatırımlar" : "Şebeke sistemi"}
                      </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {fonKullanim.slice(3).map((item, index) => (
                    <div
                      key={index}
                      className="rounded-2xl border border-slate-200 bg-slate-50 p-4"
                    >
                      <div className="mb-2 text-sm font-semibold text-slate-800">
                        {index === 0 ? "Ar-Ge yatırımları" : "Diğer yatırımlar"}
                      </div>
                      <div className="text-sm text-slate-700">{item}</div>
                    </div>
                  ))}
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Aras Elektrik Dağıtım A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Aras Elektrik Dağıtım A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Aras Elektrik Dağıtım A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Aras Elektrik Dağıtım A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
