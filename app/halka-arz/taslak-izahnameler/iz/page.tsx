...
export const metadata: Metadata = {
  title:
    "İz Baskı San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İz Baskı San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function IzBaskiSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "121.125.000 Lot" },
    { label: "Ek Pay", value: "6.375.000 Lot" },
    { label: "Aracı Kurum", value: "Global Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 102.000.000 Lot",
    "Ortak Satışı: 6.000.000 Lot (İsmet Tanık)",
    "Ortak Satışı: 13.125.000 Lot (Kemal Cihan Tanık)",
    "Ek Ortak Satışı: 6.375.000 Lot (İsmet Tanık)",
  ];

  const fonKullanim = [
    "%30-40 Yatırımların fonlanması",
    "%20-30 Güneş enerjisi santrali",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "397,2 Milyon TL",
      d2023: "334,7 Milyon TL",
      d2022: "527,8 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%31,87",
      desc: "Ek satış dahil planlanan halka açıklık oranı %31,87 seviyesindedir.",
    },
    {
      title: "Ek Pay",
      value: "6,375 Milyon",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">121.125.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">6.375.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İz Baskı San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İz Baskı San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ek pay, dağıtım
                yöntemi, satış yöntemi, fon kullanım alanları ve finansal görünüm yer alıyor. Bu
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%31,87, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İz Baskı San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İz Baskı San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
            için halka arz tarihi, halka arz fiyatı, lot miktarı, ek pay, dağıtım yöntemi, halka
            açıklık oranı, fon kullanım alanları, finansal veriler ve taahhüt detayları bir arada
