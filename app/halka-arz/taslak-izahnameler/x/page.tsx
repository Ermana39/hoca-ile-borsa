...
export const metadata: Metadata = {
  title:
    "X Koren Elektrik A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "X Koren Elektrik A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function XKorenElektrikASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "199.900.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 148.100.000 Lot",
    "Ortak Satışı: 51.800.000 Lot (Hasan Kaytan)",
  ];

  const fonKullanim = [
    "%45 Tesis, makine ve ar-ge yatırımları",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "10,9 Milyar TL",
      d2023: "22,8 Milyar TL",
      d2022: "8,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "2,1 Milyar TL",
      d2023: "1,6 Milyar TL",
      d2022: "537,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "5 Gün",
      desc: "5 gün boyunca 10.360.000 adet günlük alım emri girilecek.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">199.900.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                X Koren Elektrik A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                X Koren Elektrik A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 10.360.000 adet günlük alım emri girilecek (Hasan Kaytan).
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,03</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            X Koren Elektrik A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            X Koren Elektrik A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
