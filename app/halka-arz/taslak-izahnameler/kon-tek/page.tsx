...
export const metadata: Metadata = {
  title:
    "Kon-Tek Kontrol Teknolojileri ve Otomasyon San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Kon-Tek Kontrol Teknolojileri ve Otomasyon San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KonTekKontrolTeknolojileriVeOtomasyonSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "92.500.000 Lot" },
    { label: "Ek Pay", value: "18.876.000 Lot" },
    {
      label: "Aracı Kurum",
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 70.000.000 Lot",
    "Ortak Satışı: 7.970.310 Lot (Tolga Murat Özdemir)",
    "Ortak Satışı: 6.212.286 Lot (Ayhan Şahin)",
    "Ortak Satışı: 4.436.047 Lot (Ahmet Can Köklü)",
    "Ortak Satışı: 2.218.023 Lot (Aydın Yaşar)",
    "Ortak Satışı: 940.000 Lot (Mehmet Özpolat)",
    "Ortak Satışı: 881.667 Lot (Lütfi Yücel)",
    "Ortak Satışı: 861.667 Lot (Attila Yapar)",
    "Ek Ortak Satışı: 6.342.331 Lot (Tolga Murat Özdemir)",
    "Ek Ortak Satışı: 4.943.394 Lot (Ayhan Şahin)",
    "Ek Ortak Satışı: 3.529.961 Lot (Ahmet Can Köklü)",
    "Ek Ortak Satışı: 1.764.980 Lot (Aydın Yaşar)",
    "Ek Ortak Satışı: 748.000 Lot (Mehmet Özpolat)",
    "Ek Ortak Satışı: 685.667 Lot (Lütfi Yücel)",
    "Ek Ortak Satışı: 861.667 Lot (Attila Yapar)",
  ];

  const fonKullanim = [
    "%15-25 Yurt içi ve yurt dışı enerji depolama projeleri",
    "%45-55 Yurt içi ve yurt dışı yenilenebilir enerji üretim santrali projeleri",
    "%15-25 Diğer yatırımlar",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "298,1 Milyon TL",
      d2024: "3,6 Milyar TL",
      d2023: "4,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "92,0 Milyon TL",
      d2024: "1,0 Milyar TL",
      d2023: "1,2 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%30,4",
      desc: "Ek satış dahil planlanan halka açıklık oranı %30,4 seviyesindedir.",
    },
    {
      title: "Ek Pay",
      value: "18,876 Milyon",
      desc: "Halka arz sürecinde ek pay satışı da yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">92.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">18.876.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kon-Tek Kontrol Teknolojileri ve Otomasyon San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kon-Tek Kontrol Teknolojileri ve Otomasyon San. ve Tic. A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, ek pay, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları,
                tahsisat yapısı ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak izahname
                verileri daha sade ve analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
          ...
          <aside className="space-y-8">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-sm font-semibold text-slate-800">Ek Pay</div>
                  <p className="mt-2 text-sm text-slate-700">18.876.000 Lot</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30,4 (ek satış dahil).</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kon-Tek Kontrol Teknolojileri ve Otomasyon San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kon-Tek Kontrol Teknolojileri ve Otomasyon San. ve Tic. A.Ş. halka arz sayfasında
            yatırımcıların hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot
            miktarı, ek pay, dağıtım yöntemi, pazar bilgisi, halka açıklık oranı, fon kullanım
            alanları, finansal veriler ve taahhüt detayları bir arada sunulmuştur. Sayfadaki
            bilgiler taslak izahnameye göre hazırlanmıştır ve resmi veriler açıklandıkça
            güncellenmelidir.
          </p>
        </section>
      </div>
