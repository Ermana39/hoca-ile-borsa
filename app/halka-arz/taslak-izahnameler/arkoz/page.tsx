...
export const metadata: Metadata = {
  title:
    "Arkoz Madencilik Enerji San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Arkoz Madencilik Enerji San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ArkozMadencilikEnerjiSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "75.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 75.000.000 Lot"];

  const fonKullanim = [
    "%30 Finansal borçluluk seviyesinin azaltılması",
    "%50 İşletme sermayesi",
    "%20 Operasyonel süreçlerin modernizasyonu ile verimliliğin artırılması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "1,7 Milyar TL",
      d2024: "1,8 Milyar TL",
      d2023: "1,9 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "712,7 Milyon TL",
      d2024: "504,4 Milyon TL",
      d2023: "570,5 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">75.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Arkoz Madencilik Enerji San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Arkoz Madencilik Enerji San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Arkoz Madencilik Enerji San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Arkoz Madencilik Enerji San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
