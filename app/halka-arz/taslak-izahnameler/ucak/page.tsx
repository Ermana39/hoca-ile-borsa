...
export const metadata: Metadata = {
  title:
    "Uçak Tekstil Turizm İthalat İhracat San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Uçak Tekstil Turizm İthalat İhracat San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function UcakTekstilTurizmIthalatIhracatSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "55.600.000 Lot" },
    { label: "Aracı Kurum", value: "QNB Finans Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 40.000.000 Lot",
    "Ortak Satışı: 7.800.000 Lot (Muhammet Uçak)",
    "Ortak Satışı: 3.900.000 Lot (Erman Uçak)",
    "Ortak Satışı: 3.900.000 Lot (Gülçin Uçak)",
  ];

  const fonKullanim = [
    "%30-35 Söke OSB'de arsa alımı ile bina ve çatı GES (Güneş Enerjisi Santrali) yatırımları",
    "%10-15 Bergama OSB'de ek depo, İzmir AOSB ek bina ve ilgili binalarda çatı GES (Güneş Enerjisi Santrali) yatırımları",
    "%5-10 Recycle elyaf, geleneksel çırçırlama tesisi, rejeneratif tarım ve tohum geliştirme/tedariği yatırımları",
    "%20-25 İşletme sermayesi",
    "%20-25 Finansal borçların azaltılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2023: "259,3 Milyon TL",
      d2022: "270,0 Milyon TL",
      d2021: "728,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "T1-T2",
      value: "Kullanılamaz",
      desc: "Taslak izahnamede T1-T2 kullanılamaz bilgisi yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">55.600.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="mb-2 text-sm font-semibold text-slate-800">
                      Elyaf ve tarım odaklı yatırımlar
                    </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Uçak Tekstil Turizm İthalat İhracat San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Uçak Tekstil Turizm İthalat İhracat San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%23,56</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Uçak Tekstil Turizm İthalat İhracat San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Uçak Tekstil Turizm İthalat İhracat San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların
