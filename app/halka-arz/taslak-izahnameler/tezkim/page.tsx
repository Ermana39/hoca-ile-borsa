...
export const metadata: Metadata = {
  title:
    "Tezkim Tarımsal Kimya San. ve Tic. A.Ş. Halka Arz Detayları | Taslak İzahname ve Finansal Veriler",
  description:
    "Tezkim Tarımsal Kimya San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, aracı kurum bilgileri, finansal veriler ve halka açıklık oranı.",
};
...
export default function TezkimTarimsalKimyaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "13.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value: "Halk Yatırım Menkul Değerler A.Ş.",
    },
    { label: "BIST Kodu", value: "TEZKM" },
    { label: "Halka Açıklık", value: "%15,29" },
    { label: "T1-T2 Durumu", value: "T1-T2 Kullanılamaz" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 11.000.000 Lot",
    "Ortak Satışı: 2.000.000 Lot (Tezcanlar Yatırım A.Ş.)",
  ];

  const fonKullanim = [
    "%25-35 İşletme sermayesi.",
    "%15-25 Kısa vadeli işletme sermayesi kredilerinin kapatılması.",
    "%30-50 Kapasite artışı, yeni yatırımlar.",
    "%5-10 Arge - Ürge yatırımları.",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2022_3: "457,9 Milyon TL",
      d2021: "901,3 Milyon TL",
      d2020: "322,4 Milyon TL",
    },
    {
      kalem: "Brüt Kar",
      d2022_3: "229,4 Milyon TL",
      d2021: "240,4 Milyon TL",
      d2020: "54,4 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">13.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">TEZKM</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
                  ...
                  <tbody>
                    {finansalVeriler.map((row, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-slate-700">{row.d2022_3}</td>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Tezkim Tarımsal Kimya San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Tezkim Tarımsal Kimya San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, fon kullanım planı, tahsisat yapısı, halka açıklık oranı ve
                finansal görünüm yer alıyor. Bu sayfada şirketin taslak izahname verileri daha
                sade ve analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%15,29.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Tezkim Tarımsal Kimya San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Tezkim Tarımsal Kimya San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
