...
export const metadata: Metadata = {
  title:
    "Proline PVC Plastik A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Proline PVC Plastik A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ProlinePvcPlastikASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "33.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 7.536.000 Lot (Celalettin Üzümcü)",
    "Ortak Satışı: 463.200 Lot (Osman Elmalı)",
  ];

  const fonKullanim = [
    "%6-8 Yeni geri dönüşüm tesisi",
    "%4-6 Yeni cam üretim tesisi",
    "%20-22 Arazı GES projesi",
    "%3-5 Yeni tesis çatı GES projesi",
    "%7-8 Doğrama tesisi",
    "%5-6 Ekstrüzyon tesisi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "623,2 Milyon TL",
      d2024: "2,5 Milyar TL",
      d2023: "2,6 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "180,7 Milyon TL",
      d2024: "590,1 Milyon TL",
      d2023: "484,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%25,38",
      desc: "Planlanan halka açıklık oranı %25,38 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">33.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%25,38</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Proline PVC Plastik A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Proline PVC Plastik A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı,
                dağıtım yöntemi, pazar bilgisi, satış yöntemi, fon kullanım alanları ve finansal
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,38.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Proline PVC Plastik A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Proline PVC Plastik A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
            için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi,
            pazar bilgisi, halka açıklık oranı, fon kullanım alanları, finansal veriler ve taahhüt
