...
export const metadata: Metadata = {
  title:
    "Efg Elektrik Enerji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Efg Elektrik Enerji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function EfgElektrikEnerjiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "150.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 50.000.000 Lot (Enver Geçgel)",
  ];

  const fonKullanim = [
    "%70 Devam eden ve yeni yatırımların finansmanı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "614,0 Milyon TL",
      d2023: "1,5 Milyar TL",
      d2022: "903,7 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "210,5 Milyon TL",
      d2023: "604,1 Milyon TL",
      d2022: "325,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%25,13",
      desc: "Planlanan halka açıklık oranı %25,13 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
    ...
    },
    {
      title: "Günlük Alım",
      value: "5 Milyon",
      desc: "5 gün boyunca 5.000.000 adet günlük alım emri girilecek bilgisi yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">150.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%25,13</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Efg Elektrik Enerji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Efg Elektrik Enerji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 5.000.000 adet günlük alım emri girilecek (Enver Geçgel).
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%25,13.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Efg Elektrik Enerji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Efg Elektrik Enerji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
