...
export const metadata: Metadata = {
  title:
    "Pttem Teknoloji ve Elektronik Hizmetleri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Pttem Teknoloji ve Elektronik Hizmetleri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function PttemTeknolojiVeElektronikHizmetleriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "24.150.000 Lot" },
    { label: "Aracı Kurum", value: "Gedik Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Ortak Satışı: 24.150.000 Lot (Ept Ticaret ve Sanal Mağazacılık A.Ş.)",
  ];

  const fonKullanim = [
    "Halka arz ortak satışı şeklinde gerçekleştirilecek olup Şirket'e doğrudan nakit girişi olmayacaktır.",
    "Halka arzdan elde edilecek gelirin kullanımı halka arz eden pay sahibinin tasarrufunda olacaktır.",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "904,0 Milyon TL",
      d2023: "596,3 Milyon TL",
      d2022: "297,2 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%21",
      desc: "Planlanan halka açıklık oranı %21 seviyesindedir.",
    },
    {
      title: "Ortak Satışı",
      value: "Tamamı",
      desc: "Halka arz tamamen ortak satışı şeklinde planlanmaktadır.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      ...
      value: "Bekleniyor",
      desc: "Fiyat istikrarına ilişkin detayların ilerleyen aşamalarda tamamlanması beklenmektedir.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">24.150.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%21</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Pttem Teknoloji ve Elektronik Hizmetleri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Pttem Teknoloji ve Elektronik Hizmetleri A.Ş. halka arz sürecinde yatırımcıların en
                çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                ortak satışı, dağıtım yöntemi, fon kullanım açıklaması ve finansal görünüm yer
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%21.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Pttem Teknoloji ve Elektronik Hizmetleri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Pttem Teknoloji ve Elektronik Hizmetleri A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı,
            dağıtım yöntemi, halka açıklık oranı, fon kullanım açıklamaları, finansal veriler ve
