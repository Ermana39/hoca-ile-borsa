...
export const metadata: Metadata = {
  title:
    "Fcr Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Fcr Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function FcrGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "211.280.000 Lot" },
    { label: "Aracı Kurum", value: "Tera Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 139.000.000 Lot",
    "Ortak Satışı: 72.280.000 Lot (Fecri Koça)",
  ];

  const fonKullanim = [
    "%65 Ramada Hotel By Wyndham Sabiha Gökçen Airport Projesi",
    "%10 Şirketin portföyünde yer alan devam eden projeleri",
    "%25 Yeni proje yatırımları",
  ];

  const tahsisat = [
    "126.768.000 Lot (%60) Yurt İçi Bireysel Yatırımcı",
    "42.256.000 Lot (%20) Yurt İçi Kurumsal Yatırımcı",
    "42.256.000 Lot (%20) Yurt Dışı Kurumsal Yatırımcı",
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%30,40",
      desc: "Planlanan halka açıklık oranı %30,40 seviyesindedir.",
    },
    {
      title: "Tahsisat",
      value: "%60 Bireysel",
      desc: "Yurt içi bireysel yatırımcı grubu toplam tahsisatın %60'ını oluşturmaktadır.",
    },
    {
    ...
    },
    {
      title: "Ana Proje",
      value: "%65",
      desc: "Fon kullanımında en büyük pay Ramada Hotel By Wyndham Sabiha Gökçen Airport Projesi için ayrılmıştır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">211.280.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Fcr Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Fcr Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">Veri bulunmuyor.</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30,40.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Fcr Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Fcr Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
