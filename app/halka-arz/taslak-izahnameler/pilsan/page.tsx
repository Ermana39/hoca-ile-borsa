...
export const metadata: Metadata = {
  title:
    "Pilsan Plastik ve Oyuncak Sanayii A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Pilsan Plastik ve Oyuncak Sanayii A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function PilsanPlastikVeOyuncakSanayiiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "45.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 14.850.000 Lot (Oğuz Çetinlap)",
    "Ortak Satışı: 150.000 Lot (Hasan Faruk Çetinlap)",
  ];

  const fonKullanim = [
    "%25-35 İhracat pazarının ve yurt dışı satış faaliyetlerini güçlendirme",
    "%25-35 Yeni ürün grubuna giriş",
    "%15-25 Lisanslı ürün gamının genişletilmesi",
    "%15-25 Üretim hatlarının otomasyonu ve üretim maliyetlerinin optimizasyonu",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "661,7 Milyon TL",
      d2024: "1,6 Milyar TL",
      d2023: "1,8 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "128,9 Milyon TL",
      d2024: "256,3 Milyon TL",
      d2023: "350,9 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">45.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Pilsan Plastik ve Oyuncak Sanayii A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Pilsan Plastik ve Oyuncak Sanayii A.Ş. halka arz sürecinde yatırımcıların en çok
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Pilsan Plastik ve Oyuncak Sanayii A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Pilsan Plastik ve Oyuncak Sanayii A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
