...
export const metadata: Metadata = {
  title:
    "Polifarma İlaç San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Polifarma İlaç San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function PolifarmaIlacSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "54.500.000 Lot" },
    { label: "Aracı Kurum", value: "Hazırlanıyor" },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 27.250.000 Lot",
    "Ortak Satışı: 12.512.533 Lot (Ufuk Süleyman Kumrulu)",
    "Ortak Satışı: 5.836.284 Lot (Yıldan Kumrulu)",
    "Ortak Satışı: 4.405.538 Lot (Umut Cengiz Kumrulu)",
    "Ortak Satışı: 4.405.538 Lot (Elif Süreyya Kumrulu)",
    "Ortak Satışı: 90.107 Lot (Fatih Zengin)",
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%20,02",
      desc: "Planlanan halka açıklık oranı %20,02 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Yıldız Pazar",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">54.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%20,02</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Polifarma İlaç San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Polifarma İlaç San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Polifarma İlaç San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Polifarma İlaç San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
