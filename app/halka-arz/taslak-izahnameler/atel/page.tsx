...
export const metadata: Metadata = {
  title:
    "Atel Teknoloji ve Savunma San. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Atel Teknoloji ve Savunma San. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AtelTeknolojiVeSavunmaSanASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "110.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 10.000.000 Lot (Güntekin Güntay)",
    "Ortak Satışı: 10.000.000 Lot (Rıza Ceran)",
    "Ortak Satışı: 10.000.000 Lot (Olcay Eraslan)",
    "Ortak Satışı: 10.000.000 Lot (İlyas Utkun)",
    "Ortak Satışı: 10.000.000 Lot (Yusuf Kotan)",
  ];

  const fonKullanim = [
    "%60 Üretim ve ihracat süreçleri ile kurumsal altyapının güçlendirilmesi",
    "%10 GES (Güneş Enerjisi Santrali) yatırımı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "584,2 Milyon TL",
      d2024: "754,3 Milyon TL",
      d2023: "541,1 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "249,5 Milyon TL",
      d2024: "302,4 Milyon TL",
      d2023: "284,9 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">110.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Atel Teknoloji ve Savunma San. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Atel Teknoloji ve Savunma San. A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30,56</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Atel Teknoloji ve Savunma San. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Atel Teknoloji ve Savunma San. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
