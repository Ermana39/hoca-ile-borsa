...
export const metadata: Metadata = {
  title:
    "Panda Alüminyum A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Panda Alüminyum A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function PandaAluminyumASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 25.000.000 Lot (Mehmet Şeherli)",
  ];

  const fonKullanim = [
    "%40-50 Soğuk hadde ve depolamalı GES (Güneş Enerjisi Santrali) yatırımları",
    "%30-40 İşletme sermayesi",
    "%15-25 Finansman maliyetlerinin azaltılması (banka kredileri)",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "583,1 Milyon TL",
      d2023: "681,0 Milyon TL",
      d2022: "1,6 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%22,83",
      desc: "Planlanan halka açıklık oranı %22,83 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Yıldız Pazar",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%22,83</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Panda Alüminyum A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Panda Alüminyum A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı, dağıtım
                yöntemi, pazar bilgisi, fon kullanım alanları ve finansal görünüm yer alıyor. Bu
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%22,83.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Panda Alüminyum A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Panda Alüminyum A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
