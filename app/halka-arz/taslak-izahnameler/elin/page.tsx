...
export const metadata: Metadata = {
  title:
    "Elin Elektrik İnşaat Müşavirlik Proje Taahhüt Tic. ve San. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Elin Elektrik İnşaat Müşavirlik Proje Taahhüt Tic. ve San. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ElinElektrikInsaatMusavirlikProjeTaahhutTicVeSanASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "47.800.000 Lot" },
    { label: "Ek Pay", value: "9.560.000 Lot" },
    { label: "Aracı Kurum", value: "Yapı Kredi Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 36.000.000 Lot",
    "Ortak Satışı: 6.018.000 Lot (Arda Yalı)",
    "Ortak Satışı: 5.192.000 Lot (Ayça Yalı Karakeçili)",
    "Ortak Satışı: 590.000 Lot (Murat Karakeçili)",
    "Ek Ortak Satışı: 4.875.600 Lot (Arda Yalı)",
    "Ek Ortak Satışı: 4.206.400 Lot (Ayça Yalı Karakeçili)",
    "Ek Ortak Satışı: 478.000 Lot (Murat Karakeçili)",
  ];

  const fonKullanim = [
    "%15-20 Modernizasyon ve kapasite artışına yönelik yatırımların finansmanı",
    "%25-30 Hücre üretimine yönelik yapılacak yatırımın finansmanı",
    "%35-38 İşletme sermayesi",
    "%4-6 Öz tüketime yönelik GES (Güneş Enerjisi Santrali) kurulumu veya enerji giderlerini azaltacak yatırımlar",
    "%2-4 Yurt içi veya yurt dışında enerji projelerinin geliştirilmesi",
    "%2-4 Girişim firmalarına yatırım",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "3,4 Milyar TL",
      d2023: "14,1 Milyar TL",
      d2022: "8,7 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "548,3 Milyon TL",
      d2023: "3,0 Milyar TL",
      d2022: "1,6 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Ek Pay",
      value: "9,56 Milyon",
      desc: "Taslak izahnamede ek pay satışı da yer alıyor.",
    },
    {
    ...
    },
    {
      ...
      value: "2024 Son Çeyrek",
      desc: "2024 yılının son çeyreğinde tamamlanması planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">47.800.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">9.560.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="mb-2 text-sm font-semibold text-slate-800">
                      Girişim firmaları yatırımı
                    </div>
                    <div className="text-sm text-slate-700">{fonKullanim[5]}</div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Elin Elektrik İnşaat Müşavirlik Proje Taahhüt Tic. ve San. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Elin Elektrik İnşaat Müşavirlik Proje Taahhüt Tic. ve San. A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, ek pay, dağıtım yöntemi, tahsisat oranları, fon kullanım
                alanları ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak izahname
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    2024 yılının son çeyreğinde tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%24,30, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Elin Elektrik İnşaat Müşavirlik Proje Taahhüt Tic. ve San. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Elin Elektrik İnşaat Müşavirlik Proje Taahhüt Tic. ve San. A.Ş. halka arz sayfasında
            yatırımcıların hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot
            miktarı, ek pay, dağıtım yöntemi, halka açıklık oranı, fon kullanım alanları, finansal
