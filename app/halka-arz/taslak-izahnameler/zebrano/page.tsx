...
export const metadata: Metadata = {
  title:
    "Zebrano Mobilya Teknolojileri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Zebrano Mobilya Teknolojileri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function ZebranoMobilyaTeknolojileriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "28.000.000 Lot" },
    { label: "Aracı Kurum", value: "Bulls Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Hazırlanıyor" },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 28.000.000 Lot"];

  const fonKullanim = [
    "%55-65 Kapasite artıcı, yenileme yatırımları ve diğer alternatif yatırım fırsatlarının değerlendirilmesi",
    "%20-30 İşletme sermayesi",
    "%10-20 Hammadde alımı",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "625,4 Milyon TL",
      d2023: "912,8 Milyon TL",
      d2022: "892,2 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "65,5 Milyon TL",
      d2023: "128,7 Milyon TL",
      d2022: "140,1 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%21,5",
      desc: "Planlanan halka açıklık oranı %21,5 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      ...
      value: "Kapasite",
      desc: "Fon kullanımında kapasite artışı ve yenileme yatırımları ana başlık olarak öne çıkmaktadır.",
    },
    {
      title: "Fiyat İstikrarı",
      value: "Bekleniyor",
      desc: "Fiyat istikrarına dair gün bilgisi henüz netleşmemiş görünüyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">28.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%21,5</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Zebrano Mobilya Teknolojileri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Zebrano Mobilya Teknolojileri A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%21,5.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Zebrano Mobilya Teknolojileri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Zebrano Mobilya Teknolojileri A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
