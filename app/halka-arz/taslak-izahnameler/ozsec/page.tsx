...
export const metadata: Metadata = {
  title:
    "Özseç Beton Madencilik İnşaat Sanayi Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Özseç Beton Madencilik İnşaat Sanayi Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OzsecBetonMadencilikInsaatSanayiTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "120.000.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 20.000.000 Lot (Hamza Balkaya)",
  ];

  const fonKullanim = [
    "%40-45 İşletme sermayesi",
    "%30-40 Üretim ve satış kapasitesinin artırılması amacıyla araç, ekipman ve santral kurulumu",
    "%20-25 Finansal borçluluğun azaltılması",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "532,3 Milyon TL",
      d2023: "1,4 Milyar TL",
      d2022: "917,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%24",
      desc: "Planlanan halka açıklık oranı %24 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
    ...
    },
    {
      title: "Tahsisat",
      value: "Bekleniyor",
      desc: "Tahsisat grupları ve fiyat istikrarı detayları ilerleyen aşamalarda netleşecektir.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">120.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Özseç Beton Madencilik İnşaat Sanayi Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Özseç Beton Madencilik İnşaat Sanayi Tic. A.Ş. halka arz sürecinde yatırımcıların en
                çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Özseç Beton Madencilik İnşaat Sanayi Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Özseç Beton Madencilik İnşaat Sanayi Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
