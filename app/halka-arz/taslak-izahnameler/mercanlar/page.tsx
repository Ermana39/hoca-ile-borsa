...
export const metadata: Metadata = {
  title:
    "Mercanlar Otomotiv Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Mercanlar Otomotiv Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function MercanlarOtomotivTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 9.500.000 Lot (Burhan Budak)",
    "Ortak Satışı: 5.000.000 Lot (Selim Marangoz)",
    "Ortak Satışı: 2.500.000 Lot (İsmail Şatır)",
    "Ortak Satışı: 2.500.000 Lot (Kemal Oturak)",
    "Ortak Satışı: 2.500.000 Lot (Talga Tonba)",
    "Ortak Satışı: 2.500.000 Lot (Begüm Çaylan)",
  ];

  const fonKullanim = [
    "%10 Pazarlama ve satış harcamaları",
    "%20 Yatırım finansmanı",
    "%30 İşletme sermayesi",
    "%40 Finansal borç ödemesi",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025_9: "813,1 Milyon TL",
      d2024: "1,0 Milyar TL",
      d2023: "861,5 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Mercanlar Otomotiv Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Mercanlar Otomotiv Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%31,25</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Mercanlar Otomotiv Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Mercanlar Otomotiv Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
