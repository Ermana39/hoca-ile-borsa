...
export const metadata: Metadata = {
  title:
    "Koray Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Koray Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function KorayGirisimSermayesiYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "91.000.000 Lot" },
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Planlanıyor",
      desc: "Fiyat istikrarına ilişkin uygulamanın planlandığı belirtiliyor.",
    },
    {
      title: "Günlük Alım",
      value: "5,4 Milyon",
      desc: "5.400.000 adet günlük alım emri taahhüdü yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">91.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Koray Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Koray Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
                satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları, günlük alım emri
                taahhüdü ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak izahname verileri
                daha sade ve analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5.400.000 adet günlük alım emri girilecek.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Koray Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Koray Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı
