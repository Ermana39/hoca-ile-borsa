...
export const metadata: Metadata = {
  title:
    "Net Global Endüstriyel Yatırımlar A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Net Global Endüstriyel Yatırımlar A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function NetGlobalEndustriyelYatirimlarASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "87.500.000 Lot" },
    { label: "Aracı Kurum", value: "Tacirler Yatırım Menkul Değerler A.Ş." },
  ...
  const fonKullanim = [
    "%20-30 Mevcut yatırımlara ilişkin kapasite artışları, çatı GES (Güneş Enerjisi Santrali) kurulumu ve koruge boru makine alımı",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "416,0 Milyon TL",
      d2023: "398,9 Milyon TL",
      d2022: "380,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%28",
      desc: "Planlanan halka açıklık oranı %28 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "Tahsisat",
      value: "Oransal",
      desc: "Yüksek başvurulu yatırımcı tarafında oransal dağıtım yapısı öne çıkıyor.",
    },
    {
      title: "Fiyat İstikrarı",
      value: "Bekleniyor",
      desc: "Fiyat istikrarına ilişkin detayların ilerleyen aşamalarda tamamlanması bekleniyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">87.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%28</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Kapasite artışları ve çatı GES
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Net Global Endüstriyel Yatırımlar A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Net Global Endüstriyel Yatırımlar A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
                satışı, dağıtım yöntemi, fon kullanım alanları ve finansal görünüm yer alıyor. Bu
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Net Global Endüstriyel Yatırımlar A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Net Global Endüstriyel Yatırımlar A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
