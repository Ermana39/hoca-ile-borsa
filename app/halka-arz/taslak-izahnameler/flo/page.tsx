...
export const metadata: Metadata = {
  title:
    "Flo Mağazacılık ve Pazarlama A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Flo Mağazacılık ve Pazarlama A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function FloMagazacilikVePazarlamaASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "87.157.894 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 36.315.789 Lot",
    "Ortak Satışı: 38.131.579 Lot (Mater Footware B.V.)",
    "Ortak Satışı: 6.355.263 Lot (Gözde Girişim Sermayesi Yatırım Ortaklığı A.Ş.)",
    "Ortak Satışı: 6.355.263 Lot (Bim Birleşik Mağazalar A.Ş.)",
  ];

  const fonKullanim = [
    "%45-55 Yurt içi ve yurt dışı mağaza açılışları, mevcut mağaza ağı modernizasyonu ve teknolojileri yatırımları",
    "%45-55 İşletme sermayesi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_3: "11,7 Milyar TL",
      d2023: "48,4 Milyar TL",
      d2022: "34,3 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_3: "4,9 Milyar TL",
      d2023: "21,1 Milyar TL",
      d2022: "13,8 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Belirlenecek",
      desc: "Fiyat istikrarı süresi henüz netleşmemiş durumda.",
    },
    {
    ...
    },
    {
      ...
      value: "2024 2. Yarı",
      desc: "2024 yılının ikinci yarısında tamamlanması planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">87.157.894</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Mağaza ve teknoloji yatırımları
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Flo Mağazacılık ve Pazarlama A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Flo Mağazacılık ve Pazarlama A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    2024 yılının ikinci yarısında tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%12</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Flo Mağazacılık ve Pazarlama A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Flo Mağazacılık ve Pazarlama A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
