...
export const metadata: Metadata = {
  title:
    "Kırlıoğlu Kimya San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Kırlıoğlu Kimya San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, fon kullanım alanları ve finansal veriler.",
};
...
export default function KirliogluKimyaSanVeTicASPage() {
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 22.500.000 Lot (Hakan Kırlıoğlu)",
  ];

  const fonKullanim = [
    "%60-70 Amonyum nitrat üretim tesisi yatırımı",
    "%30-40 Hammadde tedariki ve işletme sermayesi",
  ];
  ...
  const finansalVeriler = [
    {
      ...
      d2023: "1,7 Milyar TL",
      d2022: "1,6 Milyar TL",
      d2021: "838,7 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2023: "813,9 Milyon TL",
      d2022: "777,2 Milyon TL",
      d2021: "335,6 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Tahsisat",
      value: "Bekleniyor",
      desc: "Tahsisat grupları ilerleyen aşamalarda tamamlanacaktır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">72.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kırlıoğlu Kimya San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kırlıoğlu Kimya San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
                ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, fon
                kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada şirketin taslak
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,71</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kırlıoğlu Kimya San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kırlıoğlu Kimya San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, halka açıklık oranı,
