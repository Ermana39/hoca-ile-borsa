...
export const metadata: Metadata = {
  title:
    "İdç Liman İşletmeleri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "İdç Liman İşletmeleri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function IdcLimanIsletmeleriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "40.000.000 Lot" },
    { label: "Ek Pay", value: "8.000.000 Lot" },
    { label: "Aracı Kurum", value: "Bulls Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 10.000.000 Lot",
    "Ortak Satışı: 30.000.000 Lot (İzmir Demir Çelik Sanayi A.Ş.)",
    "Ek Ortak Satışı: 8.000.000 Lot (İzmir Demir Çelik Sanayi A.Ş.)",
  ];

  const fonKullanim = ["%100 İşletme sermayesi"];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025: "2,9 Milyar TL",
      d2024: "882,6 Milyon TL",
      d2023: "1,0 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025: "37,5 Milyon TL",
      d2024: "90,2 Milyon TL",
      d2023: "228,5 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Ek Pay",
      value: "8.000.000 Lot",
      desc: "Ek ortak satışı kapsamında ek pay bulunmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">40.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">8.000.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                İdç Liman İşletmeleri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                İdç Liman İşletmeleri A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            İdç Liman İşletmeleri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            İdç Liman İşletmeleri A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
