...
export const metadata: Metadata = {
  title:
    "Yeşil Global Enerji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Yeşil Global Enerji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function YesilGlobalEnerjiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "36.950.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 2.213.575 Lot (Lia Invest LLC)",
    "Ortak Satışı: 2.658.375 Lot (Yeşil Holding A.Ş.)",
    "Ortak Satışı: 2.078.050 Lot (Yeşil Yapı Endüstrisi A.Ş.)",
  ];

  const fonKullanim = [
    "%70 Enerji sektöründeki yatırımların finansmanı",
    "%15 Şirket ve bağlı ortaklıkların işletme sermayesi",
    "%15 Finansal borç anapara ve faiz ödemeleri",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "1,1 Milyar TL",
      d2023: "2,6 Milyar TL",
      d2022: "3,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "437,4 Milyon TL",
      d2023: "632,6 Milyon TL",
      d2022: "1,1 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "5 Gün",
      desc: "3 farklı ortak için 5 gün boyunca günlük alım emri taahhüdü yer alıyor.",
    },
    {
  ...
  const alimEmriBilgileri = [
    "5 gün, 442.715 adet günlük alım emri girilecek (Lia Invest LLC).",
    "5 gün, 531.675 adet günlük alım emri girilecek (Yeşil Holding A.Ş.).",
    "5 gün, 415.610 adet günlük alım emri girilecek (Yeşil Yapı Endüstrisi A.Ş.).",
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">36.950.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Yeşil Global Enerji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Yeşil Global Enerji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <div className="mt-2 space-y-2 text-sm text-slate-700">
                    {alimEmriBilgileri.map((item, index) => (
                      <p key={index}>{item}</p>
                    ))}
                  </div>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Yeşil Global Enerji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Yeşil Global Enerji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi
