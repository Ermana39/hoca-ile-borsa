...
export const metadata: Metadata = {
  title:
    "Innovance Bilgi Teknolojileri A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Innovance Bilgi Teknolojileri A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function InnovanceBilgiTeknolojileriASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "44.444.444 Lot" },
    { label: "Aracı Kurum", value: "Ak Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 22.222.222 Lot",
    "Ortak Satışı: 8.888.889 Lot (Yusuf Ürey)",
    "Ortak Satışı: 6.927.778 Lot (Oyak Portföy Yönetimi A.Ş. Beşinci Girişim Sermayesi Yatırım Fonu)",
    "Ortak Satışı: 1.111.111 Lot (Re-Pie Portföy Yönetimi A.Ş. Onaltıncı Karma Girişim Sermayesi Yatırım Fonu)",
    "Ortak Satışı: 3.333.333 Lot (Re-Pie 17. Karma Girişim Sermayesi Yatırım Fonu)",
    "Ortak Satışı: 1.961.111 Lot (Re-Pie Portföy Yönetimi A.Ş. Dokuzuncu Karma Girişim Sermayesi Yatırım Fonu)",
  ];

  const fonKullanim = [
    "%40 Planlanan yeni yatırımların finansmanı",
    "%20 Mevcut operasyonlar ve işletme sermayesi",
    "%20 Ar-Ge faaliyetleri ve ürün geliştirme",
    "%20 Uluslararası pazarlama ve globalleşme finansmanı",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "863,0 Milyon TL",
      d2024: "1,7 Milyar TL",
      d2023: "1,2 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "637,9 Milyon TL",
      d2024: "1,3 Milyar TL",
      d2023: "885,1 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "15 Gün",
      desc: "15 gün fiyat istikrarı planlanıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">44.444.444</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="mb-2 text-sm font-semibold text-slate-800">
                      Operasyon ve işletme sermayesi
                    </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Innovance Bilgi Teknolojileri A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Innovance Bilgi Teknolojileri A.Ş. halka arz sürecinde yatırımcıların en çok takip
                ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım
                yöntemi, tahsisat oranları, fon kullanım alanları ve finansal görünüm yer alıyor.
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">15 gün.</p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Innovance Bilgi Teknolojileri A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Innovance Bilgi Teknolojileri A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
