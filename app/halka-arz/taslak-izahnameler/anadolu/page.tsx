...
export const metadata: Metadata = {
  title:
    "Anadolu Mikronize Kimya San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Anadolu Mikronize Kimya San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, satış yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AnadoluMikronizeKimyaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Aracı Kurum", value: "Pusula Yatırım Menkul Değerler A.Ş." },
  ...
  const fonKullanim = [
    "%34 İşletme sermayesi",
    "%33 Kapasite artırmaya yönelik yatırımlar",
    "%33 Finansal borç ödemeleri",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "643,6 Milyon TL",
      d2023: "922,8 Milyon TL",
      d2022: "743,3 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "233,0 Milyon TL",
      d2023: "299,8 Milyon TL",
      d2022: "246,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%32,26",
      desc: "Planlanan halka açıklık oranı %32,26 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "Brüt halka arz gelirinin %20'si ile 30 gün fiyat istikrarı planlanmaktadır.",
    },
    {
      title: "T1-T2",
      value: "Uygun",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%32,26</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Anadolu Mikronize Kimya San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Anadolu Mikronize Kimya San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%32,26.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Anadolu Mikronize Kimya San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Anadolu Mikronize Kimya San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
