...
export const metadata: Metadata = {
  title:
    "Çimstone İnşaat Malzemeleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Çimstone İnşaat Malzemeleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function CimstoneInsaatMalzemeleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "135.000.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Ana Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 101.437.053 Lot",
    "Ortak Satışı: 33.562.947 Lot (Haşmet Akkuş)",
  ];

  const fonKullanim = [
    "%15-25 Makine ve teknolojik yatırımlar",
    "%40-50 Aynı faaliyet kolunda şirket satın alımları",
    "%15-20 Finansal borçların faiz ve anapara ödemeleri",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "718,9 Milyon TL",
      d2024: "1,5 Milyar TL",
      d2023: "1,7 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "126,0 Milyon TL",
      d2024: "288,0 Milyon TL",
      d2023: "419,2 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "5 Gün",
      desc: "5 gün boyunca 6.712.590 adet günlük alım emri girilecek.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">135.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Çimstone İnşaat Malzemeleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Çimstone İnşaat Malzemeleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 6.712.590 adet günlük alım emri girilecek.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Çimstone İnşaat Malzemeleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Çimstone İnşaat Malzemeleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
