...
export default function EkolGirisimSermayesiYatirimOrtakligiASPage() {
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 35.000.000 Lot (Nuhit Kiler)",
    ...
    "Ek Ortak Satışı: 7.000.000 Lot (Nuhit Kiler)",
  ...
  const oneCikanlar = [
    ...
    {
      title: "T1-T2 Uygunluğu",
      value: "Uygun",
      desc: "Borsada satış yönteminde T1-T2 uygunluğu bulunuyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">125.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Ekol Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Ekol Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en
                çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                ek pay satışı, dağıtım yöntemi ve finansal görünüm yer alıyor. Bu sayfada şirketin
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">Uygun.</p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Ekol Girişim Sermayesi Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Ekol Girişim Sermayesi Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı
            analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, ek pay,
            dağıtım yöntemi, halka açıklık oranı, finansal veriler ve taahhüt detayları bir arada
