...
export const metadata: Metadata = {
  title:
    "Aksam Otogong İç ve Dış Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Aksam Otogong İç ve Dış Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AksamOtogongIcVeDisTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "15.500.000 Lot" },
  ...
  const fonKullanim = [
    "%50-60 Yatırım finansmanı ile araç ve ekipman alımları",
    "%20-30 İşletme sermayesi",
    "%5-15 Teknolojik yatırımların finansmanı",
    "%5-15 Pazarlama faaliyetleri finansmanı ile pazar payının güçlendirilmesi",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "414,2 Milyon TL",
      d2023: "239,2 Milyon TL",
      d2022: "703,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%20,39",
      desc: "Planlanan halka açıklık oranı %20,39 seviyesindedir.",
    },
    {
      title: "Günlük Alım",
      value: "620 Bin",
      desc: "5 gün boyunca 620.000 adet günlük alım emri girilmesi planlanmaktadır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">15.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%20,39</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Aksam Otogong İç ve Dış Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Aksam Otogong İç ve Dış Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
                ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı,
                dağıtım yöntemi, günlük alım emri taahhüdü, fon kullanım alanları ve finansal görünüm
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün, 620.000 adet günlük alım emri girilecek (Osman Telli).
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,39.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Aksam Otogong İç ve Dış Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Aksam Otogong İç ve Dış Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
