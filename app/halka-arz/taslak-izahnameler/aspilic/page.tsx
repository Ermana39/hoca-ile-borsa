...
export const metadata: Metadata = {
  title:
    "(Aspiliç) As Ofis Damızlık Yumurta Yem Gıda San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "(Aspiliç) As Ofis Damızlık Yumurta Yem Gıda San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AspilicAsOfisDamizlikYumurtaYemGidaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "68.750.000 Lot" },
    { label: "Ek Pay", value: "13.750.000 Lot" },
    { label: "Aracı Kurum", value: "Teb Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 55.000.000 Lot",
    "Ortak Satışı: 13.750.000 Lot",
    "Ek Ortak Satışı: 13.750.000 Lot",
  ];

  const fonKullanim = [
    "%35-45 Yatırım harcamaları",
    "%35-45 Finansal borçların geri ödemesi",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "8,3 Milyar TL",
      d2024: "11,1 Milyar TL",
      d2023: "9,6 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "1,1 Milyar TL",
      d2024: "2,9 Milyar TL",
      d2023: "2,0 Milyar TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">68.750.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Ek Pay</div>
                  <div className="mt-1 text-lg font-bold">13.750.000</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                (Aspiliç) As Ofis Damızlık Yumurta Yem Gıda San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                (Aspiliç) As Ofis Damızlık Yumurta Yem Gıda San. ve Tic. A.Ş. halka arz sürecinde
                yatırımcıların en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat
                aralığı, pay miktarı, ek pay, dağıtım yöntemi, fon kullanım alanları ve finansal
                görünüm yer alıyor. Bu sayfada şirketin taslak izahname verileri daha sade ve
                analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%27,05, ek satış dahil.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            (Aspiliç) As Ofis Damızlık Yumurta Yem Gıda San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            (Aspiliç) As Ofis Damızlık Yumurta Yem Gıda San. ve Tic. A.Ş. halka arz sayfasında
