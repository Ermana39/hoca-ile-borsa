...
export const metadata: Metadata = {
  title:
    "Reçber Kablo A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Reçber Kablo A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};

export default function RecberKabloASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "192.000.000 Lot" },
    { label: "Aracı Kurum", value: "İntegral Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 160.000.000 Lot",
    "Ortak Satışı: 32.000.000 Lot",
  ];

  const fonKullanim = [
    "%80 Yatırım harcamaları",
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">192.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Aracı Kurum</div>
                  <div className="mt-1 text-sm font-bold">İntegral Yatırım</div>
                </div>
              </div>
            </div>
          </div>
