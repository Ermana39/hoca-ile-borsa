...
export const metadata: Metadata = {
  title:
    "Ral Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Ral Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function RalGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "176.000.000 Lot" },
    { label: "Ek Pay", value: "Bulunmuyor" },
    { label: "Aracı Kurum", value: "İntegral Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = ["Sermaye Artırımı: 176.000.000 Lot"];

  const fonKullanim = [
    "%55-65 Yeni proje geliştirilecek arsa alımlarının ve/veya mülkiyeti başkasına ait arsalarda geliştirilecek projelerin finansmanı",
    "%30-40 Central MKP projesinin finansmanı",
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%26,03",
      desc: "Planlanan halka açıklık oranı %26,03 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">176.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%26,03</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Ral Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Ral Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%26,03.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Ral Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Ral Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
