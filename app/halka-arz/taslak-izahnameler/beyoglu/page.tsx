...
export const metadata: Metadata = {
  title:
    "Beyoğlu Çikolata Sanayi Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Beyoğlu Çikolata Sanayi Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function BeyogluCikolataSanayiTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "67.200.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 14.700.000 Lot (Vahit Burak Akbağ)",
    "Ortak Satışı: 10.500.000 Lot (Halil Ölçgüçer)",
  ];

  const fonKullanim = [
    "%30-40 Yatırım harcamaları ve/veya şirket satın alma",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "699,4 Milyon TL",
      d2023: "385,9 Milyon TL",
      d2022: "367,1 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%26,67",
      desc: "Planlanan halka açıklık oranı %26,67 seviyesindedir.",
    },
    {
      title: "Pazar",
      value: "Ana Pazar",
    ...
    },
    {
      title: "Takvim",
      value: "2025 2. Yarı",
      desc: "Tahmini halka arz takvimi 2025 yılının ikinci yarısında tamamlanacak şekilde planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">67.200.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%26,67</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Beyoğlu Çikolata Sanayi Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Beyoğlu Çikolata Sanayi Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    2025 yılının ikinci yarısında tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%26,67.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Beyoğlu Çikolata Sanayi Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Beyoğlu Çikolata Sanayi Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
