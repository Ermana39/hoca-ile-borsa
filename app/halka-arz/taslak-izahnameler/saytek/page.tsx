...
export const metadata: Metadata = {
  title:
    "Saytek Medikal ve Plastik San. Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Saytek Medikal ve Plastik San. Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SaytekMedikalVePlastikSanTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 70.000.000 Lot"];

  const fonKullanim = [
    "%20-25 Üretim tesisi yatırımı",
    "%10-15 GES yatırımı",
    "%25-35 Şirket satın alma ve benzeri yatırımların yapılması",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "569,6 Milyon TL",
      d2023: "1,1 Milyar TL",
      d2022: "369,2 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "171,9 Milyon TL",
      d2023: "243,5 Milyon TL",
      d2022: "100,5 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-slate-800">
                    Satın alma ve benzeri yatırımlar
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Saytek Medikal ve Plastik San. Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Saytek Medikal ve Plastik San. Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi,
                tahsisat yapısı, fon kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Saytek Medikal ve Plastik San. Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Saytek Medikal ve Plastik San. Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
