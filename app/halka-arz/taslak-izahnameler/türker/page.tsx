...
export const metadata: Metadata = {
  title:
    "Türker Yenilenebilir Enerji Yatırım A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Türker Yenilenebilir Enerji Yatırım A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TurkerYenilenebilirEnerjiYatirimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "250.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 50.000.000 Lot (Türkerler İnşaat Turizm Madencilik Enerji Üretim Tic. ve San. A.Ş.)",
  ];

  const fonKullanim = [
    "%75-85 Yenilenebilir enerji projeleri yatırımları",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_9: "2,8 Milyar TL",
      d2024: "4,2 Milyar TL",
      d2023: "2,4 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_9: "1,6 Milyar TL",
      d2024: "2,0 Milyar TL",
      d2023: "1,4 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "2026 İkinci Yarı",
      desc: "Halka arzın 2026 yılının ikinci yarısında tamamlanması planlanıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">250.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Türker Yenilenebilir Enerji Yatırım A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Türker Yenilenebilir Enerji Yatırım A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">%10 ayrılması planlanıyor.</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,57</p>
                </div>

                <div className="rounded-2xl border border-sky-200 bg-sky-50 p-4">
                  <div className="text-sm font-semibold text-sky-800">Tahmini Halka Arz Takvimi</div>
                  <p className="mt-2 text-sm text-sky-900">
                    2026 yılının ikinci yarısında tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Türker Yenilenebilir Enerji Yatırım A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Türker Yenilenebilir Enerji Yatırım A.Ş. halka arz sayfasında yatırımcıların hızlı
