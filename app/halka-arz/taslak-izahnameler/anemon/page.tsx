...
export const metadata: Metadata = {
  title:
    "Anemon Turizm ve İnşaat Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Anemon Turizm ve İnşaat Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AnemonTurizmVeInsaatTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "56.250.000 Lot" },
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 9.750.000 Lot (İsmail Akçura)",
    "Ortak Satışı: 4.500.000 Lot (Ayfer Akçura)",
    "Ortak Satışı: 4.500.000 Lot (Salim Yavaş)",
  ];

  const fonKullanim = [
    "%90 Yatırımların fonlanması",
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025_9: "299,1 Milyon TL",
      d2024: "481,0 Milyon TL",
      d2023: "597,1 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "2026 İlk Yarı",
      desc: "Halka arzın 2026 yılının birinci yarısında tamamlanması planlanıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">56.250.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Anemon Turizm ve İnşaat Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Anemon Turizm ve İnşaat Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-sky-200 bg-sky-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-sky-900">
                    2026 yılının birinci yarısında tamamlanması planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Anemon Turizm ve İnşaat Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Anemon Turizm ve İnşaat Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
