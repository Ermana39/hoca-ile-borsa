...
export const metadata: Metadata = {
  title:
    "Alnus Yatırım Menkul Değerler A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Alnus Yatırım Menkul Değerler A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};

export default function AlnusYatirimMenkulDegerlerASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "113.000.000 Lot" },
    { label: "Aracı Kurum", value: "Alnus Yatırım Menkul Değerler A.Ş." },
    { label: "Bist Kodu", value: "ALNUS" },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Bist Kodu",
      value: "ALNUS",
      desc: "Taslak izahnamede yer alan BIST işlem kodu.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">113.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Bist Kodu</div>
                  <div className="mt-1 text-lg font-bold">ALNUS</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Alnus Yatırım Menkul Değerler A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Alnus Yatırım Menkul Değerler A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%22,60</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Alnus Yatırım Menkul Değerler A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Alnus Yatırım Menkul Değerler A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
