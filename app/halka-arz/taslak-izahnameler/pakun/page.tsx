...
export const metadata: Metadata = {
  title:
    "Pakun Üretim Gıda San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Pakun Üretim Gıda San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, tahsisat grupları, fon kullanım alanları ve finansal veriler.",
};
...
export default function PakunUretimGidaSanVeTicASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    "%40-30 Ürün çeşitlendirme, enerji ve kapasite artışı yatırımları",
    "%30-20 Finansal borçluluk seviyesinin azaltılması",
    "%40-30 İşletme sermayesi",
  ];

  const tahsisat = [
    "20.000.000 Lot (%50) Yurt İçi Bireysel Yatırımcı",
    "15.000.000 Lot (%37,5) Yurt İçi Kurumsal Yatırımcı",
    "5.000.000 Lot (%12,5) Yurt Dışı Kurumsal Yatırımcı",
  ];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_6: "2,9 Milyar TL",
      d2023: "5,8 Milyar TL",
      d2022: "4,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_6: "551,3 Milyon TL",
      d2023: "885,2 Milyon TL",
      d2022: "932,4 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Ürün, enerji ve kapasite yatırımları
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Pakun Üretim Gıda San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Pakun Üretim Gıda San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%30,07</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Pakun Üretim Gıda San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Pakun Üretim Gıda San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
