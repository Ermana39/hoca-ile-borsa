...
export const metadata: Metadata = {
  title:
    "Evofone Teknoloji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Evofone Teknoloji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function EvofoneTeknolojiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "90.000.000 Lot" },
    { label: "Aracı Kurum", value: "Ahlatcı Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 70.000.000 Lot",
    "Ortak Satışı: 20.000.000 Lot (Uğur Soylu)",
  ];

  const fonKullanim = [
    "%50-55 İşletme sermayesi",
    "%20-30 Yurt içi ve yurt dışında üretim tesisi kurulması, mevcut kapasitenin artırılması ve/veya bağlı ortaklık sermaye artırımı",
    "%15-20 Finansal borçların azaltılması",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "12,6 Milyar TL",
      d2023: "12,5 Milyar TL",
      d2022: "7,7 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%18,75",
      desc: "Planlanan halka açıklık oranı %18,75 seviyesindedir.",
    },
    {
    ...
    },
    {
      title: "Takvim",
      value: "2026 İlk Yarı",
      desc: "Halka arzın 2026 yılının ilk yarısında tamamlanması planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">90.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%18,75</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Evofone Teknoloji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Evofone Teknoloji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı,
                dağıtım yöntemi, pazar bilgisi, tahsisat grupları, fon kullanım alanları ve finansal
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%18,75.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Evofone Teknoloji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Evofone Teknoloji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar
            bilgisi, halka açıklık oranı, fon kullanım alanları, finansal veriler ve taahhüt
