...
export const metadata: Metadata = {
  title:
    "Termopet Akaryakıt Nakliyat ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Termopet Akaryakıt Nakliyat ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TermopetAkaryakitNakliyatVeTicASPage() {
  const summaryItems = [
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025: "17,3 Milyar TL",
      d2024: "18,5 Milyar TL",
      d2023: "22,0 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025: "694,1 Milyon TL",
      d2024: "476,5 Milyon TL",
      d2023: "558,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Tamamlanacak",
      desc: "Fiyat istikrarı bilgisi ilerleyen aşamalarda tamamlanacaktır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-sm font-bold">Tera Yatırım</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-emerald-800">
                    Tesis ve akaryakıt yatırımları
                  </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="mb-2 text-sm font-semibold text-slate-800">
                    Filo, enerji ve işletme sermayesi
                  </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Termopet Akaryakıt Nakliyat ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Termopet Akaryakıt Nakliyat ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Termopet Akaryakıt Nakliyat ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Termopet Akaryakıt Nakliyat ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
