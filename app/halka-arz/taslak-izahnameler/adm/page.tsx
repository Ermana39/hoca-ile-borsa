...
export const metadata: Metadata = {
  title:
    "Adm Energy Elektrik Yatırımları A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Adm Energy Elektrik Yatırımları A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AdmEnergyElektrikYatirimlariASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "72.814.782 Lot" },
    { label: "Aracı Kurum", value: "Yapı Kredi Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 36.407.391 Lot",
    "Ortak Satışı: 36.407.391 Lot (Parka Enerji Yatırımları A.Ş.)",
  ];

  const fonKullanim = [
    "%40 Dağıtım yatırımlarının finansmanı",
    "%20 İşletme sermayesi",
    "%40 Operasyonel şirketlerin borçluluk seviyelerinin azaltılması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025: "68,6 Milyar TL",
      d2024: "63,3 Milyar TL",
      d2023: "81,5 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025: "13,9 Milyar TL",
      d2024: "18,2 Milyar TL",
      d2023: "21,3 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "--- Gün",
      desc: "Taslak izahnamede fiyat istikrarı süresi boş bırakılmıştır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">72.814.782</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Adm Energy Elektrik Yatırımları A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Adm Energy Elektrik Yatırımları A.Ş. halka arz sürecinde yatırımcıların en çok
                ...
                alıyor. Bu sayfada şirketin taslak izahname verileri daha sade ve analiz
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">--- gün.</p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Adm Energy Elektrik Yatırımları A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Adm Energy Elektrik Yatırımları A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
