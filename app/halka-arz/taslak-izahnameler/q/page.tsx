...
export const metadata: Metadata = {
  title:
    "Q Yatırım Holding A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Q Yatırım Holding A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, BIST kodu, fon kullanım alanları ve finansal veriler.",
};
...
export default function QYatirimHoldingASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "500.000.000 Lot" },
    { label: "Aracı Kurum", value: "Allbatross Yatırım Menkul Değerler A.Ş." },
    { label: "BIST Kodu", value: "QYHOL" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 400.000.000 Lot",
    "Ortak Satışı: 100.000.000 Lot (Ali Ercan)",
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%19,8",
      desc: "Planlanan halka açıklık oranı %19,8 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">500.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">QYHOL</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Q Yatırım Holding A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Q Yatırım Holding A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı,
                dağıtım yöntemi, BIST kodu, satış yöntemi, fiyat istikrarı ve finansal görünüm yer
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%19,8.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Q Yatırım Holding A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Q Yatırım Holding A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, ortak satışı, dağıtım yöntemi, BIST
            kodu, satış yöntemi, halka açıklık oranı, fon kullanım alanları, finansal veriler ve
