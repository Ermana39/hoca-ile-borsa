...
export const metadata: Metadata = {
  title:
    "Özpet Plastik Global San. Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Özpet Plastik Global San. Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function OzpetPlastikGlobalSanTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "100.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 68.750.000 Lot",
    "Ortak Satışı: 31.250.000 Lot (Ahmet Selim Özsoy)",
  ];

  const fonKullanim = [
    "%35-40 Yatırım finansmanı ve makine/ekipman alımları",
    "%35-40 İşletme sermayesi",
    "%15-20 Finansal borçluluğun azaltılması",
    "%5-10 GES yatırımı",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024: "450,1 Milyon TL",
      d2023: "478,5 Milyon TL",
      d2022: "983,2 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "91,4 Milyon TL",
      d2023: "77,0 Milyon TL",
      d2022: "174,0 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%29,09",
      desc: "Planlanan halka açıklık oranı %29,09 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
    ...
    },
    {
      title: "Tahsisat",
      value: "2 Grup",
      desc: "Yurt içi bireysel ve yurt içi kurumsal yatırımcı grupları öne çıkmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">100.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%29,09</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Özpet Plastik Global San. Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Özpet Plastik Global San. Tic. A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak satışı,
                dağıtım yöntemi, fon kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%29,09.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Özpet Plastik Global San. Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Özpet Plastik Global San. Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
