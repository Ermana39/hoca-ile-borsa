...
export const metadata: Metadata = {
  title:
    "Taksim Holding A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Taksim Holding A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TaksimHoldingASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 28.500.000 Lot",
    "Ortak Satışı: 600.000 Lot (Safa Can Abdik)",
    "Ortak Satışı: 2.100.000 Lot (Saadet Abdik)",
    "Ortak Satışı: 2.100.000 Lot (Merve Çelik)",
    "Ortak Satışı: 2.100.000 Lot (İlknur Abdik)",
  ];

  const fonKullanim = [
    "%50-60 Yeni yatırım fırsatlarının değerlendirilmesi",
    "%10-20 İşletme sermayesi",
    "%30-40 Finansman ve kredi borç ödemeleri",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025_6: "159,3 Milyon TL",
      d2024: "331,9 Milyon TL",
      d2023: "294,6 Milyon TL",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Taksim Holding A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Taksim Holding A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Taksim Holding A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Taksim Holding A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
