...
export const metadata: Metadata = {
  title:
    "Enerjeo Kemaliye Enerji Üretim A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Enerjeo Kemaliye Enerji Üretim A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function EnerjeoKemaliyeEnerjiUretimASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 2.500.000 Lot (Atilla Başol)",
    "Ortak Satışı: 2.500.000 Lot (Hakan Başol)",
  ];

  const fonKullanim = [
    "%10-20 İşletme sermayesi",
    "%40-50 Finansman maliyetlerinin azaltılması",
    "%20-30 Yatırım finansmanı",
    "%10-20 Şirket satın alma ve/veya iş ortaklıkları kurulması",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2024_3: "47,1 Milyon TL",
      d2023: "359,0 Milyon TL",
      d2022: "623,8 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024_3: "33,4 Milyon TL",
      d2023: "192,2 Milyon TL",
      d2022: "27,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "15 Gün",
      desc: "15 gün boyunca brüt halka arz gelirinin %20'si ile fiyat istikrarı planlanıyor.",
    },
    {
    ...
    {
      title: "Dağıtım Yapısı",
      value: "Bireysel/Çalışan",
      desc: "Bireysel ve şirket çalışanları için eşit dağıtım bilgisi yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Enerjeo Kemaliye Enerji Üretim A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Enerjeo Kemaliye Enerji Üretim A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%26,92</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Enerjeo Kemaliye Enerji Üretim A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Enerjeo Kemaliye Enerji Üretim A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
