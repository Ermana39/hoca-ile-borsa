...
export const metadata: Metadata = {
  title:
    "Smm Tekstil A.Ş. Halka Arz Detayları | Taslak İzahname ve Finansal Veriler",
  description:
    "Smm Tekstil A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, aracı kurum bilgileri, finansal veriler ve halka açıklık oranı.",
};
...
export default function SmmTekstilASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "12.500.000 Lot" },
    {
      label: "Aracı Kurum",
      value: "Şeker Yatırım Menkul Değerler A.Ş.",
    },
    { label: "BIST Kodu", value: "SMMAS" },
    { label: "Halka Açıklık", value: "%27,4" },
    { label: "T1-T2 Durumu", value: "T1-T2 Uygun" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 10.500.000 Lot",
    "Ortak Satışı: 2.000.000 Lot (Murat Şimşek)",
  ];

  const fonKullanim = [
    "%50 Şirketin finansal borçlarının geri ödemesinde.",
    "%30 Şirketin işletme sermayesi ihtiyacının karşılanmasında.",
    "%20 Şirketin büyüme stratejisi kapsamında marka ve lisans haklarının satın alınmasının finansmanında.",
  ];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2022_9: "407,4 Milyon TL",
      d2021: "300,3 Milyon TL",
      d2020: "221,1 Milyon TL",
    },
    {
      kalem: "Brüt Kar",
      d2022_9: "70,9 Milyon TL",
      d2021: "49,5 Milyon TL",
      d2020: "21,8 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Toplam Pay",
      value: "12,5 Mn",
      desc: "Planlanan toplam halka arz pay miktarı.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-7 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="text-2xl font-bold sm:text-3xl">Smm Tekstil A.Ş.</h1>
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">12.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">SMMAS</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Smm Tekstil A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Smm Tekstil A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi, fon
                kullanım planı, halka açıklık oranı ve finansal görünüm yer alıyor. Bu sayfada
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">Eşit Dağıtım</p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%27,4.</p>
                </div>

                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  <div className="text-sm font-semibold text-emerald-800">T1-T2 Durumu</div>
                  <p className="mt-2 text-sm text-emerald-900">T1-T2 Uygun.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Smm Tekstil A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Smm Tekstil A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım yöntemi, aracı kurum bilgisi,
            halka açıklık oranı, fon kullanım alanları ve finansal veriler bir arada sunulmuştur.
            Sayfadaki bilgiler taslak izahnameye göre hazırlanmıştır.
          </p>
        </section>
      </div>
    </main>
