...
export const metadata: Metadata = {
  title:
    "Başakkent Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Başakkent Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları, tahsisat grupları ve finansal veriler.",
};
...
export default function BasakkentGayrimenkulYatirimOrtakligiASPage() {
  const summaryItems = [
    ...
    { label: "Aracı Kurum", value: "Integral Yatırım Menkul Değerler A.Ş." },
  ];
  ...
  const fonKullanim = [
    "%30-40 Yeni projelerin finansmanı",
    "%50-60 Konaklamalı orman tesisi projesi finansmanı",
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "391,8 Bin TL",
      d2024: "77,7 Milyon TL",
      d2023: "48,3 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "(-)3,8 Milyon TL",
      d2024: "(-)30,0 Milyon TL",
      d2023: "(-)92,4 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%26,31",
      desc: "Planlanan halka açıklık oranı %26,31 seviyesindedir.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                ...
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">%26,31</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Başakkent Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Başakkent Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sürecinde yatırımcıların en
                çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                ortak satışı, dağıtım yöntemi, fon kullanım alanları, tahsisat yapısı ve finansal
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    Son üç dönemde negatif brüt kâr görünümü dikkat çekmektedir.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%26,31.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Başakkent Gayrimenkul Yatırım Ortaklığı A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Başakkent Gayrimenkul Yatırım Ortaklığı A.Ş. halka arz sayfasında yatırımcıların hızlı
