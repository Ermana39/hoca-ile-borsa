...
export const metadata: Metadata = {
  title:
    "Türkiye Emlak Katılım Bankası A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Türkiye Emlak Katılım Bankası A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function TurkiyeEmlakKatilimBankasiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "600.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 600.000.000 Lot"];

  const fonKullanim = [
    "%50-60 Yatırım finansmanı",
    "%20-25 İşletme sermayesi",
    "%20-25 Özkaynağın güçlendirilmesi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025: "55,1 Milyar TL",
      d2024: "33,6 Milyar TL",
      d2023: "16,6 Milyar TL",
    },
    {
      kalem: "Net Kâr",
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
      desc: "Sabit fiyatla talep toplama yöntemi uygulanacak.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">600.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Türkiye Emlak Katılım Bankası A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Türkiye Emlak Katılım Bankası A.Ş. halka arz sürecinde yatırımcıların en çok takip
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Türkiye Emlak Katılım Bankası A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Türkiye Emlak Katılım Bankası A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
