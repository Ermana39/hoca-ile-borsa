...
export const metadata: Metadata = {
  title:
    "Naturel Holding A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Naturel Holding A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları, tahsisat grupları ve finansal veriler.",
};
...
export default function NaturelHoldingASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    "%70 Yeni yatırım imkanlarının değerlendirilmesi",
    "%25 Kısa vadeli finansal borçların finansmanı",
    "%5 İşletme sermayesi",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "474,5 Milyon TL",
      d2024: "1,2 Milyar TL",
      d2023: "-",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "3,2 Milyar TL",
      d2024: "1,1 Milyar TL",
      d2023: "1,2 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Hazırlanıyor",
      desc: "Fiyat istikrarına ilişkin detayların netleşmesi bekleniyor.",
    },
    {
      title: "Satmama",
      value: "1 Yıl",
      desc: "İhraççı ve ortaklar için 1 yıl satmama taahhüdü yer alıyor.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Naturel Holding A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Naturel Holding A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği başlıklar
                arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi, tahsisat
                grupları, fon kullanım alanları ve finansal görünüm yer alıyor. Bu sayfada taslak
                izahname verileri daha sade, düzenli ve analiz edilebilir bir yapıda sunulmuştur.
              </p>
            </section>
          </div>
          ...
          <aside className="space-y-8">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-sm font-semibold text-slate-800">Pay Tutarı</div>
                  <p className="mt-2 text-sm text-slate-700">50.000.000 Lot</p>
                </div>
              </div>
            </section>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Naturel Holding A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Naturel Holding A.Ş. halka arz sayfasında yatırımcıların hızlı analiz yapabilmesi için
            ...
            Sayfadaki bilgiler taslak izahname verilerine göre hazırlanmıştır ve resmi veriler
