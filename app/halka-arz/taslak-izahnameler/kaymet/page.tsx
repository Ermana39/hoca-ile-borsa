...
export const metadata: Metadata = {
  title:
    "Kaymet Metal İmalat San. ve Tic. A.Ş. Halka Arz Detayları | Taslak İzahname ve Finansal Veriler",
  description:
    "Kaymet Metal İmalat San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, aracı kurum bilgileri, finansal veriler ve halka açıklık oranı.",
};
...
export default function KaymetMetalImalatSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "10.500.000 Lot" },
    {
      label: "Aracı Kurum",
      value: "Alnus Yatırım Menkul Değerler A.Ş.",
    },
    { label: "BIST Kodu", value: "KAYMT" },
    { label: "Halka Açıklık", value: "%31,82" },
    { label: "T1-T2 Durumu", value: "T1-T2 Uygun" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 9.000.000 Lot",
    "Ortak Satışı: 750.000 Lot (Mehmet Sönmez)",
    "Ortak Satışı: 750.000 Lot (Ali Metin Sönmez)",
  ];

  const fonKullanim = [
    "%52 İşletme sermayesi.",
    "%38 Yeni makine yatırımları.",
    "%10 Fabrika ve depo alanının genişletilmesi.",
  ];

  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2022: "655,3 Milyon TL",
      d2021: "394,8 Milyon TL",
      d2020: "185,6 Milyon TL",
    },
    {
      kalem: "Brüt Kar",
      d2022: "118,7 Milyon TL",
      d2021: "79,6 Milyon TL",
      d2020: "26,3 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "30 Gün",
      desc: "Brüt halka arz gelirinin %15’i ile fiyat istikrarı planlanmaktadır.",
    },
    {
      title: "Halka Açıklık",
      value: "%31,82",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">10.500.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">BIST Kodu</div>
                  <div className="mt-1 text-lg font-bold">KAYMT</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Kaymet Metal İmalat San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Kaymet Metal İmalat San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                dağıtım yöntemi, fon kullanım planı, halka açıklık oranı ve finansal görünüm yer
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">1 Yıl, İhraççı.</p>
                  <p className="mt-1 text-sm text-blue-900">1 Yıl, Ortaklar.</p>
                </div>

                <div className="rounded-2xl border border-indigo-200 bg-indigo-50 p-4">
                  <div className="text-sm font-semibold text-indigo-800">Fiyat İstikrarı</div>
                  <p className="mt-2 text-sm text-indigo-900">
                    30 gün. Brüt halka arz gelirinin %15&apos;i.
                  </p>
                </div>

                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  <div className="text-sm font-semibold text-cyan-800">Halka Açıklık</div>
                  <p className="mt-2 text-sm text-cyan-900">%31,82.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Kaymet Metal İmalat San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Kaymet Metal İmalat San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
            yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, dağıtım yöntemi,
            aracı kurum bilgisi, halka açıklık oranı, fon kullanım alanları ve finansal veriler bir
