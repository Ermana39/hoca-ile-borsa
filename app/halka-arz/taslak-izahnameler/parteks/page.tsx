...
export const metadata: Metadata = {
  title:
    "Parteks Kağıt Endüstrisi A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Parteks Kağıt Endüstrisi A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};

export default function ParteksKagitEndustrisiASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "92.250.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 69.000.000 Lot",
    "Ortak Satışı: 23.250.000 Lot",
  ];

  const fonKullanim = [
    "%60 Osb fabrikasında yatırım ve kapasite artırımı",
    "%20 İşletme sermayesi",
    "%10 Yenilenebilir enerji yatırımları",
    "%10 Dijitalleşme ve üretimde verimlilik artırımı finansmanı",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2025: "554,9 Milyon TL",
      d2024: "338,1 Milyon TL",
      d2023: "331,2 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "5 Gün",
      desc: "5 gün boyunca 4.650.000 adet günlük alım emri girilecek.",
    },
    {
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[320px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">92.250.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-indigo-200 bg-indigo-50 p-4">
                  <div className="font-semibold text-indigo-800">Günlük Alım Emri</div>
                  <p className="mt-2 text-sm text-indigo-900">
                    5 gün, 4.650.000 adet günlük alım emri girilecek.
                  </p>
                </div>

                <div className="rounded-2xl border border-violet-200 bg-violet-50 p-4">
                  <div className="font-semibold text-violet-800">Satmama Taahhüdü</div>
                  <p className="mt-2 text-sm text-violet-900">1 yıl ihraççı, 1 yıl ortaklar.</p>
                </div>
