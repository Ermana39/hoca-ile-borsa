...
export const metadata: Metadata = {
  title:
    "Fortis Enerji Elektrik Üretim A.Ş. Halka Arz Detayları 2026 | Taslak İzahname Özeti",
  description:
    "Fortis Enerji Elektrik Üretim A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, aracı kurum bilgileri ve mevcut taslak veriler.",
};
...
export default function FortisEnerjiElektrikUretimASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "23.428.571 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 16.400.000 Lot",
    "Ortak Satışı: 7.028.571 Lot (Mehmet Burak Uçkardeş)",
  ];
  ...
  const oneCikanlar = [
    {
      title: "Toplam Pay",
      value: "23,4 Milyon",
      desc: "Taslak verilerde toplam pay miktarı 23.428.571 lot olarak yer alıyor.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">23.428.571</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-5 text-xl font-bold text-slate-900">
                Fortis Enerji Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Fortis Enerji Elektrik Üretim A.Ş. için taslak izahnamede şu aşamada sınırlı veri
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Fortis Enerji Elektrik Üretim A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Fortis Enerji Elektrik Üretim A.Ş. halka arz sayfasında mevcut taslak veriler sade ve
