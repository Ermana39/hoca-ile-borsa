...
export const metadata: Metadata = {
  title:
    "Noksel Çelik Boru Sanayii A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Noksel Çelik Boru Sanayii A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function NokselCelikBoruSanayiiASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 22.000.000 Lot",
    "Ortak Satışı: 5.520.000 Lot (Tersan Tersanecilik San. ve Tic. A.Ş.)",
    "Ortak Satışı: 420.000 Lot (Başarı Yatırımları San. ve Tic. A.Ş.)",
    "Ortak Satışı: 60.000 Lot (Salim Erol Akkoyunlu)",
  ];

  const fonKullanim = [
    "%25-30 İşletme sermayesi",
    "%25-30 Finansal yapının sağlamlaştırılması",
    "%25-30 Makine, ekipman ve proje yatırımları",
    "%5-35 Satış, pazarlama ve iş geliştirme faaliyetleri",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_6: "7,9 Milyar TL",
      d2024: "19,1 Milyar TL",
      d2023: "16,3 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_6: "1,7 Milyar TL",
      d2024: "3,4 Milyar TL",
      d2023: "2,9 Milyar TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Belirsiz",
      desc: "Fiyat istikrarı detayları ilerleyen aşamalarda tamamlanacaktır.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Noksel Çelik Boru Sanayii A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Noksel Çelik Boru Sanayii A.Ş. halka arz sürecinde yatırımcıların en çok takip
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%22,95</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Noksel Çelik Boru Sanayii A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Noksel Çelik Boru Sanayii A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
