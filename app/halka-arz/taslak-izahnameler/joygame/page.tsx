...
export const metadata: Metadata = {
  title:
    "Joygame Oyun ve Teknoloji A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Joygame Oyun ve Teknoloji A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function JoygameOyunVeTeknolojiASPage() {
  const summaryItems = [
  ...
  const fonKullanim = [
    "%60-70 Büyümeye yönelik yatırımlar",
    "%10-15 İşletmenin verimli ve etkin yönetimine yönelik yatırımlar",
    "%20-25 Oyuncu merkezli içerik uygulamaları ve teknoloji yatırımları",
  ];
  ...
  const finansalVeriler = [
    {
      kalem: "Hasılat",
      d2025_3: "134,4 Milyon TL",
      d2024: "767,1 Milyon TL",
      d2023: "676,9 Milyon TL",
    },
    {
      kalem: "Brüt Kâr",
      d2025_3: "39,9 Milyon TL",
      d2024: "340,0 Milyon TL",
      d2023: "248,1 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Planlanıyor",
      desc: "Fiyat istikrarına ilişkin uygulamanın planlandığı görülüyor.",
    },
    {
      title: "Dağıtım",
      value: "Eşit",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Joygame Oyun ve Teknoloji A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Joygame Oyun ve Teknoloji A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi,
                pazar bilgisi, fon kullanım alanları, fiyat istikrarı ve finansal görünüm yer alıyor.
          ...
          <aside className="space-y-8">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="text-sm font-semibold text-slate-800">Dağıtılacak Pay Miktarı (Olası)</div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Joygame Oyun ve Teknoloji A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Joygame Oyun ve Teknoloji A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
