...
export default function EkincilerDemirVeCelikSanayiASPage() {
  ...
  const halkaArzSekli = [
    ...
    "Ortak Satışı: 1.713.972 Lot (Tarık Ekinci)",
    "Ortak Satışı: 1.713.972 Lot (Nezihe Ekinci)",
    "Ortak Satışı: 1.713.972 Lot (Sıdkı Baytan)",
    "Ortak Satışı: 571.324 Lot (İlker Eker)",
    "Ortak Satışı: 571.324 Lot (İlkay Eker)",
    "Ortak Satışı: 571.324 Lot (Soner Eker)",
    "Ortak Satışı: 21.96 Lot (Recep Ekinci)",
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "%60",
      desc: "Fon kullanımında en yüksek pay yenilenebilir enerji yatırımlarına ayrılıyor.",
    },
  ];
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-7 text-slate-600">
                Ekinciler Demir ve Çelik Sanayi A.Ş. halka arz sürecinde yatırımcıların en çok
