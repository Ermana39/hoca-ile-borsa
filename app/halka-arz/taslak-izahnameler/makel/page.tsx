...
export const metadata: Metadata = {
  title:
    "Makel Elektrik Malzemeleri San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Makel Elektrik Malzemeleri San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function MakelElektrikMalzemeleriSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "63.400.000 Lot" },
    { label: "Aracı Kurum", value: "İnfo Yatırım Menkul Değerler A.Ş." },
    { label: "Pazar", value: "Yıldız Pazar" },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 50.691.000 Lot",
    "Ortak Satışı: 6.354.500 Lot (Necati Çalışkan)",
    "Ortak Satışı: 3.177.250 Lot (Turgay Yalçınkaya)",
    "Ortak Satışı: 3.177.250 Lot (Günay Yalçınkaya)",
  ];

  const fonKullanim = [
    "%33-38 Finansal borçluluk seviyesinin azaltılması",
    "%25-30 İşletme sermayesi",
    "%20-25 Yurt dışı hammadde tedariki",
    "%3-6 Fabrika yenileme ve kapasite artırımı",
    "%3-4 Pazarlama, Ar-Ge ve Ür-Ge",
    "%2-3 Çatı GES (Güneş Enerjisi Santrali) yatırımı",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "376,2 Milyon TL",
      d2023: "540,8 Milyon TL",
      d2022: "390,7 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%20,79",
      desc: "Planlanan halka açıklık oranı %20,79 seviyesindedir.",
    },
    {
    ...
    },
    {
      title: "Günlük Alım",
      value: "1,268 Milyon",
      desc: "5 gün boyunca en yüksek günlük alım emri 1.268.000 adet olarak planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">63.400.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <div className="text-xs text-blue-100">Halka Açıklık</div>
                  <div className="mt-1 text-lg font-bold">%20,79</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  ...
                  <div className="text-sm text-emerald-900">{fonKullanim[3]}</div>
                </div>
                ...
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  ...
                  <div className="text-sm text-emerald-900">{fonKullanim[4]}</div>
                </div>
                ...
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                  ...
                  <div className="text-sm text-emerald-900">{fonKullanim[5]}</div>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Makel Elektrik Malzemeleri San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Makel Elektrik Malzemeleri San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
                takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, ortak
                satışı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal görünüm yer
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-700">
                    5 gün 1.268.000 adet, 5 gün 634.000 adet ve 5 gün 634.000 adet günlük alım emri planlanmaktadır.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,79.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Makel Elektrik Malzemeleri San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Makel Elektrik Malzemeleri San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı
