...
export const metadata: Metadata = {
  title:
    "Sector Tarım Kimya Gıda Pazarlama San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Sector Tarım Kimya Gıda Pazarlama San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function SectorTarimKimyaGidaPazarlamaSanVeTicASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "165.000.000 Lot" },
    { label: "Ek Pay", value: "Bulunmuyor" },
    { label: "Aracı Kurum", value: "Bulls Yatırım Menkul Değerler A.Ş." },
  ];

  const halkaArzSekli = [
    "Sermaye Artırımı: 150.000.000 Lot",
    "Ortak Satışı: 5.000.000 Lot (Fuat Kunduracı)",
    "Ortak Satışı: 5.000.000 Lot (Süleyman Terlemez)",
    "Ortak Satışı: 5.000.000 Lot (Fatih Kocaman)",
  ];
  ...
  const finansalVeriler = [
    ...
    {
      kalem: "Brüt Kâr",
      d2024: "684,7 Milyon TL",
      d2023: "519,0 Milyon TL",
      d2022: "379,9 Milyon TL",
    },
  ];
  ...
  const oneCikanlar = [
    {
      title: "Halka Açıklık",
      value: "%22",
      desc: "Planlanan halka açıklık oranı %22 seviyesindedir.",
    },
    {
      title: "Satış Yöntemi",
      value: "Sabit Fiyat",
    ...
    },
    {
      ...
      value: "15 Gün",
      desc: "Brüt halka arz gelirinin %20'si ile 15 gün fiyat istikrarı planlanıyor.",
    },
    {
      title: "T1-T2",
      value: "Uygun",
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">165.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Sector Tarım Kimya Gıda Pazarlama San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Sector Tarım Kimya Gıda Pazarlama San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların
                en çok takip ettiği başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı,
                ortak satışı, dağıtım yöntemi, fon kullanım alanları ve finansal görünüm yer alıyor.
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%22.</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Sector Tarım Kimya Gıda Pazarlama San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Sector Tarım Kimya Gıda Pazarlama San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların
            hızlı analiz yapabilmesi için halka arz tarihi, halka arz fiyatı, lot miktarı, ortak
            satışı, dağıtım yöntemi, halka açıklık oranı, fon kullanım alanları, finansal veriler ve
