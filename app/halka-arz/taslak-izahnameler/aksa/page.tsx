...
export const metadata: Metadata = {
  title:
    "Aksa Elektrik Perakende Satış A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Aksa Elektrik Perakende Satış A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, pazar bilgisi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AksaElektrikPerakendeSatisASPage() {
  const summaryItems = [
    ...
    { label: "Pay", value: "300.000.000 Lot" },
    {
      label: "Aracı Kurum",
      value:
  ...
  const halkaArzSekli = ["Sermaye Artırımı: 300.000.000 Lot"];

  const fonKullanim = [
    "%60-65 Şirket'in elektrik dağıtım şirketlerinin yatırım harcamaları",
    "%15-20 İşletme sermayesi",
    "%15-25 Büyüme odaklı potansiyel yeni stratejik yatırım planları",
  ];
  ...
  const finansalVeriler = [
    {
      ...
      d2023: "33,8 Milyar TL",
      d2022: "37,7 Milyar TL",
    },
    {
      kalem: "Brüt Kâr",
      d2024: "4,5 Milyar TL",
  ...
  const oneCikanlar = [
    ...
    },
    {
      title: "Halka Açıklık",
      value: "%20",
      desc: "Planlanan halka açıklık oranı %20 seviyesindedir.",
    },
    {
      title: "Fiyat İstikrarı",
      value: "30 Gün",
      desc: "Halka arz sonrası 30 gün fiyat istikrarı planlanmaktadır.",
    },
    {
      title: "Tahmini Takvim",
      value: "2024 İkinci Yarı",
      desc: "Tahmini halka arz takvimi 2024 yılının ikinci yarısında tamamlanacak şekilde planlanmaktadır.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 md:min-w-[300px]">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  ...
                  <div className="mt-1 text-lg font-bold">300.000.000</div>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Aksa Elektrik Perakende Satış A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Aksa Elektrik Perakende Satış A.Ş. halka arz sürecinde yatırımcıların en çok takip ettiği
                başlıklar arasında halka arz tarihi, fiyat aralığı, pay miktarı, dağıtım yöntemi,
                tahsisat yapısı, tahmini takvim, fon kullanım alanları ve finansal görünüm yer
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-blue-900">
                    30 gün, Yapı Kredi Menkul Değerler A.Ş.
                  </p>
                </div>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Aksa Elektrik Perakende Satış A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Aksa Elektrik Perakende Satış A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
