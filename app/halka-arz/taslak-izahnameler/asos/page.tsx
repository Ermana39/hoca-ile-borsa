...
export const metadata: Metadata = {
  title:
    "Asos Proses Makina San. ve Tic. A.Ş. Halka Arz Detayları 2026 | Taslak İzahname ve Finansal Veriler",
  description:
    "Asos Proses Makina San. ve Tic. A.Ş. halka arz detayları, taslak izahname özeti, halka arz tarihi, fiyat aralığı, lot miktarı, dağıtım yöntemi, fon kullanım alanları ve finansal veriler.",
};
...
export default function AsosProsesMakinaSanVeTicASPage() {
  const summaryItems = [
  ...
  const halkaArzSekli = [
    "Sermaye Artırımı: 25.200.000 Lot",
    "Ortak Satışı: 10.800.000 Lot (Önder Filiz)",
    "Ek Ortak Satışı: 2.000.000 Lot (Eurocad Sarl.)",
  ];

  const fonKullanim = [
    "%35 Yeni projelerin finansmanı",
    "%35 İşletme sermayesi",
    "%30 Farklı sektör yatırımları",
  ];
  ...
  const oneCikanlar = [
    ...
    },
    {
      ...
      value: "Planlanıyor",
      desc: "Taslak izahnamede fiyat istikrarı planlandığı belirtiliyor.",
    },
    {
      title: "Günlük Alım Emri",
      value: "5 Gün",
      desc: "5 gün boyunca 1.440.000 adet günlük alım emri girilecek.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 xl:col-span-2">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="mb-4 text-xl font-bold text-slate-900">
                Asos Proses Makina San. ve Tic. A.Ş. Halka Arz Yorumu
              </h2>
              <p className="text-sm leading-7 text-slate-600">
                Asos Proses Makina San. ve Tic. A.Ş. halka arz sürecinde yatırımcıların en çok
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-indigo-200 bg-indigo-50 p-4">
                  <div className="text-sm font-semibold text-indigo-800">Günlük Alım Emri</div>
                  <p className="mt-2 text-sm text-indigo-900">
                    5 gün, 1.440.000 adet günlük alım emri girilecek.
                  </p>
                </div>

                <div className="rounded-2xl border border-violet-200 bg-violet-50 p-4">
                  <div className="text-sm font-semibold text-violet-800">Satmama Taahhüdü</div>
                ...
                <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-4">
                  ...
                  <p className="mt-2 text-sm text-cyan-900">%20,17</p>
                </div>
              </div>
            </section>
          </aside>
        ...
        <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-3 text-lg font-bold text-slate-900">
            Asos Proses Makina San. ve Tic. A.Ş. Halka Arz Değerlendirmesi
          </h2>
          <p className="text-sm leading-7 text-slate-600">
            Asos Proses Makina San. ve Tic. A.Ş. halka arz sayfasında yatırımcıların hızlı analiz
