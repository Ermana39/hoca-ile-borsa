...
const tumDusenler = [
  { kod: "IHLASR", fark: "-27,78%" },
  { kod: "BIGEN", fark: "-10,00%" },
  { kod: "ENSRI", fark: "-10,00%" },
  { kod: "MAGEN", fark: "-10,00%" },
  { kod: "ISKPL", fark: "-9,98%" },
  { kod: "HPARTF2", fark: "-9,89%" },
  { kod: "MERKO", fark: "-9,66%" },
  { kod: "ATPYF2", fark: "-9,46%" },
  { kod: "CELHA", fark: "-9,33%" },
  { kod: "BLCYT", fark: "-8,73%" },
];

const tumHacimliler = [
  { kod: "ASTOR", hacim: "13.398.241.330" },
  { kod: "ASELS", hacim: "13.376.222.463" },
  { kod: "THYAO", hacim: "9.389.712.062" },
  { kod: "EUPWR", hacim: "7.528.309.821" },
  { kod: "AKBNK", hacim: "6.598.355.860" },
  { kod: "GESAN", hacim: "6.138.780.495" },
  { kod: "SASA", hacim: "5.760.150.046" },
  { kod: "BIMAS", hacim: "4.573.454.856" },
  { kod: "TUPRS", hacim: "4.260.560.189" },
  { kod: "YKBNK", hacim: "4.217.368.311" },
];

const tumParaGirisi = [
  { kod: "ASELS", tutar: "+266.004.270" },
  { kod: "THYAO", tutar: "+194.175.708" },
  { kod: "TERA", tutar: "+153.382.147" },
  { kod: "TUPRS", tutar: "+138.082.498" },
  { kod: "EREGL", tutar: "+127.633.573" },
  { kod: "EUPWR", tutar: "+122.235.500" },
  { kod: "SASA", tutar: "+102.643.565" },
  { kod: "FROTO", tutar: "+79.496.103" },
  { kod: "EKDMR", tutar: "+71.537.335" },
  { kod: "SAHOL", tutar: "+50.495.604" },
];

const tumParaCikisi = [
  { kod: "ASTOR", tutar: "-98.228.274" },
  { kod: "BIMAS", tutar: "-92.077.155" },
  { kod: "DAPGM", tutar: "-85.040.140" },
  { kod: "AKBNK", tutar: "-78.013.202" },
  { kod: "TTKOM", tutar: "-77.071.408" },
  { kod: "KRDMD", tutar: "-50.404.870" },
  { kod: "PETKM", tutar: "-45.432.272" },
  { kod: "YKBNK", tutar: "-42.762.842" },
];

const enCokAlisYapanKurumlar = [
  { kurum: "PUSULA YAT.", hacim: "1.350.928.267", oran: "%21,83" },
  { kurum: "TERA", hacim: "962.671.375", oran: "%15,55" },
  { kurum: "HSBC", hacim: "876.038.880", oran: "%14,16" },
  { kurum: "YATIRIM FINANSMAN", hacim: "724.845.953", oran: "%11,71" },
  { kurum: "DENIZ", hacim: "435.066.368", oran: "%7,03" },
];

const enCokSatisYapanKurumlar = [
  { kurum: "IS", hacim: "-1.038.842.851", oran: "%16,79" },
  { kurum: "INFO", hacim: "-1.026.620.883", oran: "%16,59" },
  { kurum: "BANK OF AMERICA", hacim: "-685.184.824", oran: "%11,07" },
  { kurum: "TACIRLER", hacim: "-464.635.455", oran: "%7,51" },
  { kurum: "AK", hacim: "-413.784.350", oran: "%6,69" },
];

const enCokHacimYapanKurumlar = [
  { kurum: "YAPI KREDI", hacim: "69.007.694.448", oran: "%14,35" },
  { kurum: "BANK OF AMERICA", hacim: "60.123.578.974", oran: "%12,50" },
  { kurum: "IS", hacim: "50.936.196.059", oran: "%10,59" },
  { kurum: "AK", hacim: "40.788.028.292", oran: "%8,48" },
  { kurum: "MIDAS", hacim: "21.239.153.314", oran: "%4,42" },
];
