...
const tumYukselenler = [
  { kod: "RTALB", fark: "+10,00%" },
  { kod: "QPERPF1", fark: "+10,00%" },
  { kod: "INFO", fark: "+10,00%" },
  { kod: "GENIL", fark: "+10,00%" },
  { kod: "OZATD", fark: "+9,99%" },
  { kod: "PRKAB", fark: "+9,99%" },
  { kod: "PNSUT", fark: "+9,98%" },
  { kod: "SEGMN", fark: "+9,98%" },
...
const tumHacimliler = [
  { kod: "SASA", hacim: "24.093.954.545" },
  { kod: "PASEU", hacim: "15.352.638.564" },
  { kod: "EREGL", hacim: "14.177.819.783" },
  { kod: "AKBNK", hacim: "10.720.979.097" },
  { kod: "THYAO", hacim: "9.915.876.303" },
  { kod: "ASELS", hacim: "9.128.445.431" },
  { kod: "ASTOR", hacim: "8.943.147.844" },
  { kod: "TUPRS", hacim: "7.317.828.274" },
  { kod: "SISE", hacim: "7.221.172.711" },
  { kod: "HEKTS", hacim: "6.744.228.001" },
  { kod: "KRDMD", hacim: "6.459.889.785" },
];

const tumParaGirisi = [
  { kod: "PEKGY", tutar: "+321.904.788" },
  { kod: "KRDMD", tutar: "+152.892.122" },
  { kod: "AKBNK", tutar: "+138.829.618" },
  { kod: "THYAO", tutar: "+136.583.542" },
  { kod: "ISCTR", tutar: "+117.234.000" },
  { kod: "TUPRS", tutar: "+115.251.512" },
  { kod: "ASELS", tutar: "+108.172.893" },
];

const tumParaCikisi = [
  { kod: "EREGL", tutar: "-168.707.542" },
  { kod: "BIMAS", tutar: "-121.228.041" },
  { kod: "HEKTS", tutar: "-91.212.955" },
  { kod: "KLRHO", tutar: "-88.881.393" },
  { kod: "EFOR", tutar: "-75.511.395" },
  { kod: "ENKAI", tutar: "-50.571.884" },
  { kod: "GESAN", tutar: "-43.724.078" },
  { kod: "SASA", tutar: "-43.607.976" },
];

const enCokAlisYapanKurumlar = [
  { kurum: "YAPI KREDI", hacim: "4.558.072.695", oran: "%30,44" },
  { kurum: "TEB", hacim: "2.501.309.655", oran: "%16,70" },
  { kurum: "TERA", hacim: "1.739.094.239", oran: "%11,61" },
  { kurum: "DESTEK", hacim: "1.376.795.423", oran: "%9,19" },
  { kurum: "MIDAS", hacim: "724.489.309", oran: "%4,84" },
];

const enCokSatisYapanKurumlar = [
  { kurum: "BANK OF AME", hacim: "-2.726.934.097", oran: "%18,21" },
  { kurum: "ZIRAAT", hacim: "-2.318.219.813", oran: "%15,48" },
  { kurum: "IS", hacim: "-1.452.795.796", oran: "%9,57" },
  { kurum: "AK", hacim: "-1.277.093.910", oran: "%8,53" },
  { kurum: "TACIRLER", hacim: "-1.128.380.312", oran: "%7,54" },
];

const enCokHacimYapanKurumlar = [
  { kurum: "YAPI KREDI", hacim: "109.891.246.648", oran: "%14,70" },
  { kurum: "BANK OF AME", hacim: "92.563.651.659", oran: "%12,38" },
  { kurum: "IS", hacim: "70.822.916.480", oran: "%9,47" },
  { kurum: "AK", hacim: "55.989.380.140", oran: "%7,49" },
  { kurum: "INFO", hacim: "42.411.597.887", oran: "%5,67" },
];
    ...
    kayitlar: [
      {
        saat: "10:00",
        ulke: "TR",
        gosterge: "Toplam Ciro Endeksi (Yıllık %)",
