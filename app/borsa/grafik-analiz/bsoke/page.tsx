...
export default function BsokeGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>BSOKE Teknik Analiz — 08.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Batısöke Çimento (BSOKE) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/bsoke" />
          ...
          <div className="bsoke-scenario-grid">
            <div className="bsoke-scenario-card bull">
              ...
              <ul>
                ...
                <li>Hedef: 200.00–39.99 TL direnç bölgesi</li>
              </ul>
            </div>
