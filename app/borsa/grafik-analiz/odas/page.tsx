...
export default function OdasPage() {
  return (
        ...
        <article className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-4 text-base leading-8 text-zinc-700 md:text-lg">
              <p>
                ODAS hissesinde fiyatın önemli bir direnç bölgesinden tepki aldığı
                görülüyor.
              </p>

              <p>
                Özellikle 7,22 seviyesi kısa vadede kritik direnç olarak
                izlenebilir.
              </p>

              <p>
                Bu seviye yukarı yönlü aşılmadıkça hissede bir miktar geri
                çekilme ve kâr satışları gündeme gelebilir.
              </p>

              <p>
                Olası geri çekilmelerde destek bölgelerinin nasıl çalışacağı da
