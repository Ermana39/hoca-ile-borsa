...
export default function OdasGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>ODAS Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Odaş Elektrik (ODAS) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/odas" />
      ...
      <div className="odas-wrap">
        ...
        <main className="odas-main">
          ...
          <div className="odas-narrative">
            ...
            <p>188.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>6.14–6.75 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
