...
export const metadata: Metadata = {
  title: "KCHOL Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Koç Holding (KCHOL) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/kchol",
  },
};
...
export default function KcholGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="kchol" tarih="2026-06-07" />
