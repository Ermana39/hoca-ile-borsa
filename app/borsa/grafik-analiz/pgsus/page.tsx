...
export default function PgsusGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>PGSUS Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Pegasus Hava Yolları (PGSUS) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/pgsus" />
      ...
      <div className="pgsus-wrap">
        ...
        <main className="pgsus-main">
          ...
          <div className="pgsus-narrative">
            ...
            <p>188.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>202.15–161.72 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
