...
export const metadata: Metadata = {
  title: "TSKB Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Türkiye Sınai Kalkınma Bankası (TSKB) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/tskb",
  },
};
...
export default function TskbGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="tskb" tarih="2026-06-07" />
