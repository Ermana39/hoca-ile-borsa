...
export default function KuyasGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>KUYAS Teknik Analiz — 10.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Kuyas Holding (KUYAS) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/kuyas" />
      ...
      <div className="kuyas-wrap">
        ...
        <footer style={{ background:"var(--bg)", borderTop:"1px solid var(--border)" }}>
          <div className="kuyas-footer">
            <div className="kuyas-footer-inner">
              <div className="kuyas-footer-brand">HOCA İLE BORSA</div>
              <div className="kuyas-footer-meta">
                KUYAS Teknik Analiz Raporu<br />
                Hazırlanma: 10.06.2026 &nbsp;·&nbsp; Veri: BIST / IQ Platform
              </div>
            </div>
            <div className="kuyas-footer-legal">
