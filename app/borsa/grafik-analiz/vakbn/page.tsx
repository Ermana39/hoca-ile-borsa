...
export const metadata: Metadata = {
  title: "VAKBN Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "VakıfBank (VAKBN) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/vakbn",
  },
};
...
export default function VakbnGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="vakbn" tarih="2026-06-07" />
      ...
      <div className="vakbn-wrap">
        ...
        <main className="vakbn-main">
          ...
          <div className="vakbn-narrative">
            ...
            <p>31.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>30.57–29.61 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="vakbn-scenario-grid">
            ...
            <div className="vakbn-scenario-card bear">
              ...
              <ul>
                <li>31.60 TL günlük dip altında kapanış</li>
