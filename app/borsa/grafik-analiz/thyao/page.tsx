...
export const metadata: Metadata = {
  title: "THYAO Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Türk Hava Yolları (THYAO) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/thyao",
  },
};
...
export default function ThyaoGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="thyao" tarih="2026-06-07" />
