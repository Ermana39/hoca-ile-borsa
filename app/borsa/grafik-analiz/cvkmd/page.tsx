...
export const metadata: Metadata = {
  title: "CVKMD Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "CVK Maden (CVKMD) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/cvkmd",
  },
};
...
export default function CvkmdGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="cvkmd" tarih="2026-06-08" />
          ...
          <div className="cvkmd-chart-wrap">
            ...
            <div className="cvkmd-chart-img-wrap">
              <img
                ...
                alt="CVKMD Teknik Analiz Grafiği — Bollinger Bantları, Hareketli Ortalamalar, Stochastic, MACD, RSI — 08.06.2026"
                loading="lazy"
              />
