...
export const metadata: Metadata = {
  title: "SOKM Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
...
export default function SokmGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="sokm" tarih="2026-06-07" />
      ...
      <div className="sokm-wrap">
        ...
        <main className="sokm-main">
          ...
          <div className="sokm-narrative">
            ...
            <p>47.82 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>49.90–46.11 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="sokm-scenario-grid">
            ...
            <div className="sokm-scenario-card bear">
              ...
              <ul>
                <li>47.82 TL günlük dip altında kapanış</li>
