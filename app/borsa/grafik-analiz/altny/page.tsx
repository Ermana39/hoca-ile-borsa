...
export default function AltnyGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>ALTNY Teknik Analiz — 08.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Altınay Savunma (ALTNY) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/altny" />
