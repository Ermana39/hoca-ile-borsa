...
export const metadata: Metadata = {
  title: "TTKOM Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Türk Telekom (TTKOM) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/ttkom",
  },
};
...
export default function TtkomGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="ttkom" tarih="2026-06-07" />
