...
export default function TuprsGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>TUPRS Teknik Analiz — 05.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Tüpraş (TUPRS) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/tuprs" />
      ...
      <div className="tuprs-wrap">
        ...
        <main className="tuprs-main">
          ...
          <div className="tuprs-narrative">
            ...
            <p>188.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>206.49–228.28 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
