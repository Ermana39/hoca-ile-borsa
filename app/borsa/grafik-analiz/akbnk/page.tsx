...
export default function AkbnkGrafikAnaliz() {
 ...
 &nbsp;·&nbsp; 05 Haziran 2026
        ...
        <main className="aefes-main">
          ...
          {hisse && (
            <>
              <div className="aefes-section-title"><span className="aefes-section-num">07</span> Şirket Profili &amp; Temel Görünüm</div>
              ...
              <div className="aefes-narrative" style={{ borderLeftColor: "var(--gold)" }}>
                ...
                <p style={{ marginTop: ".4rem", fontSize: ".82rem", color: "var(--text-dim)" }}>
                  ...
                  <Link href="/hisse/akbnk" prefetch={false} style={{ color: "var(--accent)", textDecoration: "underline" }}>
