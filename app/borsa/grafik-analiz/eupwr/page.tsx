...
export const metadata: Metadata = {
  title: "EUPWR Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Europower Enerji (EUPWR) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/eupwr",
  },
};
...
export default function EupwrGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="eupwr" tarih="2026-06-08" />
          ...
          <div className="eupwr-chart-wrap">
            ...
            <div className="eupwr-chart-img-wrap">
              <img
                ...
                alt="EUPWR Teknik Analiz Grafiği — Bollinger Bantları, Hareketli Ortalamalar, Stochastic, MACD, RSI — 08.06.2026"
                loading="lazy"
              />
