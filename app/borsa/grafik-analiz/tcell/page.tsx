...
export const metadata: Metadata = {
  title: "TCELL Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Turkcell (TCELL) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/tcell",
  },
};
...
export default function TcellGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="tcell" tarih="2026-06-07" />
      ...
      <div className="tcell-wrap">
        ...
        <main className="tcell-main">
          ...
          <div className="tcell-narrative">
            ...
            <p>104.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>104.02–98.76 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="tcell-scenario-grid">
            ...
            <div className="tcell-scenario-card bear">
              ...
              <ul>
                <li>104.60 TL günlük dip altında kapanış</li>
