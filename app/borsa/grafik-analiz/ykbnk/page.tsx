...
export const metadata: Metadata = {
  title: "YKBNK Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Yapı Kredi Bankası (YKBNK) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/ykbnk",
  },
};
...
export default function YkbnkGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="ykbnk" tarih="2026-06-07" />
      ...
      <div className="ykbnk-wrap">
        ...
        <main className="ykbnk-main">
          ...
          <div className="ykbnk-narrative">
            ...
            <p>33.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>34.85–31.34 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="ykbnk-scenario-grid">
            ...
            <div className="ykbnk-scenario-card bear">
              ...
              <ul>
                <li>33.60 TL günlük dip altında kapanış</li>
