...
export default function TavhlGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>TAVHL Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="TAV Havalimanları (TAVHL) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/tavhl" />
      ...
      <div className="tavhl-wrap">
        ...
        <footer style={{ background: "var(--bg)", borderTop: "1px solid var(--border)" }}>
          <div className="tavhl-footer">
            <div className="tavhl-footer-inner">
              <div className="tavhl-footer-brand">HOCA İLE BORSA</div>
              <div className="tavhl-footer-meta">
                TAVHL Teknik Analiz Raporu<br />
                Hazırlanma: 07.06.2026 &nbsp;·&nbsp; Veri: BIST / IQ Platform
              </div>
            </div>
            <div className="tavhl-footer-legal">
