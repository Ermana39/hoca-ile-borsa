...
export const metadata: Metadata = {
  title: "SAHOL Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Sabancı Holding (SAHOL) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/sahol",
  },
};
...
export default function SaholGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="sahol" tarih="2026-06-07" />
