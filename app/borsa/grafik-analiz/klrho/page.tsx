...
export default function KlrhoGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>KLRHO Teknik Analiz — 10.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Kiler Holding (KLRHO) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/klrho" />
      ...
      <div className="klrho-wrap">
        ...
        <footer style={{ background:"var(--bg)", borderTop:"1px solid var(--border)" }}>
          <div className="klrho-footer">
            <div className="klrho-footer-inner">
              <div className="klrho-footer-brand">HOCA İLE BORSA</div>
              <div className="klrho-footer-meta">
                KLRHO Teknik Analiz Raporu<br />
                Hazırlanma: 10.06.2026 &nbsp;·&nbsp; Veri: BIST / IQ Platform
              </div>
            </div>
            <div className="klrho-footer-legal">
