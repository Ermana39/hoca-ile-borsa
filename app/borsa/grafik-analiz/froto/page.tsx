...
export const metadata: Metadata = {
  title: "FROTO Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Ford Otosan (FROTO) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic indikatörleri ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/froto",
  },
};
...
export default function FrotoGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="froto" tarih="2026-06-07" />
