...
export const metadata: Metadata = {
  title: "ENKAI Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Enka İnşaat (ENKAI) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic indikatörleri ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/enkai",
  },
};
...
export default function EnkaiGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="enkai" tarih="2026-06-07" />
