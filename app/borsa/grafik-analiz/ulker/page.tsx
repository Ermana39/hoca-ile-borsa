...
export default function UlkerGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>ULKER Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Ülker (ULKER) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/ulker" />
      ...
      <div className="ulker-wrap">
        ...
        <main className="ulker-main">
          ...
          <div className="ulker-narrative">
            ...
            <p>188.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>116.96–109.56 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
