...
export default function ToasoGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>TOASO Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Tofaş Otomotiv (TOASO) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/toaso" />
      ...
      <div className="toaso-wrap">
        ...
        <main className="toaso-main">
          ...
          <div className="toaso-narrative">
            ...
            <p>188.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>258.53–282.13 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
