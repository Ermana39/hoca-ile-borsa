...
export default function QubrfGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>QUBRF Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Gübre Fabrikaları (QUBRF) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/qubrf" />
      ...
      <div className="qubrf-wrap">
        ...
        <footer style={{ background: "var(--bg)", borderTop: "1px solid var(--border)" }}>
          <div className="qubrf-footer">
            <div className="qubrf-footer-inner">
              <div className="qubrf-footer-brand">HOCA İLE BORSA</div>
              <div className="qubrf-footer-meta">
                QUBRF Teknik Analiz Raporu<br />
                Hazırlanma: 07.06.2026 &nbsp;·&nbsp; Veri: BIST / IQ Platform
              </div>
            </div>
            <div className="qubrf-footer-legal">
