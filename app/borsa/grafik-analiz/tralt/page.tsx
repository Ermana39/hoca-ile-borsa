...
export const metadata: Metadata = {
  title: "TRALT Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "TRALT günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/tralt",
  },
};
...
export default function TraltGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="tralt" tarih="2026-06-07" />
      ...
      <div className="tralt-wrap">
        ...
        <main className="tralt-main">
          ...
          <div className="tralt-narrative">
            ...
            <p>44.89 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>39.68–40.65 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="tralt-scenario-grid">
            ...
            <div className="tralt-scenario-card bear">
              ...
              <ul>
                <li>44.89 TL günlük dip altında kapanış</li>
