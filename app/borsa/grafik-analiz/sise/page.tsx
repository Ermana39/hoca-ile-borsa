...
export default function SiseGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>SISE Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Şişecam (SISE) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/sise" />
      ...
      <div className="sise-wrap">
        ...
        <main className="sise-main">
          ...
          <div className="sise-narrative">
            ...
            <p>188.60 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>41.79–42.35 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
        ...
        <footer style={{ background: "var(--bg)", borderTop: "1px solid var(--border)" }}>
          <div className="sise-footer">
            <div className="sise-footer-inner">
              <div className="sise-footer-brand">HOCA İLE BORSA</div>
              <div className="sise-footer-meta">
                SISE Teknik Analiz Raporu<br />
                Hazırlanma: 07.06.2026 &nbsp;·&nbsp; Veri: BIST / IQ Platform
              </div>
            </div>
            <div className="sise-footer-legal">
