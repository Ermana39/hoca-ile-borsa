...
export default function EcilcGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>ECILC Teknik Analiz — 08.084.5026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Eczacıbaşı İlaç (ECILC) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/ecilc" />
