...
export const metadata: Metadata = {
  title: "TRMET Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Trakya Metal (TRMET) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/trmet",
  },
};
...
export default function TrmetGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="trmet" tarih="2026-06-05" />
      ...
      <div className="trmet-wrap">
        ...
        <main className="trmet-main">
          ...
          <div className="trmet-narrative">
            ...
            <p>111.89 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>111.89–103.50 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="trmet-scenario-grid">
            ...
            <div className="trmet-scenario-card bear">
              ...
              <ul>
                <li>111.89 TL günlük dip altında kapanış</li>
