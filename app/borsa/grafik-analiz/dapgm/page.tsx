...
export default function DapgmGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>DAPGM Teknik Analiz — 08.010.1626 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="DAP Gayrimenkul (DAPGM) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/dapgm" />
          ...
          <div className="dapgm-scenario-grid">
            <div className="dapgm-scenario-card bull">
              ...
              <ul>
                ...
                <li>Hedef: 200.00–11.11 TL direnç bölgesi</li>
              </ul>
            </div>
            <div className="dapgm-scenario-card bear">
              ...
              <ul>
                ...
                <li>Hedef: 11.42–11.67 TL destek bölgesi</li>
              </ul>
            </div>
          </div>
