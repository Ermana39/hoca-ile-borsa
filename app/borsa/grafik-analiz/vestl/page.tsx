...
export const metadata: Metadata = {
  title: "VESTL Teknik Analiz, Grafik ve Hisse Yorumu",
  description:
    "Vestel (VESTL) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme.",
  alternates: {
    canonical: "https://www.hocaileborsa.com/borsa/grafik-analiz/vestl",
  },
};
...
export default function VestlGrafikAnaliz() {
  return (
    <>
      ...
      <GrafikAnalizJsonLd kod="vestl" tarih="2026-06-07" />
      ...
      <div className="vestl-wrap">
        ...
        <main className="vestl-main">
          ...
          <div className="vestl-narrative">
            ...
            <p>25.50 TL altı kapanışlarda satış baskısı yeniden artabilir. Bu durumda <strong>33.80–24.74 TL</strong> destek bölgesi takip edilmelidir.</p>
          </div>
          ...
          <div className="vestl-scenario-grid">
            ...
            <div className="vestl-scenario-card bear">
              ...
              <ul>
                <li>25.50 TL günlük dip altında kapanış</li>
