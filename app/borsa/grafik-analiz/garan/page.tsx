...
export default function GaranGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>GARAN Teknik Analiz — 07.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Garanti BBVA (GARAN) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/garan" />
      ...
      <div className="garan-wrap">
        ...
        <footer style={{ background: "var(--bg)", borderTop: "1px solid var(--border)" }}>
          <div className="garan-footer">
            <div className="garan-footer-inner">
              <div className="garan-footer-brand">HOCA İLE BORSA</div>
              <div className="garan-footer-meta">
                GARAN Teknik Analiz Raporu<br />
                Hazırlanma: 07.06.2026 &nbsp;·&nbsp; Veri: BIST / IQ Platform
              </div>
            </div>
            <div className="garan-footer-legal">
