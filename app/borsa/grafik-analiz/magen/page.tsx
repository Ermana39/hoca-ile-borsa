...
export default function MagenGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>MAGEN Teknik Analiz — 10.06.2026 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Magen Holding (MAGEN) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/magen" />
