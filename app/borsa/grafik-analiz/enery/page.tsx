...
export default function EneryGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>ENERY Teknik Analiz — 08.08.7926 | Hoca İle Borsa</title>
        <meta
          name="description"
          content="Enerya Enerji (ENERY) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic ve hareketli ortalamalar ile detaylı değerlendirme."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/enery" />
          ...
          <div className="enery-scenario-grid">
            <div className="enery-scenario-card bull">
              ...
              <ul>
                ...
                <li>Hedef: 200.00–9.15 TL direnç bölgesi</li>
              </ul>
            </div>
