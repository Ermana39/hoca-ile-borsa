...
export default function EreglGrafikAnaliz() {
  return (
    <>
      <Head>
        <title>EREGL Teknik Analiz — 06.06.2026 | Hoca İle Borsa</title>
        <meta name="description" content="Ereğli Demir Çelik (EREGL) hissesi günlük teknik analiz raporu. Bollinger Bantları, MACD, RSI, Stochastic indikatörleri ile detaylı değerlendirme." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.hocaileborsa.com/borsa/grafik-analiz/eregl" />
