...
const haziranTemettuleri = [
  { sembol: "ZRGYO", tarih: "30 Haziran 2026", verim: "% 0,43", brut: "₺0,09", net: "₺0,0929", toplam: "₺436.271.510", oran: "%6" },
  { sembol: "KIMMR", tarih: "30 Haziran 2026", verim: "% 1,27", brut: "₺0,21", net: "₺0,1771", toplam: "₺49.999.992", oran: "%8" },
  { sembol: "ECGYH", tarih: "30 Haziran 2026", verim: "% 0,98", brut: "₺0,30", net: "₺0,3000", toplam: "₺60.000.000", oran: "%8" },
  { sembol: "LOGO", tarih: "30 Haziran 2026", verim: "% 3,73", brut: "₺5,26", net: "₺4,4737", toplam: "₺499.999.991", oran: "%33" },
  ...
  { sembol: "PAGYO", tarih: "24 Haziran 2026", verim: "% 4,48", brut: "₺5,75", net: "₺5,7545", toplam: "₺500.641.500", oran: "%32" },
  { sembol: "VKGYO", tarih: "24 Haziran 2026", verim: "% 3,71", brut: "₺0,10", net: "₺0,1020", toplam: "₺351.999.705", oran: "%50" },
  { sembol: "AVPGY", tarih: "24 Haziran 2026", verim: "% 4,22", brut: "₺2,50", net: "₺2,5000", toplam: "₺1.000.000.000", oran: "%62" },
  { sembol: "CEMTS", tarih: "24 Haziran 2026", verim: "% 2,75", brut: "₺0,30", net: "₺0,2550", toplam: "₺150.000.000", oran: "" },
  { sembol: "EKGYO", tarih: "24 Haziran 2026", verim: "% 2,97", brut: "₺0,60", net: "₺0,6000", toplam: "₺2.280.000.000", oran: "%37" },
  { sembol: "KTLEV", tarih: "23 Haziran 2026", verim: "% 0,09", brut: "₺0,10", net: "₺0,0821", toplam: "₺199.999.881", oran: "%2" },
  { sembol: "EMPAE", tarih: "18 Haziran 2026", verim: "% 0,26", brut: "₺0,10", net: "₺0,0850", toplam: "₺17.000.000", oran: "%20" },
  { sembol: "BIMAS", tarih: "17 Haziran 2026", verim: "% 0,55", brut: "₺4,00", net: "₺3,4000", toplam: "₺2.400.000.000", oran: "%13" },
  { sembol: "BULGS", tarih: "15 Haziran 2026", verim: "% 0,21", brut: "₺0,09", net: "₺0,0933", toplam: "₺24.999.978", oran: "%2" },
  { sembol: "INDES", tarih: "15 Haziran 2026", verim: "% 2,11", brut: "₺0,22", net: "₺0,1847", toplam: "₺163.000.875", oran: "%34" },
  { sembol: "ATATP", tarih: "10 Haziran 2026", verim: "% 0,69", brut: "₺1,00", net: "₺0,8500", toplam: "₺93.750.000", oran: "%5" },
  { sembol: "YAPRK", tarih: "10 Haziran 2026", verim: "% 0,18", brut: "₺0,03", net: "₺0,0213", toplam: "₺7.455.000", oran: "%38" },
  { sembol: "AVPGY", tarih: "3 Haziran 2026", verim: "% 4,22", brut: "₺2,50", net: "₺2,5000", toplam: "₺1.000.000.000", oran: "%62" },
  { sembol: "AKCNS", tarih: "1 Haziran 2026", verim: "% 0,89", brut: "₺1,88", net: "₺1,5984", toplam: "₺359.999.996", oran: "%46" },
  { sembol: "SISE", tarih: "1 Haziran 2026", verim: "% 1,28", brut: "₺0,59", net: "₺0,4995", toplam: "₺1.799.999.717", oran: "%19" },
  { sembol: "AYES", tarih: "1 Haziran 2026", verim: "% 1,18", brut: "₺0,35", net: "₺0,3000", toplam: "₺52.941.165", oran: "%52" },
  { sembol: "MACKO", tarih: "1 Haziran 2026", verim: "% 6,55", brut: "₺2,70", net: "₺2,2950", toplam: "₺270.000.000", oran: "%84" },
];
