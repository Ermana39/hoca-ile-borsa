...
export default function TemettuHesaplamaClient() {
    ...
    <main className="min-h-screen bg-white px-4 py-6 md:px-6">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mb-6 text-sm leading-7 text-zinc-600">
          Elinizdeki lot adedi, şirketin açıkladığı lot başına brüt temettü tutarı ve stopaj oranına
          göre toplam net temettü gelirinizi ve kesinti tutarını anında hesaplayın.
        </p>
        ...
        <section className="mt-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-5 md:p-6">
          ...
          <p className="mb-3 text-sm leading-7 text-zinc-600">
            Temettü hesaplama işlemi için şirkete ait lot başına brüt temettü tutarını ve
            elinizde kaç lot hisse bulundurduğunuzu girmeniz yeterlidir. Türkiye&apos;de bireysel
            yatırımcılar için stopaj oranı genellikle %15 olup bu oran varsayılan olarak
            yüklenmiştir. Hesaplama sonucunda toplam brüt temettü, stopaj kesintisi ve elde
            edeceğiniz net temettü tutarı gösterilir.
          </p>
          <p className="text-sm leading-7 text-zinc-600">
            Lot başına brüt temettü tutarı şirketin Kamuyu Aydınlatma Platformu (KAP) üzerinden
            yapılan resmi temettü duyurularında yer alır. Kurumsal yatırımcılar ve yabancı
            yatırımcılar için farklı stopaj oranları geçerli olabilir.
          </p>
        </section>
        ...
        <section className="mt-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-5 md:p-6">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="mb-1 text-sm font-bold text-zinc-800">Temettü stopaj oranı ne kadardır?</h3>
              <p className="text-sm leading-6 text-zinc-600">
                Türkiye&apos;de bireysel yatırımcılar için temettü stopaj oranı %15&apos;tir. Bu oran brüt temettü
                tutarı üzerinden kesilerek net temettü ödenir.
              </p>
            </div>
            <div>
              <h3 className="mb-1 text-sm font-bold text-zinc-800">Lot başına brüt temettüyü nereden öğrenebilirim?</h3>
              <p className="text-sm leading-6 text-zinc-600">
                Şirketler temettü kararlarını KAP (kamuoyu.com.tr) üzerinden duyurur. İlgili şirketin
                temettü bildiriminde hisse başına veya lot başına brüt temettü tutarı yer alır.
              </p>
            </div>
            <div>
              <h3 className="mb-1 text-sm font-bold text-zinc-800">Temettü ne zaman hesaba geçer?</h3>
              <p className="text-sm leading-6 text-zinc-600">
                Temettü dağıtım tarihinde (ex-date) sahip olunan hisseler üzerinden hesaplama yapılır.
                Ödeme tarihi ise genellikle dağıtım tarihinden birkaç iş günü sonrasıdır.
              </p>
            </div>
          </div>
        </section>
        <HesaplayiciRehberi slug="temettu" />
      </div>
    </main>
  );
}
