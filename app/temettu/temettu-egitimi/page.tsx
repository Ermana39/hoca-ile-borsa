      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mb-8">
          ...
          <p className="text-base leading-7 text-zinc-700">
            Temettü eğitimi sayfasında, temettü yatırımında en çok merak edilen
            temel kavramları daha sade ve anlaşılır şekilde inceleyebilirsiniz.
            Temettü nedir, brüt ve net temettü farkı nasıl oluşur, hak kullanım
            tarihi ne anlama gelir, ödeme tarihi neden önemlidir, temettü verimi
            nasıl hesaplanır ve temettü sonrası hisse fiyatı neden düşer gibi
            konular bu bölümde adım adım ele alınır.
          </p>
        </section>
