export const metadata = {
  title: "Aralık Ayı Temettü Takvimi | Hoca İle Borsa",
  description: "Aralık ayında temettü veren BIST şirketleri, ödeme tarihleri ve temettü miktarları.",
...
const aralikTemettuleri = getTemettulerByAy(2026, 12);

export default function AralikAyiTemettuTakvimiPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="overflow-x-auto rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
          <table className="min-w-full overflow-hidden rounded-xl border border-zinc-200 bg-white text-sm">
            ...
            <tbody>
              {aralikTemettuleri.map((item, index) => (
                <tr
        ...
        <section className="mt-12 rounded-2xl border border-zinc-200 bg-white p-6">
          <h2 className="mb-4 text-2xl font-bold text-zinc-900">
            Aralık Ayı Temettü Takvimi Hakkında
          </h2>

          <p className="mb-4 leading-7 text-zinc-700">
            Aralık ayı temettü takvimi sayfası, Borsa İstanbul’da işlem gören şirketlerin
            Aralık 2026 dönemindeki temettü dağıtım tarihlerini, hisse başına brüt ve net
          ...
          <p className="mb-4 leading-7 text-zinc-700">
            Sayfada yer alan Aralık 2026 temettü takvimi verileri sayesinde hangi şirketin hangi
          ...
          <p className="leading-7 text-zinc-700">
            Güncel Aralık ayı temettü takvimi, BIST temettü veren hisseler, hisse başı brüt ve
