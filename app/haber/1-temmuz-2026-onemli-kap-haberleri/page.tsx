...
export const metadata: Metadata = {
  ...
  description:
    seoAciklamasi("BYDNR %615 bedelsiz sermaye artırımı, SASA satış performansı, EKGYO ihale sonucu ve 1 Temmuz KAP haberlerinde olası etkiler.", "Haberde gelişmenin ayrıntıları, açıklanan veriler ve yatırımcıların izleyebileceği temel noktalar yer alıyor."),
  alternates: {
    canonical:
