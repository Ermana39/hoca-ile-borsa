...
export const metadata: Metadata = {
  ...
  description:
    "SPK, Orzaks İlaç ve Kimya Sanayi Ticaret AŞ halka arzına onay verdi. Halka arz fiyatı 69,00 TL olurken toplam 52,5 milyon lot satışa sunulacak.",
  alternates: {
    canonical:
      "https://www.hocaileborsa.com/haber/orzaks-ilac-halka-arzina-spk-onayi-geldi",
  },
  openGraph: {
    title: "Orzaks İlaç Halka Arzına SPK Onayı Geldi",
    description:
      "Orzaks İlaç halka arzı SPK’dan onay aldı. Halka arz fiyatı, sermaye artırımı, ortak satışı ve izahname detayları haberimizde.",
    url: "https://www.hocaileborsa.com/haber/orzaks-ilac-halka-arzina-spk-onayi-geldi",
    siteName: "Hoca ile Borsa",
    type: "article",
    images: [
      {
        url: "https://www.hocaileborsa.com/orzaks-ilac-halka-arzina-spk-onayi-geldi.webp",
        width: 1200,
        height: 675,
  ...
  twitter: {
    ...
    title: "Orzaks İlaç Halka Arzına SPK Onayı Geldi",
    description:
      "SPK, Orzaks İlaç halka arzına onay verdi. Halka arz fiyatı 69,00 TL olarak açıklandı.",
    images: [
      "https://www.hocaileborsa.com/orzaks-ilac-halka-arzina-spk-onayi-geldi.webp",
    ],
  },
};
...
const jsonLd = {
  ...
  "@type": "NewsArticle",
  headline: "Orzaks İlaç Halka Arzına SPK Onayı Geldi",
  description:
    "SPK, Orzaks İlaç ve Kimya Sanayi Ticaret AŞ halka arzına onay verdi. Halka arz fiyatı 69,00 TL olurken toplam 52,5 milyon lot satışa sunulacak.",
  ...
  image: "https://www.hocaileborsa.com/orzaks-ilac-halka-arzina-spk-onayi-geldi.webp",
};
      ...
      <article className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Orzaks İlaç Halka Arzına SPK Onayı Geldi
          </h1>

          <p className="mt-4 text-lg leading-8 text-slate-700">
            Sermaye Piyasası Kurulu, Orzaks İlaç ve Kimya Sanayi Ticaret AŞ’nin
            halka arz başvurusuna onay verdi. Halka arz fiyatı 69,00 TL olarak
        ...
        <div className="mb-8 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
          <Image
            src="/orzaks-ilac-halka-arzina-spk-onayi-geldi.webp"
            alt="Orzaks İlaç halka arzına SPK onayı geldi"
            width={1200}
            height={675}
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-7">
          ...
          <p className="mt-4 leading-8 text-slate-700">
            SPK’nın yayımladığı bültende Orzaks İlaç ve Kimya Sanayi Ticaret
            AŞ’nin halka arzına onay verildi. Şirket payları 1 TL nominal
            değerli pay için 69,00 TL sabit fiyat üzerinden satışa sunulacak.
          </p>
            ...
            <table className="w-full min-w-[720px] border-collapse text-left text-sm">
              ...
              <tbody className="text-slate-700">
                ...
                <tr>
                  ...
                  <td className="border border-slate-200 px-3 py-3">
                    31.500.000 TL nominal değerli pay
                  </td>
                </tr>
                <tr>
                  <td className="border border-slate-200 px-3 py-3 font-medium text-slate-900">
                  ...
                  <td className="border border-slate-200 px-3 py-3">
                    21.000.000 TL nominal değerli pay
                  </td>
                </tr>
                <tr>
                  <td className="border border-slate-200 px-3 py-3 font-medium text-slate-900">
        ...
        <section className="mt-8 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-7">
          ...
          <p className="mt-4 leading-8 text-slate-700">
            Orzaks İlaç halka arzında sermaye artırımı ve mevcut pay satışı
        ...
        <section className="mt-8 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-7">
          ...
          <p className="mt-4 leading-8 text-slate-700">
            Orzaks İlaç ve Kimya Sanayi Ticaret AŞ, sağlık, ilaç, takviye edici
            gıda ve kimya alanlarına yakın ürün gruplarıyla halka arz sürecine
            giren şirketlerden biri oldu. Bu alanlarda faaliyet gösteren
            şirketler; üretim kapasitesi, marka bilinirliği, dağıtım kanalları,
            ihracat potansiyeli ve regülasyonlara uyum gibi başlıklarla
            yakından takip edilir.
          </p>

          <p className="mt-4 leading-8 text-slate-700">
            Bu nedenle yatırımcıların şirketi değerlendirirken yalnızca halka
            arz fiyatına değil; faaliyet modeli, satış kanalları, kârlılık
          ...
          <div className="mt-5 rounded-xl bg-blue-50 p-4 ring-1 ring-blue-100">
            <p className="leading-7 text-blue-950">
              Orzaks İlaç’ın onaylı izahname detaylarını incelemek için
            ...
            >
              Orzaks İlaç onaylı izahname sayfası
            </Link>
          </div>
        </section>
        ...
        <section className="mt-8 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-7">
          ...
          <p className="mt-4 leading-8 text-slate-700">
            Orzaks İlaç halka arzında fiyat 69,00 TL olarak açıklanırken,
            toplam satışa konu pay miktarı sermaye artırımı ve mevcut pay satışı
            toplamında 52.500.000 lot seviyesinde bulunuyor. Bu yapı,
        ...
        <section className="mt-8 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-7">
          ...
          <p className="mt-4 leading-8 text-slate-700">
            SPK onayının ardından Orzaks İlaç için talep toplama tarihleri,
