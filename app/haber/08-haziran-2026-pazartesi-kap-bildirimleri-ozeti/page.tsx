            ...
            <div className="mt-6 space-y-6 text-base leading-8 text-slate-700 md:text-lg">
              ...
              <div className="rounded-xl border border-blue-100 bg-blue-50 p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Link href="/borsa/dikkat-cekenler/dstkf-empae-zergy-vbts-tedbiri" prefetch={false} className="inline-flex items-center gap-1 rounded-full border border-blue-200 bg-white px-3 py-1.5 text-xs font-semibold text-blue-700 hover:bg-blue-50">DSTKF VBTS Tedbiri <span aria-hidden>→</span></Link>
