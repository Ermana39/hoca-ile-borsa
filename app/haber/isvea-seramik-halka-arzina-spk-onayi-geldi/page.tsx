...
const jsonLd = {
  ...
  "@type": "NewsArticle",
  headline: "İsvea Seramik Halka Arzına SPK Onayı Geldi",
  description:
    "SPK, İsvea Seramik ve Banyo Ürünleri Sanayi AŞ halka arzına onay verdi. Halka arz fiyatı 20,90 TL olurken toplam 67 milyon lot satışa sunulacak.",
  ...
  image: "https://www.hocaileborsa.com/isvea-seramik-halka-arzina-spk-onayi-geldi.webp",
};
          ...
          >
            ...
            <span className="mt-2 block text-sm font-semibold text-blue-600">
              Onaylı izahname sayfasını incele
                ...
                <HaberAltKisim href="/haber/isvea-seramik-halka-arzina-spk-onayi-geldi" />
</article>
    </main>
  );
}