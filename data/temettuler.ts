...
export const temettuler: TemettuKaydi[] = [
  ...
  // --- AĞUSTOS 2026 ---
  { sembol: "SUWEN", tarih: "31 Ağustos 2026", isoTarih: "2026-08-31", verim: "% 2,73", brut: "₺0,18", net: "₺0,1518", toplam: "₺99.999.984", oran: "%93" },
  { sembol: "TURSG", tarih: "27 Ağustos 2026", isoTarih: "2026-08-27", verim: "% 2,44", brut: "₺0,15", net: "₺0,1275", toplam: "₺3.000.000.000", oran: "%16" },
  { sembol: "ENERY", tarih: "25 Ağustos 2026", isoTarih: "2026-08-25", verim: "% 0,18", brut: "₺0,02", net: "₺0,0142", toplam: "₺149.999.400", oran: "%3" },
  { sembol: "AHGAZ", tarih: "24 Ağustos 2026", isoTarih: "2026-08-24", verim: "% 0,17", brut: "₺0,06", net: "₺0,0490", toplam: "₺149.999.980", oran: "%5" },
  { sembol: "DOAS", tarih: "13 Ağustos 2026", isoTarih: "2026-08-13", verim: "% 8,16", brut: "₺15,00", net: "₺12,7500", toplam: "₺3.300.000.000", oran: "%56" },
  { sembol: "GOKNR", tarih: "10 Ağustos 2026", isoTarih: "2026-08-10", verim: "% 1,33", brut: "₺0,31", net: "₺0,2603", toplam: "₺107.202.480", oran: "%24" },
  { sembol: "BOBET", tarih: "5 Ağustos 2026", isoTarih: "2026-08-05", verim: "% 2,11", brut: "₺0,40", net: "₺0,3400", toplam: "₺152.000.000", oran: "" },

  // --- EYLÜL 2026 ---
  { sembol: "KIMMR", tarih: "30 Eylül 2026", isoTarih: "2026-09-30", verim: "% 1,38", brut: "₺0,21", net: "₺0,1771", toplam: "₺49.999.992", oran: "%8" },
  { sembol: "DESA", tarih: "30 Eylül 2026", isoTarih: "2026-09-30", verim: "% 0,80", brut: "₺0,08", net: "₺0,0714", toplam: "₺41.176.464", oran: "%7" },
  { sembol: "TUPRS", tarih: "30 Eylül 2026", isoTarih: "2026-09-30", verim: "% 2,59", brut: "₺6,75", net: "₺5,7349", toplam: "₺13.001.761.617", oran: "%42" },
  { sembol: "LKMNH", tarih: "28 Eylül 2026", isoTarih: "2026-09-28", verim: "% 1,60", brut: "₺0,23", net: "₺0,1968", toplam: "₺49.999.982", oran: "%34" },
  { sembol: "MOPAS", tarih: "25 Eylül 2026", isoTarih: "2026-09-25", verim: "% 0,87", brut: "₺0,27", net: "₺0,2335", toplam: "₺74.999.989", oran: "%40" },
  { sembol: "OFSYM", tarih: "23 Eylül 2026", isoTarih: "2026-09-23", verim: "% 0,74", brut: "₺0,42", net: "₺0,3577", toplam: "₺61.542.848", oran: "%14" },
  { sembol: "GIPTA", tarih: "22 Eylül 2026", isoTarih: "2026-09-22", verim: "% 0,01", brut: "₺0,01", net: "₺0,0066", toplam: "₺1.024.993", oran: "%0" },
  { sembol: "TAVHL", tarih: "22 Eylül 2026", isoTarih: "2026-09-22", verim: "% 0,68", brut: "₺1,80", net: "₺1,5342", toplam: "₺655.718.977", oran: "%23" },
  { sembol: "MACKO", tarih: "22 Eylül 2026", isoTarih: "2026-09-22", verim: "% 5,40", brut: "₺1,80", net: "₺1,5300", toplam: "₺180.000.000", oran: "%58" },
  { sembol: "PETUN", tarih: "21 Eylül 2026", isoTarih: "2026-09-21", verim: "% 2,15", brut: "₺0,25", net: "₺0,2083", toplam: "₺74.319.525", oran: "%43" },
  { sembol: "BIGCH", tarih: "18 Eylül 2026", isoTarih: "2026-09-18", verim: "% 1,53", brut: "₺0,10", net: "₺0,0850", toplam: "₺53.500.000", oran: "%2397" },
  { sembol: "BIMAS", tarih: "16 Eylül 2026", isoTarih: "2026-09-16", verim: "% 0,67", brut: "₺2,50", net: "₺2,1250", toplam: "₺3.000.000.000", oran: "%16" },
  { sembol: "BULGS", tarih: "15 Eylül 2026", isoTarih: "2026-09-15", verim: "% 0,25", brut: "₺0,09", net: "₺0,0933", toplam: "₺24.999.978", oran: "%2" },
  { sembol: "LIDER", tarih: "8 Eylül 2026", isoTarih: "2026-09-08", verim: "% 0,04", brut: "₺0,04", net: "₺0,0303", toplam: "₺29.411.745", oran: "%2" },
  { sembol: "BRKSN", tarih: "4 Eylül 2026", isoTarih: "2026-09-04", verim: "% 0,74", brut: "₺0,06", net: "₺0,0500", toplam: "₺5.505.888", oran: "%28" },

  // --- EKİM 2026 ---
  { sembol: "DESA", tarih: "30 Ekim 2026", isoTarih: "2026-10-30", verim: "% 0,92", brut: "₺0,10", net: "₺0,0816", toplam: "₺47.058.816", oran: "%8" },
  { sembol: "SRVGY", tarih: "26 Ekim 2026", isoTarih: "2026-10-26", verim: "% 2,88", brut: "₺0,08", net: "₺0,0769", toplam: "₺249.999.750", oran: "%6" },
  { sembol: "OSMEN", tarih: "26 Ekim 2026", isoTarih: "2026-10-26", verim: "% 0,55", brut: "₺0,05", net: "₺0,0424", toplam: "₺19.999.992", oran: "%12" },
  { sembol: "BASCM", tarih: "21 Ekim 2026", isoTarih: "2026-10-21", verim: "% 7,32", brut: "₺1,06", net: "₺0,9015", toplam: "₺699.999.960", oran: "%198" },
  { sembol: "EBEBK", tarih: "15 Ekim 2026", isoTarih: "2026-10-15", verim: "% 0,83", brut: "₺0,63", net: "₺0,5313", toplam: "₺100.000.000", oran: "%100" },
  { sembol: "ASTOR", tarih: "15 Ekim 2026", isoTarih: "2026-10-15", verim: "% 0,70", brut: "₺2,19", net: "₺1,8625", toplam: "₺21.867.648.058", oran: "%3" },
  { sembol: "AEFES", tarih: "5 Ekim 2026", isoTarih: "2026-10-05", verim: "% 0,83", brut: "₺0,17", net: "₺0,1443", toplam: "₺1.005.098.684", oran: "%6" },

  // --- KASIM 2026 ---
  { sembol: "DESA", tarih: "30 Kasım 2026", isoTarih: "2026-11-30", verim: "% 0,92", brut: "₺0,10", net: "₺0,0816", toplam: "₺47.058.816", oran: "%8" },
  { sembol: "OFSYM", tarih: "25 Kasım 2026", isoTarih: "2026-11-25", verim: "% 0,74", brut: "₺0,42", net: "₺0,3577", toplam: "₺61.542.848", oran: "%14" },
  { sembol: "ASELS", tarih: "24 Kasım 2026", isoTarih: "2026-11-24", verim: "% 0,11", brut: "₺0,43", net: "₺0,3635", toplam: "₺1.949.999.640", oran: "%7" },
  { sembol: "DURKN", tarih: "18 Kasım 2026", isoTarih: "2026-11-18", verim: "% 0,44", brut: "₺0,09", net: "₺0,0792", toplam: "₺12.342.958", oran: "%10" },
  { sembol: "GIPTA", tarih: "11 Kasım 2026", isoTarih: "2026-11-11", verim: "% 0,01", brut: "₺0,01", net: "₺0,0066", toplam: "₺1.024.993", oran: "%0" },
  { sembol: "KOBRL", tarih: "10 Kasım 2026", isoTarih: "2026-11-10", verim: "% 0,08", brut: "₺0,02", net: "₺0,0177", toplam: "₺12.490.800", oran: "%2" },
  { sembol: "GOKNR", tarih: "9 Kasım 2026", isoTarih: "2026-11-09", verim: "% 1,33", brut: "₺0,31", net: "₺0,2603", toplam: "₺107.202.480", oran: "%24" },
  { sembol: "LIDER", tarih: "6 Kasım 2026", isoTarih: "2026-11-06", verim: "% 0,04", brut: "₺0,04", net: "₺0,0303", toplam: "₺29.411.745", oran: "%2" },

  // --- ARALIK 2026 ---
  { sembol: "GLYHO", tarih: "31 Aralık 2026", isoTarih: "2026-12-31", verim: "% 0,58", brut: "₺0,10", net: "₺0,0872", toplam: "₺199.999.995", oran: "%4" },
  { sembol: "SRVGY", tarih: "25 Aralık 2026", isoTarih: "2026-12-25", verim: "% 2,88", brut: "₺0,08", net: "₺0,0769", toplam: "₺249.999.750", oran: "%6" },
  { sembol: "BIMAS", tarih: "16 Aralık 2026", isoTarih: "2026-12-16", verim: "% 0,67", brut: "₺2,50", net: "₺2,1250", toplam: "₺3.000.000.000", oran: "%16" },
  { sembol: "EBEBK", tarih: "15 Aralık 2026", isoTarih: "2026-12-15", verim: "% 0,83", brut: "₺0,63", net: "₺0,5313", toplam: "₺100.000.000", oran: "%100" },
  { sembol: "TCELL", tarih: "9 Aralık 2026", isoTarih: "2026-12-09", verim: "% 3,78", brut: "₺4,00", net: "₺3,4000", toplam: "₺8.800.000.000", oran: "%48" },
  { sembol: "SUMAS", tarih: "7 Aralık 2026", isoTarih: "2026-12-07", verim: "% 0,62", brut: "₺2,17", net: "₺1,8436", toplam: "₺13.500.000", oran: "%90" },
];
